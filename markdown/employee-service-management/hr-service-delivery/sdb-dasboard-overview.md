...
breadcrumb: [Explore the HR Success Dashboard indicators, HR Success Dashboard indicators, HR Service Delivery, Employee Service Management]
---

# HR Success Dashboard indicators components
...
View the aggregation of the daily values for KPIs in the selected period on the scorecards.
...
## Info icons in the HR Success Dashboard indicators
...
Select and view the trend of the metric scorecard aggregated scores:

-   Call deflection trend
-   Structured tickets trend

## View details in the HR Success Dashboard indicators
