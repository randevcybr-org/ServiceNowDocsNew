...
<table id="simpletable_y4w_clk_npb"><thead><tr><th>
...
The date the employee became a union member.
...
The date the employee left the union, if applicable.
...
Identifies if the employee is an active union member.
...
Identifies if the employee is a union steward.
...
The employee's job code within your company.
