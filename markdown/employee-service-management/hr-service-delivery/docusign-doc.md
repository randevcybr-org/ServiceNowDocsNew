...
**Note:** The Document Template integration with Docusign application supports the signing of HTML and PDF document templates that are generated from Document Templates.
