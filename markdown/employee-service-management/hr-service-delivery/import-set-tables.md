---
title: Import set tables in HR Service Delivery Integration with Workday Learning
description: Import set tables into HR Service Delivery Integration with Workday Learning
locale: en-US
release: australia
