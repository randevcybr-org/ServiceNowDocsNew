...
View reporting structure of an employee.
...
Send an email to an employee.This action opens a link with the work email of your employee in the To field \(default email client\), and an empty subject line.
