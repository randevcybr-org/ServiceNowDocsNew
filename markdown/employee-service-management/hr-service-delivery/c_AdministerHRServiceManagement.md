...
description: Administer the Case and Knowledge Management application to improve HR efficiency and make it easier for employees to get the services they need.
locale: en-US
release: australia
...
-   **[Collect employee input](employee-form-configuration.md)**  
...
-   **[Managed lists](c_ManagedLists.md)**  
...
-   **[HR Knowledge Management](hr-knowledge-management.md)**  
...
-   **[HR services](hr-service-administration.md)**  
...
-   **[Manage HR roles](c_ManageRoles.md)**  
Roles control access to features and capabilities in modules in the HR application.
-   **[HR Service Delivery case assignment](hr-case-assignment.md)**  
...
-   **[HR chat from lists and forms](chat-with-scoped-hr.md)**  
You can chat with employees about their HR services request from any HR list or form in HR Service Delivery.
-   **[Capturing multiple job records for a user](support-hr-users-with-multiple-jobs.md)**  
...
-   **[Standard Ticket Page view for HR Service Delivery](ur-hr-standard-ticket-page.md)**  
Configure your HR services to use the Standard Ticket page to provide a consistent user experience for your employees.
-   **[Translations for HR cases and tasks](translation-of-hr-cases-and-tasks.md#)**  
...
-   **[Employee Profile table](employee-profile.md)**  
...
-   **[Link generator for HR Service Delivery](HRLinkGenerator.md)**  
...
-   **[HR flows and triggers](hr-flows-and-triggers.md)**  
...
-   **[Employee passport](employee-passport.md)**  
