...
**Note:** Associating a labor union with an employee is a reference to the membership and not proof of actual membership.

There are a couple of methods to associate a labor union with an employee:
