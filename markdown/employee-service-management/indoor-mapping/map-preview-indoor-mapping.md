...
4.  In the search field, search for places on the Campus, for example: Meeting room 101.
    ...
    When you start typing in the search field, application provides auto-suggestions for places that are available in the selected campus.
...
7.  Specify the **From** and **To** fields to specify the floors from where you want to have the wayfinding capabilities.

8.  You can also add directions from one building to another.

9.  Select the required buildings in the **From** and **To** fields to display the directions.
...
11. Toggle between the **View Types** available on the top right menu \(in case if you have multiple View types\).
    ...
    Select the buildings and floors that you want to show on the map. Zoom in and zoom out as required.
