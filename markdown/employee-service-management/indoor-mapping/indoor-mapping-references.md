---
title: Indoor Mapping references
description: Learn more about the Indoor Mapping basic indoor mapping terms, and the components installed with indoor maps like roles, tables, and properties.
locale: en-US
release: australia
...
1.  [Map components installed with Indoor Mapping](../reference/components-installed-with-indoor-mapping.md)  
...
2.  [Indoor Mapping terminology](../reference/indoor-mapping-common-terminology.md)  
Key terms used in Indoor Mapping.
3.  [Snapshot Impacted tables](../reference/snapshot-ind-mapping-tables.md)  
