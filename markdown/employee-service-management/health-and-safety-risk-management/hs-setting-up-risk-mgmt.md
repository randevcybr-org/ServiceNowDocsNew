---
title: Setting up Health and Safety Risk Management
description: Set up your implementation for Health and Safety Risk Management by installing the application and reviewing and configuring the components that are installed with the application.
locale: en-US
release: australia
...
# Setting up Health and Safety Risk Management

Set up your implementation for Health and Safety Risk Management by installing the application and reviewing and configuring the components that are installed with the application.

-   **[Install Health and Safety Risk Management](../task/install-hs-risk-mgmt.md)**  
...
-   **[Create a safety risk category](../task/hs-create-safety-risk-category.md)**  
Create or modify a risk category to group your workplace hazards into logical categories.
-   **[Define Health and Safety hazards](../task/hs-define-hazards.md)**  
...
-   **[Create a safety control measure category](../task/hs-create-safety-hierarchy-controls.md)**  
Create or modify a control measure category to group your safety controls into logical categories.
-   **[Define Health and Safety control measures](../task/hs-define-controls.md)**  
...
-   **[Configure a safety risk matrix](../task/hs-configure-risk-matrix.md)**  
...
-   **[Define a job in the job register](../task/hs-define-job-register.md)**  
...
-   **[Configure creating actions from smart assessment questionnaire](../task/hs-configure-property-smart-assessment-action-creation.md)**  
...
-   **[Configure the smart assessment template for safety inspections and audits](../task/hs-configure-smart-assessment-template.md)**  
...
-   **[Configure a safety inspection or audit survey](../task/hs-configure-safety-inspection-surveys.md)**  
...
-   **[Define a category and measurement unit for an exposure type](../task/hs-define-category-measurement-unit-exposure-type.md)**  
...
-   **[Configure permit-to-work](hs-configure-permit-to-work.md)**  
