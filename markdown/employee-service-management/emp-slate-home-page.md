...
Employee Slate includes the following widgets on the home page:

-   **Inbox**

    Surfaces priority tasks and approvals for your employees to act right from inbox. The widget highlights the top two AI-prioritised to-do items for immediate attention and action. Inbox provides quick access to the full task or approval record.
