...
Check the reports of workplace cases that are assigned to you. Select from the following reports to know more information:-   Select **Breached** to view the workplace cases that have breached the set SLAs.
...
Go to the **Group work** section to view the cases and tasks assigned to the assignment group to which you belong.Select from the following:
...
Go to the **Unassigned work** section to view the details of all the cases and tasks that are currently not assigned to any agent within your assignment group.-   Select **See all** to view all the cases and tasks in a list on a separate page.
...
</table>3.  To check the knowledge articles added by your organization, select the **Article** tab at the bottom.
