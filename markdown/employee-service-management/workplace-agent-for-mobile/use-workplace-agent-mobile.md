---
title: Use Workplace Agent for mobile
description: Use the Workplace Agent for mobile to perform workplace case or task related activities using the ServiceNow Agent mobile application.
locale: en-US
release: australia
...
breadcrumb: [Workplace Agent for mobile, Workplace Service Delivery, Employee Service Management]
---
...
-   **[Print workplace tasks](../task/print-workplace-tasks-mobile.md)**  
...
-   **[Create a child task](../task/create-a-child-task-agentmobile.md)**  
...
-   **[Create a workplace case on behalf of an employee through Workplace Agent for mobile](../task/create-agentcase-mobile.md)**  
Create workplace cases on behalf of an employee in the Workplace Agent for mobile work view page.
-   **[Edit or view a child task](../task/edit-or-view-a-child-task-agentmobile.md)**  
View or update a task whenever you want to get the details or update the progress.
-   **[Offline mode](../task/offline-mode.md)**  
