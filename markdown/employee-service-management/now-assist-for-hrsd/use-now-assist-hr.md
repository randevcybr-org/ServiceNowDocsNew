---
title: Use Now Assist for HR Service Delivery \(HRSD\) in Agent Workspace
description: If you have a sn\_hr\_core.case\_writer role, you can summarize a case, generate resolution notes, summarize the chat interactions with a requester, and propose resolutions more quickly with the Now Assist for HR Service Delivery \(HRSD\) application.
locale: en-US
release: australia
