...
<table id="table_ag5_j3m_v4b"><thead><tr><th>
...
Option to copy the comments and attachments of this case while transferring. The option is automatically selected.**Note:** The transfer action does not copy work notes.
