---
title: Managing Workplace cases
description: As a Workplace case manager, you can manage workplace cases created through workplace services. You can view and update cases if required.
locale: en-US
release: australia
