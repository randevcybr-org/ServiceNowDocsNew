...
Raise a cleaning request using either the Workplace Service Portal or the Employee Center.
...
Use the **Cleaning** workplace service to request for cleaning service at your workplace.

## Procedure

1.  Navigate to the portal from one of the following locations.

<table id="choicetable_presence_dashboard"><thead><tr><th align="left" id="d181966e70">

Location

</th><th align="left" id="d181966e73">

Navigation

</th></tr></thead><tbody><tr><td id="d181966e79">
...
</table>2.  On the submit a **Cleaning** request form, fill in the details.

<table id="table_sjh_sgk_ybc"><thead><tr><th>
...
Choose the **Urgency** for the cleaning service.
...
**Building**, that has requested for cleaning service.
...
**Floor**, that has requested for cleaning service.
...
**Space**, that has requested for the cleaning service.
...
The cleaning request is submitted.
