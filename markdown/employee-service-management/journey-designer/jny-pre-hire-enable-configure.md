...
# Enable and configure the Pre-hire Experience
...
-   **[Deactivate an obsolete Lifecycle Events activity](../task/jny-deactivate-old-le-activity.md)**  
...
-   **[Activate new Lifecycle Events activities](../task/jny-activate-new-le-activities.md)**  
...
-   **[Configure the Start onboarding widget](../task/jny-configure-start-onboarding.md)**  
...
-   **[Configure the Our culture widget](../task/jny-configure-our-culture.md)**  
...
-   **[Configure the Getting started resources widget](../task/jny-configure-getting-started.md)**  
