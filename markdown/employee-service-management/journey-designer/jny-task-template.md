...
<table id="table_bsc_mls_stb"><thead><tr><th>
...
Table that is used to track tasks and fields. Select the Task \[sn\_ja\_task\] table to enable access to the template fields.
...
**Note:** When `editable = false`, the following occurs:
