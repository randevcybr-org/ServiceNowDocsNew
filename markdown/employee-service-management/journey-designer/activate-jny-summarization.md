...
-   Blockers that are impeding the journey's progress
-   The next steps that should be taken to resume the journey's progress

Role required: \[sn\_jny.admin\], \[sn\_nowassist\_admin.nsa\_admin\]
...
4.  Use the guided setup to accept the default configurations for this skill or to configure the skill to your specifications.

    During the guided setup, select **Save and continue** to navigate to the next page in the configuration process or **Back** to navigate to the previous page.

5.  Select **Activate** on the final page of the guided setup to complete the configuration process.
