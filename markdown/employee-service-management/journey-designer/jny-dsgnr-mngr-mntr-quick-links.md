---
title: Add, edit, or delete journey quick links
description: Journey owners and mentors add, edit, and delete quick links in a journey.
locale: en-US
release: australia
...
Role required: Journey owner or Journey Mentor with **Can add quick links** permission.
...
3.  Select **Add a link** and fill in the fields.
    ...
    -   **Link text**: The text that is visible in the journey.
    -   **Link address**: A valid URL.
4.  Select **Add link**.
