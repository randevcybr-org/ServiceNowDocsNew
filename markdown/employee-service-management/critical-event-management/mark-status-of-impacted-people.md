...
4.  On the Total Impacted list, select the check box for the relevant individual.

5.  Double-click \(or use the keyboard shortcut\) the field in the Status column for that impacted person.
