...
-   **[Generate impacted people list](../task/generate-impacted-people-list.md)**  
...
-   **[Add a person manually to the impacted people list](../task/add-person-manually-to-impacted-people.md)**  
...
-   **[Export an impacted people list](../task/export-impacted-people-list.md)**  
...
-   **[View an impacted person record](../task/view-impacted-person-record.md)**  
View and track the status of an impacted person's record as an agent in Critical Event Management.
-   **[Mark the status of impacted people as an agent](../task/mark-status-of-impacted-people.md)**  
Take attendance of the impacted people in Critical Event Management and request help if needed.
-   **[View notifications received](../task/view-notifications-received.md)**  
View the list of notifications received for an impacted person in Critical Event Management.
-   **[Conduct a roll call as an on-site responder](../task/conduct-roll-call.md)**  
