---
title: Create a strict mode connection with Microsoft Exchange Online
description: For a strict mode connection with Microsoft Exchange Online, you must perform the following actions.
locale: en-US
release: australia
...
# Create a strict mode connection with Microsoft Exchange Online

For a strict mode connection with Microsoft Exchange Online, you must perform the following actions.

-   **[Configure Microsoft Azure](../task/auth-mxex-with-azure-strict-mode.md)**  
...
-   **[Create connection with Microsoft Exchange Online Spoke in strict mode](../task/create-connection-with-msspoke-strict-mode.md)**  
Configure a strict mode connection with the Microsoft Exchange Online spoke.
-   **[Create a strict mode configuration in Microsoft Exchange Online](../task/strict-mode-configuration-in-msex.md)**  
Specify your delegated user email in the Microsoft portal.
-   **[Setup strict mode OAuth connectivity with Microsoft Exchange Online](../task/setup-strict-mode-oauth-connectivity-with-msex.md)**  
Create a strict mode app registry for Microsoft Exchange Online with ServiceNow instance for OAuth authorization.
-   **[Configure strict mode Connection and Credential alias for Microsoft Exchange Online](../task/configure-strict-mode-connection-and-credential-alias-for-msex.md)**  
...
-   **[Create your own credential and connection alias for strict mode](../task/create-own-credential-and-connection-alias-for-strict-mode.md)**  
...
-   **[Configure Microsoft Exchange Online calendar provider in strict mode](../task/configure-msex-strict-mode-calendar-providers.md)**  
