...
For more information about the tables in the Skills Foundation application, see [Components installed with Skills Foundation](../reference/skills-intelligence-users-and-roles-1.md).
...
-   Using a scheduled job. For more information, see [Map a role level to the employee profile](../task/skills-int-attach-role-level-emp.md).
-   Adding a job profile to an employee manually. For more information, see [Adding a job profile to the employee](../task/map-employee-job-profile.md).
