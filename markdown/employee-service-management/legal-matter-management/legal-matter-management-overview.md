...
## Legal Matter Management users

<table id="table_ydm_tg1_vfc"><thead><tr><th>
...
Matter Fulfiller can do the following:-   Submit legal matter.
-   Define phases and task in the workflow.
-   Mark matter as Privileged and confidential.
-   Works on assigned legal matter.
...
1.  A legal matter is submitted by any of the following method.
    -   A paralegal staff or lawyer can promotes a legal request to a legal matter if the request needs additional investigation and substantial time to work on.
    ...
    -   A practice area lead creates a legal matter directly. These matters do not have any parent legal request though related requests can be added to them.
2.  The legal matter is assigned to a matter fulfiller.
...
## Legal Matter Management benefits
