...
<table id="choicetable_qbl_2bj_gtb"><thead><tr><th align="left" id="d430300e105">

Option

</th><th align="left" id="d430300e108">

Steps

</th></tr></thead><tbody><tr><td id="d430300e114">
...
</table>4.  Open the legal matter that you want to reopen.

5.  Click **Reopen**.

6.  In the Reopen Matter dialog box, enter comments in the **Comments** field to note why you are reopening the matter.

    Comments entered in the Reopen Matter dialog box will be posted in all related requests.

7.  Reopen related closed or canceled legal requests along with the parent request by selecting the **Reopen related requests** check box.
...
-   The legal matter is reopened.
-   The state of the matter updates to the state it was in before it was closed or canceled.
-   If the primary legal request of the matter is closed or canceled, then the request is reopened.
-   If you chose to reopen all related requests also, any related legal requests that are in the Closed Complete, Closed Incomplete, or Cancelled state are also reopened.
-   Any collaborators added to the matter will receive an email notification that the matter has been reopened.
