...
The AI assistant uses the reasoning engine to identify the records that must change. It collects the inputs in the conversation and confirms before it updates the system of record. For background, see [AI assistant reasoning engine](../concept/empworks-moveworks-capabilities.md#section-reasoning-engine).
