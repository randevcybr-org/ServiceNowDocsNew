---
title: Scheduling Health and Safety actions
description: Use the Health and Safety action scheduler to create and schedule actions across the organization and auto-assign them to specific individuals using the condition builder.
locale: en-US
release: australia
