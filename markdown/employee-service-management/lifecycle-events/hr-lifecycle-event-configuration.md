...
1.  [Document the lifecycle event process](define-lifecycle-event-process.md)  
...
2.  [Configure the supporting components for a lifecycle event](configure-supporting-components-for-lifecycle-event.md)  
...
3.  [Configure a lifecycle event](../task/configure-hr-lifecycle-event-type.md)  
Build a lifecycle event and its associated activity sets and activities with the lifecycle event builder.
4.  [Configure an HR service for a lifecycle event](../task/create-hr-service-for-lifecycle-event.md)  
...
5.  [Configure an HR service for a journey](../task/configure-hr-service-for-journey.md)  
...
6.  [Using the Test Activity Sets tool for a lifecycle event activity set](hr-lifecycle-event-test-tool.md)  
Use the lifecycle event test tool to thoroughly test a lifecycle event before launching it.
7.  [Select a Lifecycle Event for Now Mobile](../task/select-lifecycle-event-for-mobile-onboarding.md)  
...
[Clone a lifecycle event](../task/clone-lifecycle-event.md)

[Filter lifecycle event activities](../task/filter-lifecycle-event-activities.md)

[Lifecycle event properties](../task/lifecycle-event-properties-page.md)

[Support multiple jobs in a lifecycle event](../task/adopt-jobs-table.md)

[Configure the UI of the lifecycle event builder](../task/le-ui-configuration.md)
