...
Workplace manager: Needs visibility into the real-time status and number of the reservations, most reserved locations, peak timings for meetings, and current day's reservations.
...
-   Monitor reservations created by employees
-   Monitor peak time when maximum meetings are organized
-   Monitor the number of meetings for each location
