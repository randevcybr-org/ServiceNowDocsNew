---
title: Explore Workplace Reservation Management
description: Workplace Reservation Management provides one unified interface for employees to reserve desks, meeting rooms, parking spots, workplace equipments, services, and collaboration spaces.
locale: en-US
release: australia
...
Workplace administrators can configure Reservable Modules, assign spaces, and add standard or flexible services like catering, seating arrangement, AV equipments, and so on. They can enable approvals, manage shift-based or group bookings, and track reservations.
...
Employees can perform the following using Workplace Reservation Management:

-   Find and reserve spaces instantly. Reserve desks, meeting rooms, conference rooms, parking spots, or even services like catering, seating arrangement, projectors, and so on.
-   Opt to reserve a space for an hour, for an entire day, across multiple days, or even multiple buildings.
-   View the availability of a workplace item for a day using Map, Card, or Schedule options.
-   View details of workplace items such as capacity, location, layout, and services available.
-   Browse locations on floor maps and make reservations or raise a workplace issues based on space availability.
...
Workplace Reservation Management allows workplace administrators and facility managers to monitor space allocations and utilization across a workplace. They can monitor space utilization. It provides them with greater visibility and monitoring capabilities.

-   Configure reservable modules to group similar workplace items—like desks or meeting rooms.
-   Set approval policies to match organizational needs, so reservations follow the right workflows.
-   Enable shift-based reservations for workplaces with staggered schedules.
-   Allow group reservations, letting one manager book for an entire team.
-   Add standard or flexible services—everything from projectors to catering—to make meetings more productive.
-   Generate QR codes for easy check-ins, displayed at reservable locations.
...
Workplace Reservation Management isn’t just about booking—it’s about improving the workplace experience. With built-in dashboards and reporting, workplace administrators and facility managers can perform the following:

-   Track reservation patterns over a period of time.
-   Understand space utilization across buildings, floors, and areas.
-   Identify underused spaces and optimize layouts.
-   Support smarter planning for hybrid work and future growth.

As a Workplace Reservation Management manager, you can:

-   Manage reservations created by employees. You can view, update, and approve or reject the reservations created by the employees based on your organization’s guidelines.
