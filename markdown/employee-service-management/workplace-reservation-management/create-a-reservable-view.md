...
To view workplace items in the above views while making a reservation, configure the reservable module to use the reservable views. For more information, refer to [Configure a reservable view on a reservable module](configure-rsv-view-of-cnfig-module.md).
