---
title: Workplace Reservation Management references
description: Learn more about the role, tables and system properties installed with the Workplace Reservation Management application.
locale: en-US
release: australia
