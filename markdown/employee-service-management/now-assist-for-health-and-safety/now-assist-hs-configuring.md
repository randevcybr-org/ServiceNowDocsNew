---
title: Configuring Now Assist for Health and Safety
description: Configure the Now Assist for Health and Safety application.
locale: en-US
release: australia
...
-   **[Install Now Assist for Health and Safety](../task/now-assist-hs-install.md)**  
...
-   **[Activate a Now Assist for Health and Safety skill](../task/now-assist-hs-activate-skill.md)**  
...
-   **[Skill inputs for Now Assist for Health and Safety](../reference/now-assist-hs-skill-inputs.md)**  
Get a quick overview of the skill inputs for Now Assist for Health and Safety.
-   **[Configure Now Assist AI agents for Health and Safety](ai-agents-now-assist-hs-configuring.md)**  
Learn how to configure Now Assist AI agents to execute agentic workflows with AI agents and mapped tools.
-   **[Configure conversational AI](hs-configure-conversational-ai.md)**  
Learn how to configure conversational AI for Health and Safety incidents and observations.
-   **[Configure incident patterns](hs-configure-incident-patterns.md)**  
