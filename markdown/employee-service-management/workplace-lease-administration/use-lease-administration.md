...
# Using Workplace Lease Administration

As a lease manager or administrator manager, you can create, manage, and track workplace contracts. You can add workplace contract services, relevant documents, and track important milestones.

As a lease administrator or manager, you can do the following:

-   Create workplace lease contracts.
-   Track the lease contracts as a tenant.
-   Add workplace contract services along with its costs.
-   Add contract locations.
-   Add assets to a contract.
-   Add documents.
-   Build and add Terms and Conditions.
-   Receive notifications regarding the lease contracts expiry.
-   Renew workplace lease contracts before or after the expiry.

As a lease administration user, you can only view the workplace contracts.
