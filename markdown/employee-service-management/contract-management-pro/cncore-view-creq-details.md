...
3.  View the details of the contract request.
    ...
    -   View the list of supporting documents by accessing the **Supporting Documents** tab. This related list is available only for non-self-served contract request.
