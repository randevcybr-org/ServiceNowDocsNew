...
keywords: [Obligation management, Contract repository]
...
1.  Navigate to **All** &gt; **Contract** &gt; **Contracts** &gt; **All**.

2.  Select a contract record.
...
The Obligations tab will appear in contract repository records.
