...
<table id="table_bxv_pt5_mbc"><thead><tr><th>
...
HR agents and Managers

</td></tr><tr><td>

Step by step guidance enabling you to onboard a healthcare professional smoothly into your organization. Use the demo Healthcare Employee Onboarding workflow in Journey designer as a guidance to set up and automate tasks for a new hire \(healthcare professional\) at a healthcare organization.

-   Auto-create profile for the healthcare professional, auto-create email account, and auto-initiate necessary form intake tasks for the healthcare professional.
-   Create credentialing and validation tasks for HR agents to review and validate the information submitted by the healthcare professionals.
...
Healthcare administrator or HR admin
