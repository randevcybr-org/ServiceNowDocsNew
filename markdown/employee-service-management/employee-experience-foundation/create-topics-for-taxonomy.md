---
title: Create and associate topics
description: Create topics that you want to associate with the new or cloned taxonomy.
locale: en-US
release: australia
...
When you have a lot of topics, ensure you set up user criteria for your topics.
...
5.  Click **Submit**.
    ...
    **Note:** Topics are visible only when content is associated with it.
