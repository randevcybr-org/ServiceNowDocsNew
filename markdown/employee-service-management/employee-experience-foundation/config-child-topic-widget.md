...
# Modify the sub-topics widget display
...
4.  Do one of the following.
    ...
    -   Select the **Show Topic Icon** check box to show the topic icon.
    -   Deselect the **Show Topic Icon** check box to hide the topic icon.
