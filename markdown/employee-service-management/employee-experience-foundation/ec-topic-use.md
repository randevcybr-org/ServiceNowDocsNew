...
The topic header widget displays the parent topics. Select a topic from the mega menu to view its details. The topic widget displays the description of the topic and the banner and icon images for the topic, if available.
...
<table id="table_smr_tkv_brb"><thead><tr><th>
...
How you want to filter the information. The options are:-   **All:** Displays both the knowledge articles and requests.
-   **Article:** Displays only knowledge articles.
-   **Request:** Displays only requests.
...
How you want to sort the information. The options are:-   **Popular:** Displays the most popular knowledge articles and requests.
-   **A-Z:** Displays the knowledge articles and requests in alphabetical order.
...
Displays the knowledge articles and requests in cards.
...
Displays the knowledge articles and requests in lists.
...
Displays the next set of 12 content items \(knowledge articles and requests\), based on the settings of the **Sort by** and **Filter by** options. By default, 12 content items are displayed for a topic. This option appears only when more than 12 content items are associated to a topic.

</td></tr></tbody>
</table>**Note:** The A-Z sorting is not supported for non-English.
