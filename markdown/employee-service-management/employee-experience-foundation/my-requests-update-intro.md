...
**Drafts** is enabled by default. If you want to hide the **Drafts** tab, mark the system property, Enable Save as draft in esc portal \(glide.sc.enable.save\_as\_draft.portal.esc\) **false**.
