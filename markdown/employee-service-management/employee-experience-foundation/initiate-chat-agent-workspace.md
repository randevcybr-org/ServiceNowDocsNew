---
title: Request-based chat - Start and import chat from Workspace
...
# Request-based chat - Start and import chat from Workspace

Initiate a conversation with the requester to resolve the ticket.

-   **[Request-based chat - Start and import chat from field decorator](../task/initiate-chat-record-field-decorator-workspace.md)**  
...
-   **[Request-based chat - Start and import chat from Start Microsoft Teams chat action](../task/initiate-chat-agent-ws.md)**  
Interact with a requester in Microsoft Teams from the workspace to quickly resolve the ticket.
-   **[Import messages from Agent Workspace](../task/import-messages-agent-workspace.md)**  
