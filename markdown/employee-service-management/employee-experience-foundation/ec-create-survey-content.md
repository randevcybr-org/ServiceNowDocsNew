...
Role required: sn\_lp.creator, sn\_cd.content\_manager, sn\_ca.campaign\_manager
...
<table id="table_kt1_rmd_knb"><thead><tr><th>
...
</table>7.  Right-click in the form header and select **Save**.
