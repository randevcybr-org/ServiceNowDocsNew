...
Personalized Answers- time off feature has location-specific data. The default third-party integrations available are Kronos and Workday for specific regions that show the leave balances of employees of that region.
