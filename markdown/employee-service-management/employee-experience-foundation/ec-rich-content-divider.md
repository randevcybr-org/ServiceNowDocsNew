---
title: Add a Divider with the Rich Content Editor
description: Add a horizontal Divider into your canvas to visually separate elements or highlight important sections.
locale: en-US
release: australia
...
# Add a Divider with the Rich Content Editor

Add a horizontal Divider into your canvas to visually separate elements or highlight important sections.
...
2.  From the **Rich Content Editor** canvas, you can use a drag-and-drop method to add dividers.
...
Specify the value by entering a number.Select the unit of measure:
...
Margin is the space between the divider and another element/the canvas boundary. Specify the value for top, bottom, right, or left padding by entering a number.
