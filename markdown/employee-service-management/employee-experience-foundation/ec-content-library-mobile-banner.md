---
title: Create mobile banner content
description: Create banner content that your employees can view on their mobile devices.
locale: en-US
release: australia
...
breadcrumb: [Mobile content, Creating employee communications, Authoring and managing employee communications, Employee Center Pro, Unified Employee Experience, Employee Service Management]
---

# Create mobile banner content
...
3.  Select **Mobile** under the **Select the Platform** column.

4.  Select **Mobile Banner** under the **Choose a content format** section.
...
The content type you are creating or editing. Select **Mobile Banner**.
...
Image to display for the mobile banner.
...
Link to use with the mobile banner. The link displays when the user taps anywhere on the banner.
...
Text that appears in the header of the banner \(max 80 characters\).
...
Text that displays in the body of the banner.
