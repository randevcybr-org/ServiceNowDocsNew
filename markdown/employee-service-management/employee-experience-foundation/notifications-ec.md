...
With the notifications header option, you can:

-   Get a bell icon on the portal header for tracking.
-   Get notification count displayed on the bell icon.
-   Turn on or off the display of the notification count.

Turn off notifications altogether, if it isn’t relevant for you.

## Notifications actions

Use Notifications filters to refine your search when you have a long list. The filters are configurable according to your requirements. The following are the default options:

-   Critical
-   Reminder

Mark all your notifications read altogether with the **Mark all as read** option available on the global utility ellipses option.

Notifications actions available for each notification are:
...
If the author clicks on a news article notification for an expired article, it won't be visible anymore.
