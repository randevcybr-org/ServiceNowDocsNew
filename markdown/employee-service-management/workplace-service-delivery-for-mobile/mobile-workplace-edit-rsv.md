...
5.  Select the **Reservations** tab.
    ...
    By default, the **Reservations** tab is selected.

6.  Review your reservations available in **Your reservations for today** \(in case of a single day reservation\) or **Your reservations for &lt;selected-date&gt;** \(in case of bulk reservations\) Agenda view.

7.  The agenda view shows all reservations created from using the Advanced Reservation web portal and the Now Mobile® app.
...
8.  Select the Actions menu icon \(![More information icon.](../images/wsd-mobile-three-dots-icon.png)\) for a reservation.
    ...
    1.  Edit reservations: Select **Edit reservations** to edit an existing reservation and update it with a new date, time, and location.
    ...
    3.  Select **When** to open a dialog box to update the date and time of an existing reservation.
