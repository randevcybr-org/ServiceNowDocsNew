---
title: Setup a kiosk on a physical device for reservations
description: Kiosk operators can bind the kiosk configuration to a physical device for employees and guests to make workplace reservations.
locale: en-US
release: australia
...
# Setup a kiosk on a physical device for reservations
