...
# View the smart assessment result using the Mobile agent app
...
4.  Tap the **Smart assessment results** button.

5.  Select **Next** to view all the sections of the assessment.
