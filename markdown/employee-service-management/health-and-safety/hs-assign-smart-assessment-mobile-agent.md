...
-   The smart assessment can be assigned only when it was previously assigned to another safety agent or manager.
-   This option is available only when you’re part of the same assignment group as the agent or manager to whom the inspection or audit was originally assigned.
...
3.  Tap the inspection or audit record.

4.  Tap the **Assign to me** button.

5.  Tap **Yes** in the dialogue box to confirm.


## Result

-   The inspection or the audit gets assigned to you.
-   The smart assessment associated with the inspection also gets assigned to you.
