...
3.  In the **My Actions** section on the page, tap **My Assessments and Surveys**.

    All surveys that were downloaded before you went offline are listed.

4.  In the list, tap the inspection or audit survey that you want to complete.
