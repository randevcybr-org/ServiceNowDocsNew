...
description: Use the Health and Safety Environmental Management application to view the chemical library, raise chemical requests, and submit the requests for approvals.
locale: en-US
release: australia
...
-   **[View the chemical library as an employee](../task/hs-view-chemical-library.md)**  
...
-   **[Create a chemical request from the Employee Center](../task/hs-create-chemical-request-ec.md)**  
...
-   **[Submit a chemical request for approval](../task/hs-submit-chemical-request-approval.md)**  
A chemical manager reviews a chemical request received from the employee and submits it for approval by the approver.
-   **[Approve or reject a chemical request](../task/hs-approve-reject-chemical-request.md)**  
