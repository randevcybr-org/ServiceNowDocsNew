---
title: Legal Content Review requests
description: Legal Content Review is a mechanism to raise a legal review request for any marketing materials, collateral, or presentation contents and seek services from the legal department to resolve the issue and track its status.
locale: en-US
release: australia
