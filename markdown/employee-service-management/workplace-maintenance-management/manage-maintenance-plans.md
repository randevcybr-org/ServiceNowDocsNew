...
5.  [Create workplace services](../task/create-workplace-services.md)  
...
6.  [Create plan service configuration](../task/create-maint-service-config.md)  
Configure a plan service to associate workplace services and set scheduling conditions for a plan record.
7.  [Workplace maintenance cases](../task/create-maint-cases.md)  
