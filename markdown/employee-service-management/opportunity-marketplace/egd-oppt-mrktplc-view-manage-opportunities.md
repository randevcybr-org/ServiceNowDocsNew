...
1.  Navigate to **All** &gt; **Opportunity Marketplace** &gt; **Opportunities**.

    Opportunities records contain several fields. Here are some of the fields that help you to identify opportunities. Some of the listed fields are linked to their respective records for the applicant.
...
The title of the opportunity that applicants and opportunity owners see when looking at opportunities.
...
The **State** of an opportunity indicates where an opportunity is in the approval process.-   **Canceled**
-   **Closed**
-   **Complete**
-   **Draft**
-   **Edited**
...
The date that the opportunity is available to applicants.

</td></tr></tbody>
</table>2.  Select an opportunity.

3.  Update any field that must be changed.
