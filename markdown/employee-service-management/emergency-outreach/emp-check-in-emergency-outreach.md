...
-   To reply to a mobile push notification:
    ...
    2.  In the message, tap **Check In**.

    3.  On the Check In screen, provide your location and additional comments.
...
-   To reply to an SMS notification:
    ...
    1.  Open the SMS message on your phone.

    2.  Reply with the number of your response.
