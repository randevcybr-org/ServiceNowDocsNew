...
3.  Create a schedule plan.
    ...
    7.  Select the required assignment group. f you want to assign the schedule to the groups you manage, select **Groups I manage**. If you want to specify groups, select **Specify groups** and browse for groups.
