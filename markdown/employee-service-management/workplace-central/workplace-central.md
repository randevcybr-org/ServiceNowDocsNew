...
# Explore Workplace Central

Workplace Central is a one-stop application where you can view key metrics, and access or control all your workplace-related operations.

Install the Workplace Central \(sn\_wsd\_central\) plugin from the ServiceNow Store.

As a workplace manager, the Workplace Central makes it easier for you to configure, perform, monitor, and run all your workplace activities efficiently from a single workspace. The application helps you save time without the need to navigate to different places to perform any workplace-related action. For example, you can plan a scenario, track the scenario metrics, analyze workplace activities, monitor workplace maintenance plans, and more.

![Workplace Analytics Dashboard.](../../wsd-indoor-mapping/images/wsd-workplace-central-home-page.png "Workplace Central landing page")

Using the Workplace Central application, you can perform the following:
...
-   View a key metrics dashboard for Space Optimization, Lease Administration, and Maintenance Management. For more information, see [Working with Workplace Analytics](working-with-workplace-analytics.md).
-   Create move projects to track workplace move requests at a time. Collate move requests under a project using filter conditions and monitor their fulfillment. For more information, refer to [Move Management](move-mgmt.md).
...
-   Check the current day's planned reservation, canceled reservations and reservations that are yet to be approved.
