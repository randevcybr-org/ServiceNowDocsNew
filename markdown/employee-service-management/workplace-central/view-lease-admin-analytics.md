...
To access the Lease Administration dashboard, you must have the sn\_wsd\_la.manager or sn\_wsd\_la.admin role.
...
**Note:** Workplace contracts without a location value aren't included in the total count.

The following default scorecards are available on the dashboard. Select the card to see the list of records.

-   **All Contracts**- Displays the total number of workplace contracts.
-   **Active Contracts** - Displays the number workplace contracts in an active state.
...
-   **Lease expiration by region**
    ...
    Displays the number of workplace contracts expiring in different regions.
