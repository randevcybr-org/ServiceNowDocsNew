...
After transferring Workplace Central data between ServiceNow ServiceNow instances, some data and links are lost.
...
2.  From the Fix Scripts list, select the **Load space details table- current state** script.
