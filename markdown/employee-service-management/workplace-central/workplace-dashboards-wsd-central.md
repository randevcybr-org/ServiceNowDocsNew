---
title: Manage Workplace Dashboards
description: Manage Workplace Dashboards in Workplace Central to get insights and metrics of Reservations, Visitors, Workplace Manager activities, Workplace Cases, and Synchronizations.
locale: en-US
release: australia
...
1.  Navigate to **All** &gt; **Workplace Central** &gt; **Workplace Dashboards**.
    ...
    ![Workplace Dashboards in Workplace Central.](../images/wsd-central-workplace-dashboards.png)

2.  The following Workplace Dashboards are available:
    ...
    -   [Workplace Manager Dashboard](../../../use/dashboards/application-content-packs/workplace-manager-dashboard.md)
    -   [Synchronization Health Dashboard](../../../use/dashboards/application-content-packs/workplace-calendar-synchronization-dashboard.md)
