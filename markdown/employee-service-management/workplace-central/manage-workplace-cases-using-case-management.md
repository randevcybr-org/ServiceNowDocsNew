...
Check the number of active cases and the details of those cases using the dashboard. Know the total number of cases that are currently critical, breached SLAs, unassigned and awaiting approval.
...
3.  To view the number of cases based on their status, go to the **Overview** section.

    1.  Select any of the following tiles to view the list of cases:
    ...
    2.  In the list view of the cases, perform any of the following actions if necessary:

        -   Refresh the list
        -   Edit the columns of the list
        -   Apply the filter on the list
...
4.  To view a list of all the active cases, check the **All active cases** section.
    ...
    1.  From the list view, you can also assign one or more cases to another user using the **Assign** option.

        You can edit the columns of the list and also add filters if necessary.
