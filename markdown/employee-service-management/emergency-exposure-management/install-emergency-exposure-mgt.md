...
# Install Emergency Exposure Management
...
2.  Search for `Emergency Exposure Management`.
...
5.  When the installation is complete, click **Close**.
    ...
    The Emergency Exposure Management application is installed on your instance.
