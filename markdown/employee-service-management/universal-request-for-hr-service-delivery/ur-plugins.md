---
title: Universal Request plugins
description: Request and activate the following plugins to use Universal Request in your application.
locale: en-US
release: australia
...
-   **[Activate Universal Request](../task/activate-ur-plugin.md)**  
...
-   **[Activate Universal Request Advanced Work Assignment](../task/activate-ur-awa-plugin.md)**  
...
-   **[Activate Universal Request Integration for Incident management](../task/activate-ur-integration-for-incident.md)**  
...
-   **[Activate Universal Request NLU Model for Virtual Agent Conversations](../task/activate-ur-nlu-model.md)**  
...
-   **[Activate Universal Request Reporting](../task/activate-ur-reporting.md)**  
You can activate the Universal Request: Reporting plugin \(com.snc.universal\_request.reporting\) if you have the admin role. Activate this plugin to use reports in Universal Request. This plugin includes demo data and activates related plugins if they are not already active.
-   **[Activate Universal Request Virtual Agent Conversations](../task/activate-ur-va-conversation.md)**  
...
-   **[Activate Predictive Intelligence for Universal Request](../task/activate-predictive-intelli-ur.md)**  
...
-   **[Activate Performance Analytics and Reporting for Universal Request](../task/activate-pa-reporting-ur.md)**  
