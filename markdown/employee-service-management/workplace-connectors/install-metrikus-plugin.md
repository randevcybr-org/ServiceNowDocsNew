...
4.  In the Application installation dialog box, review the application dependencies.
    ...
    Dependent plugins and applications are listed. If there are any plugins or applications that must be installed, confirm to activate them before you activate the Metrikus Spoke plugin.

5.  If demo data is available and you want to activate it, select **Load demo data**.

    Demo data comprises sample records that describe application features for common use cases. Load demo data when you first activate the application on a development or test instance.
