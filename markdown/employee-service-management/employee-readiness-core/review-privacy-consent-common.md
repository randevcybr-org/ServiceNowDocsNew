...
3.  Review the employee's responses in the Consent History related list.
    ...
    -   **I Agree**: Employees have responded and agreed to have their data used.
    -   **I Disagree**: Employees have responded and have not agreed to have their data used.
    -   **Withdraw Consent**: Employees previously agreed to have their data used but later withdrew the consent.
