---
title: Health and Safety Case Management reference
description: Using the reference topics, learn about the components, such as the roles, tables, plugins, and store applications that are installed when you install the Health and Safety Case Management application.
locale: en-US
release: australia
...
-   **[Components installed with Health and Safety Case Management](../reference/components-installed-with-hs-case-mgmt.md)**  
...
-   **[Health and Safety case form](../reference/hs-case-form.md)**  
Safety case manager can use the safety case form to resolve health and safety questions that they receive from employees.
-   **[Domain separation and Health and Safety Case Management](hs-case-management-domain-separation.md)**  
