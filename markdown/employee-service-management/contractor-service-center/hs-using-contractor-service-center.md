---
title: Using the Contractor Service Center
description: A contractor can use the Contractor Service Center to access site safety tools, protocols, documentation, raise health and safety requests, and request permits safely.
locale: en-US
release: australia
...
# Using the Contractor Service Center

A contractor can use the Contractor Service Center to access site safety tools, protocols, documentation, raise health and safety requests, and request permits safely.

On the Contractor Service Center you can:
...
-   **[Log in to the Contractor Service Center for the first time as a contractor](../task/hs-log-in-csc-first-time-contractor.md)**  
