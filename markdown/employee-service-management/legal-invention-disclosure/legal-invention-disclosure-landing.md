---
title: Legal Invention Disclosure
description: Legal Invention Disclosure is a workflow that enables inventors to disclose their inventions in a structured manner. The application is installed by the Legal Simple Intellectual Property application.
locale: en-US
release: australia
...
Legal Invention Disclosure is a workflow that enables inventors to disclose their inventions in a structured manner. The application is installed by the Legal Simple Intellectual Property application.

## Get started

<table id="table_yr3_sjg_tyb" class="nav-card"><tbody><tr><td>

[Explore![](../../../reuse/icons/brand-icons/bus-explore.svg)Learn about the features and benefits of Legal Invention Disclosure.](../concept/explore-legal-invention-disclosure.md)

</td><td>

[Configure![](../../../reuse/icons/brand-icons/bus-sdlc.svg)Install and configure Legal Invention Disclosure, set up outside firms and outside counsels, and set up and configure inventor rewards.](../concept/configure-legal-invention-disclosure.md)

</td></tr><tr><td>

[Manage ![](../../../reuse/icons/brand-icons/bus-project-manager.svg)Use Legal Invention Disclosure to manage patent requests, create related matter, facilitate the application process, and track progress.](../concept/use-legal-invention-disclosure.md)

</td><td>

[Reference![](../../../reuse/icons/brand-icons/bus-learn.svg)Get details about components such as roles, tables, and forms.](../concept/legal-invention-disclosure-reference.md)
...
-   [Ask or answer questions in the Legal Service Delivery community forum](https://community.servicenow.com/community?id=community_forum&sys_id=75291a2ddbd897c068c1fb651f9619f3)
...
-   **[Exploring Legal Invention Disclosure](../concept/explore-legal-invention-disclosure.md)**  
Learn more about Legal Invention Disclosure through a sample workflow and review the benefits it can provide.
-   **[Configure Legal Invention Disclosure](../concept/configure-legal-invention-disclosure.md)**  
...
-   **[Using the Legal Invention Disclosure](../concept/use-legal-invention-disclosure.md)**  
...
-   **[Legal Invention Disclosure reference](../concept/legal-invention-disclosure-reference.md)**  
