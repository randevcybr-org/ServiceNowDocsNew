---
title: Configuring Telecommunications Network Inventory
description: Learn how to configure the Telecommunications Network Inventory application so that you can define your telecommunications network and create a comprehensive network inventory model.
locale: en-US
release: australia
...
-   **[Install Telecommunications Network Inventory](../task/installing-telecommunications-network-inventory.md)**  
...
-   **[Define a location hierarchy](../task/define-tni-locations.md)**  
...
-   **[Create the components of a telephone number](create_components_of_a_telephone_number.md)**  
...
-   **[Configuring decision tables for Telecommunications Network Inventory](decision_tables.md)**  
...
-   **[Configure attributes](../task/confgure-telecommunications-network-inventory-attributes.md)**  
...
-   **[Configuring an attribute pack table](configuring-pack-table.md)**  
...
-   **[Configuring capacity management](configuring-capacity-management.md)**  
