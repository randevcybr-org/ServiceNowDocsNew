---
title: Strand model form
description: The Strand Model form enables you to describe the details for a strand model record.
locale: en-US
release: australia
...
Name of the strand model. The ServiceNow AI Platform uses this name to identify it in your network inventory.
...
Description of the strand model that you’re defining.
...
Depreciation schedule of the strand model.
...
Type of the strand. Select one from the following.-   **Single Mode**
