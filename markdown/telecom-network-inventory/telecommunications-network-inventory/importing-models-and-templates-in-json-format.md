---
title: Importing models and templates in JSON format
description: Learn how to import equipment models and inventory templates together in a single operation using JSON format in the Telecommunications Network Inventory application.
locale: en-US
release: australia
...
[Import](network-inventory-import-model.md)

[Import models](import-inventory.md)
