...
description: Use the network diagram in the Telecommunications Network Inventory application to view a hierarchical map of the circuit and its underlying connection elements.
locale: en-US
release: australia
...
-   **[View the details of a network diagram](../task/show-a-ci-related-details-network-diagram.md)**  
...
-   **[Download a network diagram](../task/download-network-diagram.md)**  
...
-   **[Create a protection path](../task/create-a-protection-path.md)**  
