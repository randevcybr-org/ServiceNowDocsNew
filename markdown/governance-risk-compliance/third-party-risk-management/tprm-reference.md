---
title: Third-party Risk Management reference
description: Reference topics provide detailed descriptions of tables, properties, forms, and roles that are installed with the Third-party Risk Management application.
locale: en-US
release: australia
...
-   **[Terminology](../reference/tprm-terminology.md)**  
Learn more about the key concepts and terms that are used in the TPRM application.
-   **[Roles in Third-party Risk Management](../../grc-vendor-risk-implementation/reference/tprm-roles.md)**  
Roles determine permissions and access in TPRM.
-   **[Unique ID numbers for TPRM records](../reference/tprm-records-chars-in-number.md)**  
...
-   **[Sample questionnaires](../../grc-workspace-vrm/reference/tprm-questionnaire-types.md)**  
...
-   **[Due diligence request process management](../../grc-workspace-vrm/reference/tprm-ws-dd-mgt-pg-details-tab.md)**  
...
-   **[Third-party \(external\) risk assessment management](../../grc-workspace-vrm/reference/tprm-ws-dd-mgt-pg-extrnl-assessment.md)**  
...
-   **[Approval process management](../../grc-workspace-vrm/reference/tprm-ws-dd-mgt-pg-approvals.md)**  
...
-   **[Risk intelligence report requests management](../../grc-workspace-vrm/reference/tprm-ws-dd-mgt-pg-rir-tab.md)**  
...
-   **[Scoring calculations using the classic assessment engine](vendor-ratings-scoring.md)**  
...
-   **[Third-party risk management data model](../reference/tprm-data-model.md)**  
...
-   **[Domain separation and Third-party Risk Management](tprm-domain-separation.md)**  
...
-   **[Vendor Risk Overview reports — Legacy view](../reference/vendor-risk-overview-reports.md)**  
