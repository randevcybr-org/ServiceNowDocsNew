...
-   **Home page with different sections**
    ...
    -   **Overview**
        ...
        ![Compliance workspace home page.](../image/ComplianceWSHomePage.png "Compliance workspace home page")
...
To access or view the Compliance Workspace, you need of the following roles:
