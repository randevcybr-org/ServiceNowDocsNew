...
description: Use the Digital resilience third-party registers application in the Operational Resilience Workspace to create, update, and track records of ICT third-party service providers.
locale: en-US
release: australia
topic_type: concept
...
-   **[Create a legal entity and enhance digital resilience data](../task/create-legal-entity.md)**  
...
-   **[Create a branch and enhance digital resilience data](../task/create-drtp-reg-branch.md)**  
...
-   **[Create a function and enhance digital resilience data](../task/create-drtp-reg-function.md)**  
...
-   **[Create a third party and enhance digital resilience data](../task/create-drtp-reg-third-party.md)**  
...
-   **[Create a third-party engagement and enhance digital resilience data](../task/create-drtp-reg-tp-engagement.md)**  
...
-   **[Create a contract and enhance digital resilience data](../task/create-drtp-reg-contract.md)**  
...
-   **[Create a supply chain and enhance digital resilience data](../task/create-drtp-reg-supply-chain.md)**  
...
-   **[Create an assessment and enhance digital resilience data](../task/create-drtp-reg-assmt.md)**  
...
-   **[Create Microsoft Excel download and upload request](../task/create-excel-upload-download-request.md)**  
...
-   **[Currency conversion and third-party aggregation](currency-conversion-aggregation.md)**  
...
-   **[Update existing records in bulk](../task/update-records-bulk-opres-ws.md)**  
Update existing records in bulk from the Digital resilience third-party registers using Third-party Risk Management.
-   **[Create records in bulk](../task/create-records-in-bulk-opres-ws.md)**  
...
-   **[Generate a Register of Information package](../task/opres-drtp-gen-roi-pkg.md)**  
