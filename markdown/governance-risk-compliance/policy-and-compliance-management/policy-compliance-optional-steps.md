---
title: Policy and Compliance Management enhancement steps
description: After you have set up the Policy and Compliance Management base system, you can perform the procedures listed in the following sections to enhance the functionality of the application.
locale: en-US
release: australia
...
-   **[Create a GRC article template](../../grc-policy-and-compliance/task/t_CreateArticleTemplate.md)**  
Policy and Compliance managers can create templates for policy article publishing.
-   **[Create or deactivate a citation](../../grc-policy-and-compliance/task/t_CreateCitations.md)**  
...
-   **[Set notification properties](../../grc-policy-and-compliance/task/policy-compliance-properties.md)**  
...
-   **[Set up GRC Virtual Agent](../../grc-policy-and-compliance/task/grc-virtual-agent-for-policy-exception.md)**  
...
-   **[Allow policy exception requests from other applications](../../grc-policy-and-compliance/concept/allow-other-app-policy-except.md)**  
...
-   **[GRC Approval Configurator for approving policy exceptions and extensions](../../grc-policy-and-compliance/concept/grc-approval-configurator-for-policy-extension-and-exception.md)**  
