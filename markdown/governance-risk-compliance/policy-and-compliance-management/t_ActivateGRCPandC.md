---
title: Download GRC: Policy and Compliance Management
description: Before you run GRC: Policy and Compliance Management \(com.sn\_compliance\) in your instance, you must download it from the ServiceNow Store.
locale: en-US
release: australia
...
-   **[Quick start tests for Policy and Compliance Management](../../../administer/atf-quick-start-tests/reference/quick-start-tests-grc-policy-comp.md)**  
...
**Parent Topic:**[Implementing Policy and Compliance Management](../../grc-policy-compliance-implementation/concept/policy-compliance-impl-overview.md)
