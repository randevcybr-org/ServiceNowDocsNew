---
title: Manage policy exceptions and extensions
description: Policy exceptions and extensions provide temporary relief for non-compliant controls.
locale: en-US
release: australia
...
-   **[Request an extension to policy exception](../task/request-policy-extension-platform.md)**  
Request an extension for the policy exception that you created.
-   **[Review the policy exception and extension request](../task/review-policy-exception-request.md)**  
...
-   **[Request a policy exception through Service Portal](../task/request-policy-exception-service-portal.md)**  
...
-   **[Request a policy extension through Service Portal](../task/request-policy-extension.md)**  
...
-   **[Policy Exception Integration with Vulnerability Response](../reference/request-pe-from-vr.md)**  
