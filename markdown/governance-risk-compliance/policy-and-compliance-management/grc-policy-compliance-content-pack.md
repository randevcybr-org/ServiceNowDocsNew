...
The Analytics and Reporting Solution for GRC: Policy and Compliance Management is available on the ServiceNow Store.
...
To enable the Analytics and Reporting solution for GRC: Policy and Compliance Management, perform these steps.

1.  Visit the ServiceNow Store and obtain an entitlement to the Performance Analytics - GRC: Policy and Compliance Management application and associated applications. See [Install a ServiceNow Product](https://store.servicenow.com/sn_appstore_store.do#!/store/help?article=KB0030186) on the ServiceNow Store.
2.  On the instance, navigate to **System Applications** &gt; **All Applications** &gt; **All**.
3.  Locate and install the Performance Analytics - GRC: Policy and Compliance Management application.
