...
Assign an Indicator Task from the list of records. Alternatively, view the details of the record or add a work note prior to assignment. Time to complete this task: 5-10 minutes.
...
8.  Alternatively, to review more details or add work notes, with the Assign Indicator Task screen displayed, tap a record on the list to open it.
