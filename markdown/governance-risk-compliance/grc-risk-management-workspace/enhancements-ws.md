...
-   **Record view**
    ...
    The record view provides detailed information about any record. For example, in the risk statement form, you can view the complete hierarchy including the parent and children of the risk statement. This view provides the complete details including important information such as open indicator breaches, open issues, open risk events and so on.
...
-   **Overview pages of records**
    ...
    The Overview tab of each record provides you a summary of all the information you need in a single view. For example, for a risk record you can see KRI breaches, the controls failures, the number of issues open, the open indicator tasks, the number of risks assessed and so on.
