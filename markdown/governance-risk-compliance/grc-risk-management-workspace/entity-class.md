---
title: Entity classes in GRC
description: Entity classes are used to tag your entities and to provide a complete view of the risk status in your organization.
locale: en-US
release: australia
