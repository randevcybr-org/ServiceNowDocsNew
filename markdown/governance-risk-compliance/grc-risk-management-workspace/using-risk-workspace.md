---
title: Using the Risk Workspace
description: Starting with Version 13.0.5, a new workspace has been introduced for the Risk Management application. The new workspace provides you with an improved User Experience \(UX\) and a simplified user journey.
locale: en-US
release: australia
...
-   **[Common controls in Risk Management](shared-common-controls-in-risk-management.md)**  
...
-   **[Create and run a manual risk indicator in the Risk Workspace](../task/create-a-manual-indicator-risk-ws.md)**  
...
-   **[Create and run a basic risk indicator in the Risk Workspace](../task/create-a-basic-risk-indicator-ws.md)**  
...
-   **[Create and run a scripted risk indicator in the Risk Workspace](../task/create-a-scripted-indicator.md)**  
...
-   **[Issue management in the Risk Workspace](issues-in-ws.md)**  
...
-   **[Perform any object assessment in the Risk Workspace](../task/any-object-assessment-ws.md)**  
...
-   **[Workflow of risk response task](../../grc-risk/concept/workflow-of-risk-response-task.md)**  
...
-   **[Workflow of action item in risk response task](../../grc-risk/concept/workflow-action-item-risk-response-task.md)**  
...
-   **[Create a risk response task in the Risk Workspace](../../grc-risk/task/create-risk-response-task-risk-workspace.md)**  
...
-   **[Associate similar risk events](associate-similar-risk-events.md)**  
...
-   **[Categorizing risks with the Governance, Risk, and Compliance: Predictive Intelligence plugin](categorization-of-risks.md)**  
...
-   **[Create an ORX external event](../task/create-orx-event.md)**  
...
-   **[Report a risk event from the Risk Portal](../task/report-risk-event-risk-portal.md)**  
Report a risk event from the Risk Portal. The Risk Portal provides an easy method to quickly report risk events.
-   **[Chart colors for risk data](../../grc-risk/concept/chart-colors-in-risk.md)**  
You can view your risk data visualizations in different colors for a quick overview of your risks.
-   **[Create a business process in the Risk Workspace](../task/create-business-process-ws.md)**  
...
-   **[Filter data in the risk heatmap workbench](../task/filtering-in-the-risk-heatmap.md)**  
As a risk user, filter data in the risk heatmap workbench to get a granular view of your risks.
-   **[Define the risk appetite for an entity](../task/define-risk-appetite-on-entity.md)**  
...
-   **[Define the risk appetite for a risk](../task/define-risk-appetite-on-risk.md)**  
...
-   **[Define the risk appetite for a risk statement](../task/define-risk-appetite-on-risk-statement.md)**  
...
-   **[Parallel Review and Feedback in Advanced Risk](integrate-advanced-risk-with-parallel-review-feedback.md)**  
...
-   **[Risk assessment project](risk-assessment-project.md)**  
...
-   **[Matrix report in Risk Workspace](matrix-report-in-risk-workspace.md)**  
