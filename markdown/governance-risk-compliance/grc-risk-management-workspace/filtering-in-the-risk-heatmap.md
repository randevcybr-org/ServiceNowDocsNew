...
Role required: sn\_risk\_workspace.operational\_risk\_manager, sn\_risk\_workspace.business\_op\_risk\_manager

## About this task

Using the condition builder feature, the risk heatmap workbench enables you to further filter the risks that need your attention. For example, you can filter risks with high rating. If you have an important filter that you use frequently, you can also save the filter.
