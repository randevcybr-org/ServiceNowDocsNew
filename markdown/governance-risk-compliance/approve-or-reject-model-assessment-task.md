...
Role required: sn\_model\_risk\_mgmt.task\_approver

## Procedure

1.  To approve or reject model assessment and validation tasks from the GRC tasks page, navigate to **All** &gt; **Self-Service** &gt; **Employee Center** and do the following:
    ...
    4.  To approve or reject model validation tasks, select **Model validation tasks** and open the task.
...
2.  To approve or reject model assessment and validation tasks from the Model Risk Workspace, navigate to **All** &gt; **Model Risk Workspace** and do the following:
    ...
    3.  To approve or reject model validation tasks, select **MRM Validations** and open the task.
