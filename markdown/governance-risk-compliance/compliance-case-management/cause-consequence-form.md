...
breadcrumb: [Add cause and consequence, Use, Compliance Case Management, Governance, Risk, and Compliance]
---
...
Status of the cause:-   **Suspected**: When the cause isn’t confirmed.
...
Option to select the cause as the primary cause.
