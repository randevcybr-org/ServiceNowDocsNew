...
-   **[Request a new model](../task/request-new-model.md)**  
...
-   **[Initiate a model risk assessment](../task/review-and-manage-model.md)**  
...
-   **[Perform model risk assessment](../task/perform-model-risk-assessment.md)**  
...
-   **[Create a validation task](../task/create-validation-task.md)**  
...
-   **[Perform model validation](../task/perform-model-risk-validation.md)**  
...
-   **[Approve or reject model assessment and validation tasks](../task/approve-or-reject-model-assessment-task.md)**  
Approve or reject the model assessment and validation tasks either from the Employee Center or Model Risk Workspace.
-   **[Create an issue for model](../task/create-an-issue-for-model-risk.md)**  
...
-   **[Create assessment in the Pre-deployment stage](../task/create-assessment-in-the-pre-deployment-stage.md)**  
...
-   **[Schedule assessment and validation tasks](../task/schedule-assessment-and-validation-tasks.md)**  
...
-   **[Reassign model assessments and validations](../task/reassign-a-model-risk-task.md)**  
...
-   **[Copy assessment responses](../task/copy-assessment-responses-mrm.md)**  
...
-   **[Override model ratings](../task/override-model-ratings.md)**  
...
-   **[Link existing documents to a model record](../task/link-existing-documents-model-record.md)**  
