---
title: Configuring Personal Data Rights
description: Set up the Personal Data Rights to address various types of data rights request.
locale: en-US
release: australia
...
-   **[Configuring Personal Data Rights request type](../task/configure-pdr-request-type.md)**  
...
-   **[Create an action task template](../task/create-an-action-task-template.md)**  
...
-   **[Create a data registry](../task/create-data-registry.md)**  
...
-   **[Generate action tasks for a personal data rights request](../task/generate-pdr-action-tasks.md)**  
...
**Parent Topic:**[Personal Data Rights \(PDR\)](personal-data-rights.md)
