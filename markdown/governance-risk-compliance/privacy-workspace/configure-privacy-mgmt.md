---
title: Configuring Privacy Management
description: Follow the order of the tasks given here to configure Privacy Management. These tasks will help you manage your privacy program effectively.
locale: en-US
release: australia
...
-   **[Configure smart assessment templates for screening assessments](../task/configure-a-smart-assessment-template.md)**  
...
-   **[Configure smart assessment templates for impact assessments](../task/configure-smart-assessment-template-for-impact-assessment.md)**  
...
-   **[Create and validate an assessment configuration](../task/create-an-assessment-configuration.md)**  
Create your assessment configurations to determine when a processing activity must be automatically created.
-   **[Map a table with a processing activity](../task/map-business-app-with-pa.md)**  
