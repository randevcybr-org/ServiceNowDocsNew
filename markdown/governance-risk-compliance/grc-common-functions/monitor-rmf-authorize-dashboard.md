---
title: Monitor the NIST RMF Authorize dashboard
description: The NIST RMF Authorize dashboard provides insights into the overall status of the target.
locale: en-US
release: australia
...
breadcrumb: [Authorize targets, Process overview, NIST RMF Use Case Accelerator, GRC use case accelerators, Common GRC features, Governance, Risk, and Compliance]
---
