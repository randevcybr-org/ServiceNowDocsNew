...
The GRC: Approver Configurator \(sn\_grc\_appr\) application for approval configurations is installed with the GRC: Policy and Compliance Management application.
