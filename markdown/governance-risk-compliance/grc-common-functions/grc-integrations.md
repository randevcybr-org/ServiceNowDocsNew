---
title: Governance, Risk, and Compliance integrations
description: Integrations enhance the ServiceNow GRC product offering, providing users the ability to integrate with third-party applications.
locale: en-US
release: australia
...
Use the following documentation for the installation, verification, and reporting features of the GRC integrations on the ServiceNow Store.
