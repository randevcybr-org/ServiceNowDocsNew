---
title: Group Views
description: Impact enables multiple stakeholder groups within your organization to lead their own digital transformation.
locale: en-US
release: australia
topic_type: concept
last_updated: "2026-03-12"
reading_time_minutes: 1
breadcrumb: [Impact packages, Impact operating model, Exploring Impact, Impact]
---
...
A stakeholder group is defined as the following:

-   A logical, customer-defined group of customer stakeholders who share objectives for the purposes of consuming the Impact product, for instance, HR and Finance.
-   A subset of groups or equal to a single account; a Stakeholder Group may not include multiple accounts.
-   An instance could be associated to one or more stakeholder groups.
...
-   **Getting started**
    ...
    Start a conversation with your [Impact Squad](impact-squad.md) to learn more and to enable the Group Views functionality.
