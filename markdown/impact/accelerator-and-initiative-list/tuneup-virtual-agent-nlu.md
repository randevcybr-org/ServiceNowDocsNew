...
# TuneUp Your Virtual Agent – NLU \(Natural Language Understanding\)

TuneUp Your Virtual Agent – NLU \(Natural Language Understanding\) Accelerator provides guidance on fine-tuning NLU models to optimize value.
...
-   **NLU Assessment**
    ...
    -   Assessment the overall state of NLU Models
-   **Customer Coaching Session \#1 \(up to 90 minutes\)**
    ...
    -   Overview of NLU design
    -   Assessment of current NLU Models
    -   NLU leading practices \(Training Utterances, Entities, and Vocabulary\)
    -   Demonstrate NLU Advanced Features
    -   Prescriptive recommendations to improve and maintain Models
