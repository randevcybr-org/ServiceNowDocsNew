...
Subject matter expert responsible for managing the Service Desk\(s\).
...
Customer Service Agent\(s\) \(Recommended\)

</td><td>

Subject matter expert responsible for ServiceNow Customer Service.
