...
-   **Customer Coaching Session \#1 \(up to 90 minutes\)**
    ...
    -   AI Search architecture and configuration leading practices
    -   AI Search tuning \(Synonym Dictionary and Query Rules\)
    -   Overview of AI Search analytics
    -   Prescriptive guidance to optimize performance
