...
**Note:** If partner users are experiencing any of these issues, or you utilize RFQ APIs, first see the [Partner users/RFQ API sharing settings](common_salesforce_integration_issues.md#section_gml_qby_2hc) section at the end of this topic.
