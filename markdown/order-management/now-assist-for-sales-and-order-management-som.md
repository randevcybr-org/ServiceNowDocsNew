...
description: Now Assist for Sales Force Automation \(SFA\) application packages ServiceNow platform AI capabilities to deliver AI-powered insights and automation to drive faster, smarter sales and order processes.
locale: en-US
release: australia
topic_type: concept
