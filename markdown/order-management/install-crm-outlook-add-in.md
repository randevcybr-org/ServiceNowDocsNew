...
-   Review the [CRM Outlook Add-in](https://store.servicenow.com/sn_appstore_store.do#!/store/application/8f0a13e13bd1fe50c605811f23e45a56) application listing in the ServiceNow Store for information on dependencies, licensing or subscription requirements, and release compatibility.
...
2.  Find the CRM Outlook Add-in application \(sn\_crm\_outlook\) using the filter criteria and search bar.
