...
1.  Create the transaction, for example an opportunity or quote in the CSM Configurable Workspace.
    ...
    3.  When the transaction is created, select **Add line items** to create a line item.

        The tabs \(related lists\) open for the transaction.

2.  Select the Catalog tab to open the product catalog interface, then select the appropriate catalog.
