...
-   **Product hierarchy**: Lists the parent and child product relationships for configurable products. Product hierarchies are configured using relationships and relationship groups. These hierarchies help agents navigate the product at different nodes or levels in a nested bundle. To learn more about how to configure this section of the product configurator, see [Create product offering relationships](../task/som-product-config-offering-relationships.md).
