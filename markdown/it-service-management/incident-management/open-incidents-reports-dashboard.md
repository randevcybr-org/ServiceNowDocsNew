...
List of all incident records for open incidents
...
Table that lets you explore open incidents by combinations of state, assignment group, category, priority, and age.
