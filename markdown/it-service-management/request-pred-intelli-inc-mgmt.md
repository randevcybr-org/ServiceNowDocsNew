...
Predictive Intelligence for Incident Management requires a separate subscription from the rest of the ServiceNow AI Platform.
...
<table id="table_oxk_fsq_hnb"><thead><tr><th>
