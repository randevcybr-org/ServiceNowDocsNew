...
\*Self service and automation implemented to improve % of incidents resolved by first assigned group
...
\*Auto Categorization and Auto Assignment implemented to reduce reassigned count
