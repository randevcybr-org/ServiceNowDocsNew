---
title: Software license reconciliation counters for the legacy Software Asset Management plugin
description: Software counters for the legacy Software Asset Management \(com.snc.software\_asset\_management\) plugin reconcile software rights with software installations to verify compliance.
locale: en-US
release: australia
...
In addition to software counters, the legacy Software Asset Management \(com.snc.software\_asset\_management\) plugin offers [usage counters](../task/t_CreateASoftwareCounter.md) that track a license based on use by a workstation or user.
...
-   **[Get started with software counters for the legacy Software Asset Management plugin](c_GetStartedWithSoftwareCounters.md)**  
...
-   **[Schedule a software count for the legacy Software Asset Management plugin](../task/t_ScheduleASoftwareCount.md)**  
How to schedule a software count for the legacy Software Asset Management \(com.snc.software\_asset\_management\) plugin.
-   **[Use a software counter for the legacy Software Asset Management plugin](c_UseTheSoftwareCounter.md)**  
...
-   **[Create a software counter for the legacy Software Asset Management plugin](../task/t_CreateASoftwareCounter.md)**  
How to create a software counter for the legacy Software Asset Management \(com.snc.software\_asset\_management\) plugin.
-   **[Set up quick counters for the legacy Software Asset Management plugin](c_SetUpQuickCounters.md)**  
...
-   **[View software counter results for the legacy Software Asset Management plugin](../task/t_ViewASoftwareCounterResult.md)**  
...
-   **[View software counter summaries for the legacy Software Asset Management plugin](../task/t_ViewASoftwareCounterSummary.md)**  
...
-   **[View software counter details for the legacy Software Asset Management plugin](../task/t_ViewSoftwareCounterDetail.md)**  
...
-   **[View usage counter results for the legacy Software Asset Management plugin](../task/t_ViewAUsageCounterResult.md)**  
