---
title: License calculations with the legacy Software Asset Management plugin
description: Software license calculations with the legacy Software Asset Management \(com.snc.software\_asset\_management\) plugin count the number of licenses that exist in your network environment.
locale: en-US
release: australia
...
-   **[Calculate software licenses using the legacy Software Asset Management plugin](../reference/r_CalculateSoftwareLicenses.md)**  
Software calculations use license calculation types to determine how software licenses are counted in your organization.
-   **[License calculation types supported by the legacy Software Asset Management plugin](../reference/r_LicenseCalculationTypes.md)**  
...
-   **[Create a custom license type for the legacy Software Asset Management plugin](../task/t_CreateACustomLicenseType.md)**  
...
-   **[Create a custom script for a legacy Software Asset Management plugin license type](../reference/r_CreateTheScript.md)**  
