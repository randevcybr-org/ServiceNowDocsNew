---
title: DEX application monitoring
description: Manage your organization's application monitoring by adding and enabling an application for monitoring using DEX, editing the monitoring parameters, and turning off monitoring.
locale: en-US
release: australia
...
-   **[Onboard for DEX Application and Device Health](../task/dex-onboarding.md)**  
...
-   **[Add an application for monitoring](../task/add-new-application.md)**  
...
-   **[Turn off application monitoring](../task/disable-app-monitor.md)**  
...
-   **[Delete an application from the monitoring list](../task/delete-app-monitor.md)**  
...
-   **[View DEX administrators](../task/view-app-administrators.md)**  
...
-   **[Set up page-level monitoring](set-up-page-level-monitoring.md)**  
