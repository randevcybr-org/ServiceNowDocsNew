...
-   **[Map a device user to a ServiceNow DEX user](map-a-device-user-to-a-servicenow-dex-user.md)**  
...
-   **[Device location determination](location-determination.md)**  
Identify and determine the number of impacted devices based on the location by defining a custom logic.
-   **[Configure ACC to use a proxy for all traffic](../task/configure-acc-to-use-proxy.md)**  
...
-   **[Switch ACC from one instance to another](../task/convert-agent-instance.md)**  
Switch Agent Client Collector \(ACC\) to a different instance.
-   **[Configure MID-less Agent Client Collector using a single-line command](../../../reuse/agent-client-collector-and-dex/configure-acc-midless.md)**  
...
-   **[Convert MID-based ACC to MID-less](../task/convert-midbased-acc.md)**  
...
-   **[Sudo banner validation](sudo-banner-validation.md)**  
