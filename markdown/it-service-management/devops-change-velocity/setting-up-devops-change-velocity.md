---
title: Getting started with DevOps Change Velocity
description: Learn about the setup process for DevOps Change Velocity that is required before configuring integrations with your toolchain.
locale: en-US
release: australia
