...
4.  View a service offering using the Service Builder application.
    ...
    3.  Find and open the service for the service offering that you seek.

        **Tip:** You can narrow your search by using the filter options on the column headings.

    4.  After the service opens, select **Manage Offerings** in the navigation panel to see the list of offerings.
