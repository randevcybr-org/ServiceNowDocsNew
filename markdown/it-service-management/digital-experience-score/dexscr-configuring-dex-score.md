---
title: Configuring Digital Experience Score​
description: Plan and configure your implementation of Digital Experience Score​.
locale: en-US
release: australia
...
-   **[Install Digital Experience Score​](../task/install-dex-score.md)**  
...
-   **[Customize metric definitions](../task/dexscr-customize-dex-score-metric-defs.md)**  
...
-   **[Update DEX Score survey configuration](../task/dexscr-set-survey-config.md)**  
Update the survey configuration to identify the recipients, method, and timing for sending the DEX Score surveys.
