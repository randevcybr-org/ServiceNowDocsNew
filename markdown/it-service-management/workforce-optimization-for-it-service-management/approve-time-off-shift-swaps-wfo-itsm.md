...
Using the team calendar, you can access the list of all of your agents by assignment group. When you select a shift for an agent, you can see the agent's work schedule including the break time. You can also view the number of agents that are scheduled at every time interval for each group.
