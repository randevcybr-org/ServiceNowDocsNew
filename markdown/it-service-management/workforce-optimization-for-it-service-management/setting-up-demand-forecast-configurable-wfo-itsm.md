...
breadcrumb: [Demand Forecast, Scheduling, Workforce Optimization for ITSM, IT Service Management]
---
...
The image shows the end-to-end flow of setting up Demand Forecast.![The infographic shows the end-to-end flow of setting up Demand Forecast](../image/demand-forecast-flowchart.png)

-   **[Configure Demand Forecast](../task/configure-data-collection-configurable-wfo-itsm.md)**  
...
-   **[Modify forecast parameters to visualize forecast data](../task/modify-forecast-parameters-configurable-wfo-itsm.md)**  
...
-   **[Create a manual adjustment for a forecast](../task/create-manual-adjustment-configurable-wfo-itsm.md)**  
...
-   **[Demand Forecast components in Workforce Optimization for ITSM](../reference/configurable-wfo-itsm-demand-forecast-reference.md)**  
...
**Parent Topic:**[Demand Forecast in Workforce Optimization for ITSM](explore-demand-forecast-configurable-wfo-itsm.md)
