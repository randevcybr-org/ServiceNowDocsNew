...
Activate the Change Management Success Probability \(com.snc.change\_management.success\_probability\) plugin to calculate the probability of success of a change request.
