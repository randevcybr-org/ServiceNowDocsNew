---
title: Agentic AI in change management
description: Use the ITSM change management agentic workflows to manage and complete tasks autonomously.
locale: en-US
release: australia
...
2.  Change Management application. For more information, see [Configuring Change Management](configure-change-management.md).
