---
title: Risk conditions and calculation
description: Change Management features provide ways to calculate and assess the risk of change requests, and to identify and resolve conflicts.
locale: en-US
release: australia
