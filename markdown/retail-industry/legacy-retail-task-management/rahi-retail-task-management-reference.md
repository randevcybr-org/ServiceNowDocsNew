---
title: Retail Task Management reference
description: Reference topics provide additional information about Retail Task Management components.
locale: en-US
release: australia
...
-   **[Components installed with Retail Task Management](../reference/rahi-retail-task-management-components.md)**  
...
-   **[Retail Task Management Core data model](../reference/rahi-retail-task-management-data-model.md)**  
