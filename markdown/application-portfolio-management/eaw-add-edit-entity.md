---
title: Add or edit an entity
description: Add an entity or edit an existing entity details that are included in the Enterprise Modeling and Visualization diagram.
locale: en-US
release: australia
topic_type: task
...
5.  Create or update an entity.

    -   To create an entity, select **New**.
    -   To update an existing entity, select an entity, then select **Edit**.
6.  On the Shape Library form, fill in the fields.

    For field information, see [Entity configuration form](../../reference/eaw-reference/eaw-entity-config-form.md).
