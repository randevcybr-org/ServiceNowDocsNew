---
title: Install the Application Total Cost of Ownership \(TCO\) plugin
description: Install the Application TCO store application that you purchased from the ServiceNow Store to make it available on your instance.
locale: en-US
release: australia
topic_type: task
...
# Install the Application Total Cost of Ownership \(TCO\) plugin
...
**Note:** The Application TCO plugin automatically gets installed when you install the Enterprise Architecture Workspace plugin.
