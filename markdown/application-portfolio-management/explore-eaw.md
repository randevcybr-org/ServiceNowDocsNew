...
You can navigate to the Enterprise Architecture Workspace in the following two ways:

-   If Next Experience is activated on your instance, select **Workspaces** then select **Enterprise Architecture Workspace**.
-   If Next Experience isn’t activated on your instance, then on the left navigation bar, enter `Enterprise Architecture Workspace`. Select **Workspace Home** to open the Enterprise Architecture Workspace.
...
-   **[Business stakeholder role for Enterprise Architecture Workspace](../reference/eaw-reference/eaw-business-stakeholder-role.md)**  
...
-   **[Viewing insights of your portfolio](eaw-insights.md)**  
...
-   **[Exploring dashboards in Enterprise Architecture Workspace](eaw-concept/eaw-exploring-dashboards-in-ea-workspace.md)**  
...
-   **[Exploring data certification in the Enterprise Architecture Workspace](eaw-concept/eaw-explore-data-cert.md)**  
...
-   **[Exploring the Setup page in the Enterprise Architecture Workspace](eaw-concept/eaw-setup.md)**  
...
-   **[Exploring Portfolio list view](portfolio-list-view.md)**  
...
-   **[Exploring total cost of ownership \(TCO\) in Enterprise Architecture Workspace](eaw-concept/eaw-manage-application-tco.md)**  
...
-   **[Exploring Technology Portfolio view](eaw-concept/eaw-technology-portfolio-view.md)**  
...
-   **[Exploring digital integration management in Enterprise Architecture Workspace](eaw-concept/eaw-explore-digital-integ-management.md)**  
Exploring digital integration management in Enterprise Architecture Workspace.
-   **[Exploring product capabilities](eaw-concept/eaw-exploring-product-capabilities.md)**  
...
-   **[Open your Configurable Workspace experience in UI Builder task conkeyrefs](../../../reuse/workspace/workspace-open-uib.md)**  
Access your Configurable Workspace experience in UI Builder for editing.
-   **[List of workspaces reference conkeyrefs](../../../reuse/workspace/workspace-list-workspaces.md)**  
List of all workspaces ServiceNow offers to target specific users and issues.
-   **[Exploring the publishing center in Enterprise Architecture Workspace](eaw-concept/publishing-center-in-ea-workspace.md)**  
...
-   **[Exploring the architecture analyzer](eaw-concept/eaw-explore-arch-analyzer.md)**  
...
-   **[Exploring generating documents from diagrams](eaw-concept/generate-doc-from-diagram.md)**  
Generating documents for a diagram helps you to transform modeling diagrams into governed, reusable architectural documents using predefined templates.
