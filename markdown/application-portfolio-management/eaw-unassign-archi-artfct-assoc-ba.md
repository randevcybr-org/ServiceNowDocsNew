...
5.  Select the business application that you want to remove the architectural artifact for.

6.  Select **Architectural Artifacts**.

    A list of artifacts associated with the business application is displayed.

7.  Select the check box next to the architectural artifact that you want to remove and select **Remove**.
