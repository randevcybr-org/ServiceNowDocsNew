...
Although an Enterprise Architecture user \(sn\_apm.apm\_user\) can view a data domain, the access control on the Data Domain \[sn\_apm\_data\_domain\] table is limited to its different users.
