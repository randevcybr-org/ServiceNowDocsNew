...
description: Copy an existing diagram and create a version for it within the selected architectural artifact. You can update the new version as required.
locale: en-US
release: australia
topic_type: task
...
5.  Select **Save as new version**.

    In the Save as new version window, the Version number field is automatically updated with a number for the diagram. This field is a non-editable field.
