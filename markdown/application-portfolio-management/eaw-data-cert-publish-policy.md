---
title: Publish a certification policy
description: Publish a draft policy to activate it and enable certifications to be issued under that policy.
locale: en-US
release: australia
topic_type: task
...
3.  Open a draft policy by selecting the policy name link.

4.  Select **Edit Policy**.

5.  Edit the policy details as required.

6.  Review all the details on the **Review** page.

7.  Select **Publish Policy**.
