---
title: View all TRM categories
description: You can view the list of all Technology Reference Model \(TRM\) categories in the Enterprise Architecture Workspace.
locale: en-US
release: australia
topic_type: task
