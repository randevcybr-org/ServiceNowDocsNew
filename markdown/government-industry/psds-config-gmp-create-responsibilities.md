---
title: Configuring Investigative Case Management role responsibilities
description: Configure role responsibilities that can be assigned to users.
locale: en-US
release: australia
topic_type: task
...
Configure role responsibilities that can be assigned to users.
