...
2.  Enter your email address, a user name, and a password to create a community account.
3.  The system sends a verification email. Click the verification link in the email to confirm your credentials.
4.  Reopen the email invitation and click **Join Forum**.
