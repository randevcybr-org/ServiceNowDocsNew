---
title: Moderate gamification
description: Monitor points earned by users and award points and badges to users based on their participation within the community.
locale: en-US
release: australia
product: Communities
...
-   **[Award or remove points for a community user](../task/gamification-award-user-points.md)**  
...
-   **[Award a badge to a user](../task/gamification-assign-user-badge.md)**  
Award gamification badges to community users to recognize their community activities.
-   **[Remove a badge from a user](../task/gamification-remove-user-badge.md)**  
