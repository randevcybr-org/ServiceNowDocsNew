...
-   **Dashboard and insights**
    ...
    You can drill down into the process KPIs that are most important to your business. You can get the insights into the process inefficiencies that are discovered by the process model. The top identified case inefficiencies across all organizations are:
