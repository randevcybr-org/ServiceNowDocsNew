...
-   Set up the Customer Information view in CSM Configurable Workspace using [Guided Setup](../task/cust-central-configure-info-tab.md).
-   Set up the Customer Information view in CSM Agent Workspace using [Guided Setup](../task/configure-information-tab.md).
