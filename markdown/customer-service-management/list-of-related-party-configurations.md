...
-   Listed role types don’t have any responsibility. Since the correct role and responsibility determine access, related parties aren’t granted access if the **Responsibility** field is left empty.​
