...
Role required: sn\_customerservice\_agent, sn\_customerservice.consumer\_agent, sn\_customerservice\_manager, workspace\_admin, admin
...
5.  Edit the knowledge feedback task description.
