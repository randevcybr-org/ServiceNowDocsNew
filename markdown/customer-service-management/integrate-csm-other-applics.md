---
title: Integrating Customer Service Management with other applications
description: Extend the capabilities of Customer Service Management and connect with other departments to assist with case resolution by integrating with other applications.
locale: en-US
release: australia
topic_type: concept
...
Extend the capabilities of Customer Service Management and connect with other departments to assist with case resolution by integrating with other applications.

Customer Service Management provides integrations with the applications listed in the following table:

|Step|Description|
|----|-----------|
|[Integrating withIT Service Management](integrating-with-it-service-management.md)|Integrate with Incident, Problem, Change, and Request Management applications.|
|[Integrating with Service Portfolio Management](csm-spm-integration.md)|Get visibility into sold products and their associated service offerings with this integration.|
|[Integrating with Continual Improvement Management](csm-continual-improvement-mgmt.md)|Get help with setting goals, organizing effort, and completing tasks.|
||Create and view all FSM work orders and appointments as a Customer Service Management user.|
|[Integrating with IT Operations Management](integration-event-proactive.md)|Create cases proactively from alerts and track the corresponding install base items affected by the alert.|
