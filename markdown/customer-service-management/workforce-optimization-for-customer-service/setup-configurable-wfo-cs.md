---
title: Configuring Workforce Optimization for Customer Service
description: Enable Workforce Optimization for Customer Service and configure settings to use the Channel Management, Scheduling, Teams, and Coaching applications.
locale: en-US
release: australia
...
-   **[Synchronize team calendar with Microsoft Outlook](synch-cal-msoutlook-wfo-cs.md)**  
...
-   **[Setting up Coaching in Workforce Optimization for Customer Service](setup-coaching-configurable-wfo-cs.md)**  
...
-   **[Setting up Demand Forecast in Workforce Optimization for Customer Service](configuring-demand-forecast-configurable-wfo-cs.md)**  
Configure the data that you want to collect, modify forecast parameters, and calibrate manual adjustments using Demand Forecast.
-   **[Setting up Work scheduler in Workforce Optimization for Customer Service](setting-up-work-scheduler-wfo-cs.md)**  
