...
![Workflow displaying the case management process. For the text description, refer to the preceding text in the Getting to know the case management process.](../image/case_management_overview.png "High-level process flow for the case management process")
...
To learn more about case types, see [Customer Service Case Types](customer-service-case-types.md).
...
To learn more about the service definitions, see [Service definitions](csm-service-definitions.md).
...
To learn more about major issue management, see [Major issue management overview](major-issue-management.md).
...
To learn more about customer project management, see [Integrate with Customer Project Management](csm-ppm-configuration.md).
