...
description: A customer service manager can add an existing customer service case as a child to a major case.
locale: en-US
release: australia
topic_type: task
...
3.  Use the filters to narrow the list of cases displayed in the window.
