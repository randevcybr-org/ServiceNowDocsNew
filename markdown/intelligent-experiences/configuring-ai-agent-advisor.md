...
-   **[Confirm installation of AI Agent Advisor](../task/set-up-ai-agent-advisor.md)**  
Confirm the installation of the AI Agent Advisor application.
-   **[Set up automation discovery for AI Agent Advisor](../task/now-assist-center-set-up-automation-discovery.md)**  
