...
![AI Agent Studio overview page.](../image/aia-studio-overview.png "AI Agent Studio overview page")
...
![AI Agent Studio create and manage page.](../image/aia-create-manage.png "AI Agent Studio create and manage page")

## Agentic AI activity

The activity page contains execution logs for both agentic workflows and AI agents. The list allows you to filter based on various fields, including the version. For more information on creating multiple versions of the **List of steps** field, see [Version control for AI agents and agentic workflows](version-control.md).

The following example shows several execution logs in AI Agent Studio.

![AI Agent Studio activity page with list of AI agent and agentic workflow executions.](../image/ais-activity.png "AI Agent Studio activity page")
...
![AI Agent Studio testing home page](../image/aia-test-page-new.png "AI Agent Studio testing page")

![AI Agent Studio testing playground](../image/aia-test-playground.png "AI Agent Studio testing execution")
...
![AI Agent Studio settings page.](../image/aia-studio-settings.png "AI Agent Studio settings page")
...
![AI Agent Analytics dashboard overview page.](../image/aia-analytics-dashboard.png "AI Agent Analytics dashboard overview page")
