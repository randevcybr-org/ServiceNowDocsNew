...
For more information about ITSM pre-built topics, see [ITSM Virtual Agent](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/it-service-management/itsm-virtual-agent/itsm-virtual-agent.md).
...
Link to related ServiceNow documentation for the topic. 
...
The plugins that are needed to use the topic. Select a dependency to go to its documentation and learn how to install it.**Note:** Some plugins may require the admin role to install.
