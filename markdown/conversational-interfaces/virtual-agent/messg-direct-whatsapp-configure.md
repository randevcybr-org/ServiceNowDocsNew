...
1.  [Install Conversational Integration with WhatsApp](messg-direct-whatsapp-install.md).
...
-   **[Set up Conversational Integration with WhatsApp \(WhatsApp Cloud API\)](messg-direct-whatsapp-setup.md)**  
