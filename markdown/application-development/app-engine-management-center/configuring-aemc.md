...
In order to start using AEMC, you must install AEMC on your instances and configure AEMC and related features, such as Application Intake and Pipelines and Deployments.
