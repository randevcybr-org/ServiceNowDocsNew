...
Role required: You must be an admin or your administrator must add you to the Creator Studio Users group.
...
1.  Let's head over to **All** &gt; **App Engine** &gt; **Creator Studio**.
    ...
    **Note:** If you just created an app, this topic picks up right after you created an app, so you can skip to step 3.

2.  Open the application that you want to add a form to.

3.  Select **+ Add form** to get started.

    ![Select to Add form](../image/crs-add-form-new-nav.png "Select to add a form")

4.  Select a catalog template from the list, which your admin can customize.
...
5.  Select **Apply template and continue**.
...
6.  Choose how you want to build the form:
    ...
    This page enables you to specify details for your first form, though you can also do that or edit the details, such as name and description, from inside the app after it's generated.

7.  Select **Save and edit form** to get started editing your form.
