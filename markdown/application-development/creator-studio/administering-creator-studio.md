---
title: Administering Creator Studio
...
-   Administer who can access the experience switcher.
-   Manage collaboration requests.
-   Create and edit templates for forms.
-   Change the table an app uses.
-   Configure custom activities for playbooks.
-   Administer the App type page.
-   Deploy apps to production.
-   Configure user access to deployed apps.

-   **[Approve Creator Studio requests to create an app](../task/cs-create-app-request-approve.md)**  
...
-   **[Administering access to the experience switcher](crs-experience-switcher-role-access.md)**  
...
-   **[Administering collaboration in Creator Studio](creator-studio-admin-collab-tasks.md)**  
...
-   **[Administering templates and forms for Creator Studio](creator-studio-administering-forms.md)**  
...
-   **[Administering an app's associated table](creator-studio-admin-app-table.md)**  
Admins can change the default table that apps built in Creator Studio save their requests to.
-   **[Administering notification emails in Creator Studio](crs-admining-notifications.md)**  
...
-   **[Administering activities in Creator Studio](creator-studio-administering-activities.md)**  
...
-   **[Disable the App type page in Creator Studio](../task/crs-administer-interstitial-page.md)**  
...
-   **[Managing Creator Studio deployments and monitoring app usage](managing-creator-studio-deployments.md)**  
...
-   **[Administering user access for deployed Creator Studio apps](creator-studio-administering-user-access-apps.md)**  
...
-   **[Artifacts that Creator Studio generates when users create an app](../reference/creator-studio-installed-with-app.md)**  
