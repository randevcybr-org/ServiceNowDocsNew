...
-   [Assign source control permissions](delegated-dev-source-control.md)
...
-   [Display or hide update set deployment permissions](display-or-hide-deployment-permissions.md)
