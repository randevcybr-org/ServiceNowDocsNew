...
For an example showing how where the description generated by this script appears, see [Description generation script example](../reference/atf-step-config-xmpls.md#b5m_zrx_yw).
