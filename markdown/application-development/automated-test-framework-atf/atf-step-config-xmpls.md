...
![Add test step](../image/atf-test-step-dlg.png)
...
![Template reminder in test step](../image/atf-xmpl-template-rem.png)

## HTML description example

Here is a portion of the new record form for a custom step named Example Custom Step.

![HTML description example](../image/atf-xmpl-step-config-html.png)

Here is how the step appears in the Add Test Step dialog.

![Add test step](../image/atf-test-step-dlg-html.png)

## Description generation script example

Here is a portion of the new record form for a custom step named Example Custom Step.

![Description generation script example](../image/atf-xmpl-step-config-gen.png)
