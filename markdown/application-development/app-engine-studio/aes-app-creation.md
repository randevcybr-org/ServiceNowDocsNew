---
title: Building apps in App Engine Studio
description: Meet the business needs of your organization by building custom applications in App Engine Studio \(AES\).
locale: en-US
release: australia
...
-   You access App Engine Studio by navigating to **App Engine Studio** &gt; **App Engine Studio** or with the following web address: `<instance-name>.service-now.com/now/appenginestudio`. If you don't have a working link, contact your administrator.
