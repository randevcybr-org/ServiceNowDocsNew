...
5.  Add a logo to the custom template by either dragging the image to the **Browse or drag an SVG image** field or selecting the field, selecting the image from your file directory, and selecting **Open**.
