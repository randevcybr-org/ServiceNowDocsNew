...
4.  Add a logo by either dragging the image to the **Drag app logo or browse to upload** field or selecting the field, selecting the image from your file directory, and selecting **Open**.
...
6.  Control who has access to create, read, write, and delete content in your application by adding or customizing roles.
    ...
    **Note:** At least one role must have **Read** access to be able to update application security.
