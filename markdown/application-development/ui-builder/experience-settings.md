---
title: Experience settings for UI Builder
description: Learn about the UI Builder experience settings to build your own workspace and custom portal experiences.
locale: en-US
release: australia
product: UI Builder
...
![Platform Analytics Experience edit experience settings screen.](../image/experience-settings.png "Workspace edit experience settings screen")

To learn more about the workspace experience settings, see [Configure UI Builder workspace experiences](ui-builder-workspace-settings.md).
...
![Portal edit experience settings screen.](../image/portal-overall-experience-settings.png "Edit experience settings screen")

To learn more about the portal experience settings, see [Configure UI Builder portal experiences](ui-builder-portal-settings.md).
