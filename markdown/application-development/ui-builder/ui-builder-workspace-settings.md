---
title: Configure UI Builder workspace experiences
description: You can change the UI Builder workspace experience settings to fit your company goals.
locale: en-US
release: australia
product: UI Builder
...
-   Change or add the [workspace general settings](../task/workspace-general-settings.md) for your workspace experience. For example, you can change the title, the description, and the path of the workspace.
-   [View the brand and theme setting in your workspace experience](../task/workspace-view-theme-setting.md) to see the theme currently assigned to your experience. The theme sets the look and feel of the experience.
-   Change the [workspace side navigation settings](../task/workspace-side-navigation-settings.md) to add pages to the side navigation in your workspace experience.
-   Modify the [workspace utility settings](../task/workspace-utility-settings.md) to turn on or turn off notifications for your workspace experience. Also, you can change the global search settings for your workspace experience. For example, you can choose to show or hide the search bar in your workspace experience or change the search source that determines where the search results come from.

![Experience settings for Platform Analytics workspace.](../image/experience-settings.png "Experience settings for workspace")

-   **[Change the general settings in your workspace experience](../task/workspace-general-settings.md)**  
...
-   **[View the brand and theme setting in your workspace experience](../task/workspace-view-theme-setting.md)**  
...
-   **[Change the navigation and menu settings in your UI Builder workspace experience](../task/workspace-side-navigation-settings.md)**  
...
-   **[Set up notifications in workspace utility settings](../task/workspace-utility-settings.md)**  
...
-   **[Display global search in a workspace experience](../task/workspace-global-search.md)**  
