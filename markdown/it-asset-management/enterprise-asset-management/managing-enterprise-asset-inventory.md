---
title: Create and manage enterprise asset inventory
description: Keep track of your enterprise assets by efficiently managing inventory.
locale: en-US
release: australia
...
For details on how to create insurance, maintenance, warranty, purchase agreement, non-disclosure, terms &amp; conditions, and service contracts for your enterprise assets, see [Create a contract](../../contract-management/task/t_CreateAContract.md).For details on how to create contracts for your leased enterprise assets, see [Create a contract for your leased enterprise assets](../task/create-eam-lease-contract.md).
...
-   **[Create a stock rule for enterprise assets](../task/create-eamstockrules.md)**  
Create a stock rule to automatically resupply a stockroom based on vendor purchase orders or transfer orders.
-   **[Create a stockroom type for enterprise assets](../task/create-eamstockroom-type.md)**  
...
-   **[Stockroom audit access by role](stockroom-audit-access-eam.md)**  
...
-   **[Close an enterprise asset remediation task](../task/close-an-asset-remediation-task-eam.md)**  
...
-   **[Manage asset put away using the Enterprise Asset Workspace](manage-asset-putaway-stockroom-enterprise-asset-workspace.md)**  
...
-   **[Manage the receiving of assets at stockrooms in the Enterprise Asset Workspace](manage-stockroom-receive-eam.md)**  
...
-   **[Manage stockrooms with inventory reports in the Enterprise Asset Workspace](manage-stockroom-inventory-reports.md)**  
