---
title: Completing a recall order for your enterprise assets
description: After you submit a recall order for any enterprise assets that have been recalled by the asset vendor, you must perform various tasks to complete the order.
locale: en-US
release: australia
...
-   **[Complete the Prepare task for a recalled enterprise asset](../task/complete-prepare-task-recall-order.md)**  
...
-   **[Complete the Notation task for a recalled enterprise asset](../task/complete-notation-task-recall-order.md)**  
...
-   **[Complete the recall process for an enterprise asset through an on-site repair](../task/complete-recall-process-on-site-repair.md)**  
...
-   **[Complete the recall process for an enterprise asset through an off-site repair](../task/complete-recall-process-off-site-repair.md)**  
...
-   **[Complete the recall process for an enterprise asset through an asset replacement](../task/complete-recall-process-asset-replacement.md)**  
...
-   **[Complete the recall process for an enterprise asset through an asset retirement](../task/complete-recall-process-asset-retirement.md)**  
