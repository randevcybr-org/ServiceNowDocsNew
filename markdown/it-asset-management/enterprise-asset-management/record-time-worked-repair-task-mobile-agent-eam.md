---
title: Record time worked on an enterprise asset repair task using the Mobile Agent application
...
-   **[Pause an enterprise asset repair task using the Mobile Agent application](../task/pause-repair-task-eam-mobile-agent.md)**  
...
-   **[Record time worked on an enterprise asset repair task manually using the Mobile Agent application](../task/record-time-eam-repair-mobile-agent.md)**  
