---
title: Managing Return Merchandise Authorization \(RMA\) response orders for defective Device as a Service \(DaaS\) assets
description: If you are a DaaS provider, vendor, or manufacturer, you can fulfill RMA requests from your customers by creating and managing provider-based RMA response orders.
locale: en-US
release: australia
