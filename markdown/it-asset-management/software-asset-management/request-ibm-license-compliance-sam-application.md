...
3.  In the search bar, enter `IBM License Compliance for Software Asset Management` and then select **Search**.
...
5.  On the IBM License Compliance for Software Asset Management page, select **Request Install**.
    ...
    The ServiceNow Request for App Installation - IBM License Compliance for Software Asset Management dialog box opens.
