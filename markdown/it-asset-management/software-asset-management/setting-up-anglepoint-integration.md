...
-   **[Request the IBM License Compliance for Software Asset Management application for Authorized Software Asset Management Provider \(ASP\) integrations](../task/request-ibm-license-compliance-sam-application.md)**  
