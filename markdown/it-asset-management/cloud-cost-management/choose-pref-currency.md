...
Role required: insights\_admin, insights\_owner or insights\_user
...
2.  Select your preferred display currency from the **Currency display preference** drop-down list.
    ...
    The list shows only those currencies that were previously set up and activated in the Multi-currency setup by the insights\_admin.
