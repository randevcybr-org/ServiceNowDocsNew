...
The method how you want to collect the hardware assets from the departing employee. You can pick up the assets or the employee can either drop off or ship them to the organization.
...
If the hardware assets need to be kept on hold because of any legal reasons.
