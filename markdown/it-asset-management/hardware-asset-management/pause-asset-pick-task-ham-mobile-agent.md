...
breadcrumb: [Record time spent on asset pick task, Manage hardware asset pick tasks using the Mobile Agent application, Manage hardware asset tasks using the Mobile Agent application, Using Hardware Asset Management, Hardware Asset Management, IT Asset Management]
---
...
After you start work on the hardware asset pick task, make sure to start recording the time by tapping **Start timer** in the **Details** tab.
