...
6.  Receive the hardware asset in your stockroom.
    ...
    -   If the asset record is found in the Assets list, select the asset record and then select **Receive**.
        -   **Result**
            ...
            -   The receive task in the source workflow associated with the asset that you received is automatically closed.
