---
title: View your hardware asset repair tasks using the Mobile Agent application
...
4.  Filter your tasks by field values.
    ...
    1.  Tap the Filter icon ![](../../enterprise-asset-management/image/filter-mobile-task-eam.png).
