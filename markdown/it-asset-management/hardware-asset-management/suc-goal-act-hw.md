...
-   **[Create a success goal for Hardware Asset Management](../task/create-suc-goal.md)**  
Create a success goal to track the success of the Hardware Asset Management application in your instance.
-   **[Create success activities for HAM success goals](../task/create-suc-act-hw.md)**  
Create success activities to track the success of your created goals.
-   **[Create a success goal category for hardware assets](../task/create-ham-suc-cat.md)**  
Create a success goal category to associate it with the Hardware Asset Management success goal.
-   **[View all maturity items for Hardware Asset Management](../task/view-ham-maturity-items.md)**  
