---
title: Manage stockrooms with inventory reports in the Hardware Asset Workspace
description: Track and manage stockrooms efficiently by evaluating the inventory reports in the Hardware Asset Workspace.
locale: en-US
release: australia
...
-   [Find replacement options for assets](../task/identify-inventory-availability-ham.md).
-   [Quickly identify shortages and align current demand in your stockroom with both current and incoming supply](../task/identify-supply-demand-ham.md).
-   [Analyze the supply to meet open demand across all stockrooms or locations](../task/identify-supply-for-open-demand-ham.md).

-   **[Identify suitable replacement options for assets in the Hardware Asset Workspace](../task/identify-inventory-availability-ham.md)**  
...
-   **[Identify the supply and demand for models within a stockroom in the Hardware Asset Workspace](../task/identify-supply-demand-ham.md)**  
...
-   **[Identify the supply for open demands in the Hardware Asset Workspace](../task/identify-supply-for-open-demand-ham.md)**  
