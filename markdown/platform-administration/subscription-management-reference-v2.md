---
title: Subscription Management reference
description: Reference topics provide information about subscription types, meters, and domain separation support.
locale: en-US
release: australia
topic_type: concept
...
-   **[Types of subscriptions in Subscription Management](types-subscription-v2.md)**  
...
-   **[Subscription Management roles](subscription-management-roles-v2.md#)**  
Subscription Management is installed with these roles.
-   **[Domain separation and Subscription Management](domain-separation-subscription-mgmt.md)**  
