...
-   **[Add and customize a field in a table](../task/t_CreatingNewFields.md)**  
Administrators can add new fields to a table to store and display data.
-   **[Make a field mandatory](../task/t_MakingAFieldMandatory.md)**  
...
-   **[Specify a default field value](../task/t_SpecifyingADefaultValue.md#)**  
...
-   **[Require unique values for a field](../task/t_RequiringUniqueValuesForAField.md)**  
...
-   **[Record numbering](c_ManagingRecordNumbering.md)**  
