...
![Image showing the error message "Detected an issue with one or more upgrade jobs. Your next upgrade might not run. Select here to fix the upgrade jobs."](../image/uc-monitor-issue.png)
