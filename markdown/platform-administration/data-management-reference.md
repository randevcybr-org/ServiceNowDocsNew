...
description: Reference topics provide information about system properties and data limits.
locale: en-US
release: australia
topic_type: concept
...
-   **[System properties](../../database-rotation/reference/r_SetArchiveRuleProcessingBehavior.md)**  
These system properties control the behavior of the Data Management capabilities.
-   **[Archive table size limits](../../database-rotation/reference/data-archive-table-limits.md)**  
...
-   **[Domain separation and Data Management](../concept/domain-separation-data-management.md)**  
...
-   **[Data Management roles](data-management-roles.md#)**  
Data Management includes the following roles.

**Parent Topic:**[Data Management](../concept/c_DataManagement.md)
