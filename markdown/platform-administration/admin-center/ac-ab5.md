...
Use the Cloud Provisioning and Governance application to provide a single interface to access cloud resources, publish cloud offerings to a catalog, and manage the usage of those resources.
...
[Cloud Provisioning and Governance overview \(ServiceNow community\)](https://www.servicenow.com/community/itom-articles/cloud-provisioning-and-governance-and-flow-designer-series-part/ta-p/2323567)
...
Use the Vendor Management Workspace to monitor your company's vendors and manage all vendor-related information.
