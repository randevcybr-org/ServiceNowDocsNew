---
title: Start an application trial from the ServiceNow Store
description: Request a 30-day trial of an app to test its functionality in a non-production instance.
locale: en-US
release: australia
topic_type: task
last_updated: "2026-03-12"
reading_time_minutes: 2
keywords: [servicenow store, store, app store, application store, app store user documentation, servicenow app store, app trial, free trial, get a free trial, try app]
breadcrumb: [Getting apps, ServiceNow Store, Administering applications, Get started, Administer the ServiceNow AI Platform]
---

# Start an application trial from the ServiceNow Store

Request a 30-day trial of an app to test its functionality in a non-production instance.
...
1.  On the ServiceNow Store listing details for the app or integration, select **Request 30-day trial**.
...
3.  Select **Manage entitlements** to choose which non-production instances can install the application during the trial period.
