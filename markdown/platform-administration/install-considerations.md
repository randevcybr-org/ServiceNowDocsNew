...
-   **[Skipped records that occur during application installation](../reference/generation-skip-records-app-installs.md)**  
...
-   **[View the upgrade history of a ServiceNow Store application](../task/view-upgrade-history.md)**  
View the upgrade history of an application that you purchased and installed from the ServiceNow Store.

**Parent Topic:**[Using Legacy Application Manager](../task/using-legacy-application-manager.md)
