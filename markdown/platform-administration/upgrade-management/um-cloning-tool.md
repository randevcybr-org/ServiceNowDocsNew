...
You can achieve the following using the System Clone tool:

-   Clone a ServiceNow instance to a target instance.
-   Clone a ServiceNow instance to a target instance running a different version.
