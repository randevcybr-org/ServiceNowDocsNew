---
title: Setting up defaults required for standard currency use
description: Set up the defaults required for use of standard currency fields in your instance.
locale: en-US
release: australia
