...
ServiceNow AI Platform administrators can access the Application Manager by navigating to **Admin** &gt; **Application Manager**.

## Application Manager users

|User|Description|
|----|-----------|
|Instance admin|Install, update, uninstall, and repair applications and plugins for their instances as needed.|
