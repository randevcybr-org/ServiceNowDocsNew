...
Subscription Management is free and active by default for all production instances and non-production instances. You don't have to activate a plugin.

1.  [Create a Subscription Management administrator](../task/assign-usage-admin-v2.md)

    Assign the usage\_admin role to at least one user who will manage subscriptions for your organization.

2.  [Share subscription data from another instance](../task/share-subscription-data.md)
...
3.  [Configure subscription allocation status in Subscription Management](../task/configure-subscription-allocation-status-v2.md)
...
-   **[Create a Subscription Management administrator](../task/assign-usage-admin-v2.md)**  
Create a Subscription Management administrator by assigning the usage\_admin role to an administrator.
-   **[Share subscription data from another instance](../task/share-subscription-data.md)**  
View subscription data from another instance by enabling data sharing on that instance.
-   **[Configure subscription allocation status in Subscription Management](../task/configure-subscription-allocation-status-v2.md)**  
...
-   **[Manage subscriptions in an on-premise installation](../task/manage-subscriptions-on-prem.md#)**  
