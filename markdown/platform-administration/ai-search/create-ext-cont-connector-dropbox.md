---
title: Create a Dropbox external content connector
description: Create an external content connector to retrieve searchable content and security principals from your Dropbox source system.
locale: en-US
release: australia
product: AI Search
...
# Create a Dropbox external content connector
...
A source system administrator must have already configured your Dropbox source system to allow access by the Dropbox external content connector. For details on configuring these settings in the source system, see [Configure Dropbox for external content indexing](configure-dropbox-external-content-indexing.md).
...
4.  On the Choose source page, select the **Dropbox** tile, then select **Next**.
...
Unique name for this Dropbox external content connector.
...
App key for the OAuth 2.0 application that grants the connector access to your Dropbox content. If you don't have the app key, ask your Dropbox administrator for it.
...
App secret for the OAuth 2.0 application that grants the connector access to your Dropbox content. If you don't have the app secret, ask your Dropbox administrator for it.
    ...
    1.  Select **Validate Connection**.
        ...
        A warning message reports that you're connecting an app to your Dropbox account.

    2.  Select **Continue**, then select **Allow**.

        You're returned to the connector creation page.
...
8.  On the Crawl settings page, modify any default crawl settings that you want to override for this connector, then select **Next**.
    ...
    If you want to skip this step for now, select **Skip** instead of **Next**. You can modify the crawl settings for this connector from the External Content Admin Home page. For details on this procedure and the available crawl settings, see [Configure crawl settings for a Dropbox external content connector](configure-crawl-settings-dropbox-external-content-connector.md).
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for a Dropbox external content connector](configure-crawl-settings-dropbox-external-content-connector.md).
