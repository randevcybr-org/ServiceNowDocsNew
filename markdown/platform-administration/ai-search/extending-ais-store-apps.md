---
title: Extending AI Search with ServiceNow Store applications and integrations
description: Applications and integrations from the ServiceNow Store extend AI Search functionality and provide insight into search usage and behavior.
locale: en-US
release: australia
product: AI Search
...
-   **[AI Search for Next Experience](ais-next-experience-app.md)**
