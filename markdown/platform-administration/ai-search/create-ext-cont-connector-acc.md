...
API key from your Atlassian Administration console. If you don't have this API key, ask your Atlassian administrator for it.
...
Client identifier for the OAuth 2.0 Atlassian developer application that grants Confluence API access to your Atlassian Confluence Cloud source system. If you don't have this client identifier, ask your Atlassian administrator for it.
...
OAuth 2.0 client secret for the OAuth 2.0 Atlassian developer application that grants Confluence API access to your Atlassian Confluence Cloud source system. If you don't have this client secret, ask your Atlassian administrator for it.
    ...
    2.  In the **Use app on** field of the pop-up window, select the site that you specified the URL for in step [5](create-ext-cont-connector-acc.md#connection-settings-step), then select **Accept**.

        ![Pop-up window showing Atlassian account access request from connector.](../image/conf-cloud-requesting-access-account.png)
...
-   To learn how to configure your new connector's crawl settings, see [Configure crawl settings for an Atlassian Confluence Cloud external content connector](configure-crawl-settings-cc-ext-cont-connector.md).
