---
title: Executing a scan
description: Use the following types of scans to execute checks, a scan or a suite scan.
locale: en-US
release: australia
...
-   **[Execute a full scan](../task/hs-execute-full-scan.md)**  
...
-   **[Execute a suite scan](../task/hc-execute-suite-scan.md)**  
...
-   **[Execute a reactive scan](../task/hs-reactive-scan.md)**  
