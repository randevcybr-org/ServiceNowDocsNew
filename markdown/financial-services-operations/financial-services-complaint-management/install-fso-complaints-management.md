...
The following items are installed with Financial Services Complaint Management:
...
2.  Find the Financial Services Complaint Management application \(sn\_bom\_compl\) using the filter criteria and search bar.
