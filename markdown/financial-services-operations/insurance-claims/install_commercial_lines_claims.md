...
The following items are installed with Commercial Lines Claims:
...
2.  Find the Commercial Lines Claims application \(sn\_ins\_claim\_cml\) using the filter criteria and search bar.
