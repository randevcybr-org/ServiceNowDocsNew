...
2.  In the **Search** field, search for **CSM/FSM Configurable Workspace**.
...
1.  In the **Search** field, search for **CSM default record post-Details**.
2.  In the Pages and variants table, navigate to the page collection: **Claim workspace** &gt; **Indiv Life Claim Workspace** &gt; **Settings**.
