...
The following items are installed with the Intelligent Servicing for Fraud application:
...
2.  Find the Intelligent Servicing for Fraud application \(sn\_bom\_fraud\) by using the filter criteria and search bar.
