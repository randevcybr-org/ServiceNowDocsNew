...
Activate the Now Assist for FSO store app \(sn\_fso\_gen\_ai\) to use the skills included in the application.
...
3.  Financial Services Card Operations \(sn\_bom\_credit\_card\)
4.  Now Assist for FSO \(sn\_fso\_gen\_ai\)
