---
title: Implementing Platform Analytics solutions
description: The Platform Analytics Solution contains prepackaged Performance Analytics content that you can use with other ServiceNow AI Platform products. The solution provides you with data visualizations that help you to improve your business processes and quantify the value of your self-services.
locale: en-US
release: australia
topic_type: concept
...
# Implementing Platform Analytics solutions

The Platform Analytics Solution contains prepackaged Performance Analytics content that you can use with other ServiceNow AI Platform products. The solution provides you with data visualizations that help you to improve your business processes and quantify the value of your self-services.

## Required roles and tasks

The following roles and tasks are associated with this Platform Analytics Solution:

-   ServiceNow AI Platform administrator \(admin\): Install and activate this Platform Analytics Solution and make any necessary changes to the system properties.
...
-   **[Activate the Platform Analytics solution for Financial Services Operations](../../dashboards/application-content-packs/fso-install.md)**  
Activate the content pack ServiceNow Store application for the Platform Analytics.
-   **[Business Deposit Operations dashboard](../../dashboards/application-content-packs/fso-business-deposit-dashboard.md)**  
...
-   **[Business Loan Operations dashboard](../../dashboards/application-content-packs/business-loan-operations-dashboard.md)**  
...
-   **[Business Lifecycle Operations dashboard](../../dashboards/application-content-packs/fso-business-lifecycle-dashboard.md)**  
...
-   **[Complaint Management dashboard](../../dashboards/application-content-packs/fso-complaint-mgmt-dashboard.md)**  
...
-   **[Commercial Lines Claims dashboard](../../dashboards/application-content-packs/commercial-lines-claims.md)**  
...
-   **[Commercial Lines Servicing dashboard](../../dashboards/application-content-packs/commercial-lines-servicing-dashboard.md)**  
...
-   **[Client Lifecycle dashboard](../../dashboards/application-content-packs/fso-client-lifecycle-dashboard.md)**  
...
-   **[Dispute Management dashboard](../../dashboards/application-content-packs/card-operations-dashboard.md)**  
...
-   **[Group Life Servicing dashboard](../../dashboards/application-content-packs/group-life-servicing-dashboard.md)**  
...
-   **[Individual Life Servicing dashboard](../../dashboards/application-content-packs/individual-life-servicing-dashboard.md)**  
...
-   **[Payment Operations dashboard](../../dashboards/application-content-packs/payment-operations-dashboard.md)**  
...
-   **[Personal Deposit Operations dashboard](../../dashboards/application-content-packs/fso-personal-deposit-dashboard.md)**  
...
-   **[Personal Lines Claims dashboard](../../dashboards/application-content-packs/personal-lines-claims.md)**  
...
-   **[Personal Lines Servicing dashboard](../../dashboards/application-content-packs/personal-lines-servicing-dashboard.md)**  
...
-   **[Personal Loan Operations dashboard](../../dashboards/application-content-packs/personal-loan-operations-dashboard.md)**  
...
-   **[Treasury Operations dashboard](../../dashboards/application-content-packs/fso-treasury-ops-dashboard.md)**  
...
-   **[Process Mining for Financial Services Operations](../../../product/fso-common/concept/fso-process-optz-content-pack.md)**  
...
**Parent Topic:**[Financial Services](../../../product/fso-common/concept/fso-overview.md)
