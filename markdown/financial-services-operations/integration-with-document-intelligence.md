...
# Integrating with Document Intelligence
...
When a document type is created, Document Intelligence can extract specified fields from each type of document. Document Intelligence then notifies you when the data has been extracted and is available for review.
