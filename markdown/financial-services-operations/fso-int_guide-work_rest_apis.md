...
For example, you will use this API to locate customer records and query specific FSO information, such as customer credit cards, payments, and loans. For additional information on the available tables within FSO, see [Financial Services Operations Core](../../../../product/fso-common/reference/financial-services-operations-core-data-model.md) and the [FSO table definitions](../reference/fso-int_guide-table_defs.md).
...
For a list of all of the FSO roles and descriptions, see [User roles and FSO Business rules](../../../../product/fso-common/reference/fso-core-roles.md).
