...
-   **[Active Sessions](sc-active-sessions.md)**  
View the trend line of the active users on the ServiceNow AI Platform.
-   **[Adaptive authentication Security Metrics](sc-adaptive-authentication.md)**  
...
-   **[Authentication](sc-metrics-authentication.md)**  
...
-   **[Data Classification](data-classification-security-metrics.md)**  
Access the Security Metrics for data classification on your ServiceNow instance.
-   **[Authentication metrics](authentication.md)**  
