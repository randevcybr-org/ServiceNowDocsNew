---
title: Require authorization for excel requests
...
Ensure that the property **glide.basicauth.required.excel** exists in the System Properties \[sys\_properties\] table and is set to **true**.
