...
**Important:** This topic covers the enterprise version of Column Level Encryption. For information on the standard version of Column Level Encryption, or to learn the differences between the two versions, see [Exploring Field Encryption](../../encryption/concept/exploring-fe.md).
...
</table>**Note:** If you choose not to activate Field Encryption Enterprise, you can still use Field Encryption. See [Exploring Column Level Encryption](../../encryption/concept/exploring-column-level-encryption.md) for information.
...
**Parent Topic:**[Exploring Column Level Encryption](../../encryption/concept/exploring-column-level-encryption.md)
