...
As a category, all modal illustrations share color hook mappings. As a result, the colors that you apply to one modal illustration type are also applied to the entire modal illustration category.
...
5.  Select any modal illustration type from the main stage.
    ...
    **Note:** Customizing the colors of any modal illustration type applies the color change to the entire modal category, regardless of which type you select.
    ...
    ![Image styles tab selected with modal illustrations listed on main stage and property panel opened.](../image/tb-modal-property-panel.png "Image styles tab with Modals expanded and Platform/Onboarding all illustration selected")
