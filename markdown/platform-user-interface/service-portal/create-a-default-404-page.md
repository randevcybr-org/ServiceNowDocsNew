---
title: Assign a default error page
description: Create a default 404 error page for your portal using a system property.
locale: en-US
release: australia
...
[Create a page](../task/t_ConfigureAPage.md#) before adding it as the default error page.
...
**Parent Topic:**[Create a portal](../task/create-a-portal.md)
