---
title: Telecommunications Service Management \(TSM\)
description: Telecommunications Service Management \(TSM\) unites customer service and network operations on a single AI-powered platform, enabling communication service providers to resolve issues faster, reduce costs, and improve customer satisfaction.
locale: en-US
release: australia
topic_type: concept
...
-   Connect with other TSM users at [Now Community](https://www.servicenow.com/community/telecom/ct-p/telecommunication).
