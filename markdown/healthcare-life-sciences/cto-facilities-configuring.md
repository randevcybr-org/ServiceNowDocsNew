...
5.  [Add members to your healthcare facilities support organization](../task/cto-facilities-add-members-support-team.md)

    Add members to your facilities support organization to provide visibility and access to healthcare facilities cases.

6.  [Create a group for all location support agents in Care Team Operations for Facilities](../task/cto-facilities-create-group-support-agents.md)
...
7.  [Create a group for all location managers in Care Team Operations for Facilities](../task/cto-facilities-create-group-managers.md)
...
8.  [Set up assignment groups for Care Team Operations for Facilities](../task/cto-facilities-assignment-groups.md)
...
9.  [Modify state decision tables in Care Team Operations for Facilities](cto-facilities-modify-state-tables.md)
...
10. [Add custom record producers to the service catalog in Care Team Operations for Facilities](../task/cto-facilities-add-customer-record-producer.md)
