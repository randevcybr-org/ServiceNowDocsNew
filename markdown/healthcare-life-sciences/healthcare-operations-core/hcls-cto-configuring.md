...
5.  [Create a healthcare location](../task/hcls-sm-configure-healthcare-location.md)

    Create healthcare locations to designate the locations in which your care teams operate.

6.  [Organizing your healthcare locations](../task/untitled3.md)
...
7.  [Create a healthcare organization](hcls-sm-configure-healthcare-organizations.md)
...
11. [Organizing your healthcare organizations for Healthcare Operations Core](../task/example-organizing-hcls-organizations.md)
...
14. [Associate healthcare locations with a healthcare organizations](../task/hcls-sm-associate-healthcare-locations-organization.md)
...
19. [Update variables in record producers to capture tokenized data from Epic Hyperspace](../task/hco-update-variables-portal.md)
