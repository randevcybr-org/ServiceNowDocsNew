---
title: Assign responsibilities to Care Team Operations for Biomed users
description: Assign responsibilities to users in Care Team Operations for Biomed to dictate which specific records users are authorized to view or modify.
locale: en-US
release: australia
topic_type: task
...
# Assign responsibilities to Care Team Operations for Biomed users

Assign responsibilities to users in Care Team Operations for Biomed to dictate which specific records users are authorized to view or modify.
...
You can edit the responsibilities of Care Team Operations for Biomed users when adding or removing members from your healthcare organizations, or at any time as needed.

|Responsibility|Role|
|--------------|----|
|Support Department Agent|sn\_cto\_biomed.loc\_support\_agent|
