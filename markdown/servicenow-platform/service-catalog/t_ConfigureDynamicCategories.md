...
Use dynamic categories to provide users with an access option that automatically adjusts to changing request trends.
...
4.  Use this example of a step with additional info.
