...
By default, this editor is applicable for the Incident and Change tables. For other tables, you can [configure this editor](../task/configure-default-variable-editor.md).
...
-   **[Configure the default variable editor for a task-extended table](../task/configure-default-variable-editor.md)**  
