---
title: Service Catalog and CSDM
description: The Service Catalog lets you create other catalogs \(such as the Request Catalog and the Product Catalog\) that provide self-service opportunities in the channel you want to use, such as the self-service portal, the mobile app, or the Virtual Agent.
locale: en-US
release: australia
