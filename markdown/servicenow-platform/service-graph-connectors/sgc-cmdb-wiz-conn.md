---
title: Accessing the connection details of Service Graph Connector for Wiz
description: You can access the connection details of the Service Graph Connector for Wiz in a single view using the common connection framework \(CCF\) included within the Integration Commons for CMDB \(sn\_cmdb\_int\_util\) store app.Access the details of a Wiz connection configured for the Service Graph Connector for Wiz.
locale: en-US
release: australia
...
keywords: [SGC-Wiz, SGC Wiz, SGC for Wiz, Wiz SGC, Service Graph Connector for Wiz, Wiz connection details, Wiz connection, common connection framework, CCF, SGC-Wiz, SGC Wiz, SGC for Wiz, Wiz SGC, Service Graph Connector for Wiz, Wiz connection details, Wiz connection, common connection framework, CCF]
...
You can access the connection details of the Service Graph Connector for Wiz in a single view using the common connection framework \(CCF\) included within the Integration Commons for CMDB \(sn\_cmdb\_int\_util\) store app.
...
Access the details of a Wiz connection configured for the Service Graph Connector for Wiz.
