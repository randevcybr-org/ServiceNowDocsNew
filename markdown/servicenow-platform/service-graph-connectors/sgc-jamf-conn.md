---
title: Accessing the connection details of Service Graph Connector for Jamf
description: You can access the connection details of the Service Graph Connector for Jamf in a single view using the common connection framework \(CCF\) included within the Integration Commons for CMDB \(sn\_cmdb\_int\_util\) store app.Access the details of a Jamf connection configured for the Service Graph Connector for Jamf.
locale: en-US
release: australia
...
keywords: [SGC-Jamf, SGC Jamf, SGC for Jamf, Jamf SGC, Service Graph Connector for Jamf, Jamf connection details, Jamf connection, common connection framework, CCF, SGC-Jamf, SGC Jamf, SGC for Jamf, Jamf SGC, Service Graph Connector for Jamf, Jamf connection details, Jamf connection, common connection framework, CCF]
...
Access the details of a Jamf connection configured for the Service Graph Connector for Jamf.
