...
Role required: survey\_admin or admin, survey\_creator

**Note:** Users with the survey\_creator role can copy a survey only if they own the survey. If they do not own the survey, they cannot copy it.
