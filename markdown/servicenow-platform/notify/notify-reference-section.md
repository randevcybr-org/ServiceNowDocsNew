...
description: View the additional information about Notify application in this section.
locale: en-US
release: australia
product: Notify
...
-   **[Differences between Notify-Twilio and Notify-Twilio Direct](../reference/difference-notify-twilio-direct.md)**  
...
-   **[Migrate to Notify-Twilio Direct driver](../task/t_MigrateToTwilioDirectDriver.md)**  
...
-   **[Components installed with Twilio Direct driver](../reference/installed-with-twilio.md)**  
...
-   **[Notify flows](notify-flow-designer.md)**  
Use Notify flows to manage the calls and SMS messages.
-   **[Notify workflow activities](../../../administer/workflow-activities/concept/c_NotifyActivities.md)**  
Notify workflow activities manage calls and SMS messages in Notify.
-   **[Components installed with Notify](../reference/installed-with-notify2.md)**  
