---
title: Linking documents to a parent record
description: Documents can be linked to records referred to as "parent records." You can create a document version and reference it through a parent record. You can also view, edit, download, or delete document references in the parent record.
locale: en-US
release: australia
...
The terms "other record" and "parent record" are used interchangeably and refer to any records to which documents are linked.
