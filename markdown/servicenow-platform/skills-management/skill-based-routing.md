---
title: Routing work items to agents based on skills
description: Use rules to automatically route work items to agents.
locale: en-US
release: australia
...
-   **[Add a business rule for skill determination](../task/add-business-rule-skill-determination.md)**  
...
-   **[Create Skill Determination rules to assign skills to work items](../../customer-service-management/task/conf-simple-skill-determination-rule.md)**  
...
-   **[Qualify and rank users based on skills and skill levels](../task/assign-work-based-on-skills.md)**  
