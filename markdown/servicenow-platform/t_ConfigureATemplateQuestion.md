---
title: Configure a template question
...
1.  Drag the **Template** data type icon into a category container.

2.  Click the gear icon in the question title bar to open the template properties dialog box.
...
7.  Configure the properties for the remaining questions.
