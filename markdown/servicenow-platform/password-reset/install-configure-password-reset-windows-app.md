---
title: Installing and configuring Password Reset Windows Application
description: Request the Password Reset Windows App \(Password Reset Orchestration\) \(com.glideapp.password\_reset\_desktop\) plugin that enables connections to the Active Directory \(AD\) credential store types.
locale: en-US
release: australia
...
-   **[Password Reset Windows Application installation requirements](../reference/pass-reset-win-app-install-requirements.md)**  
...
-   **[Download the Password Reset Windows Application installer](../task/win-dwnld-installer-pwr-reset.md)**  
Download the Password Reset Windows Application installer.
-   **[Install Password Reset Windows Application](win-install-password-reset.md)**  
Install Password Reset Windows Application using different available methods.
-   **[Configure security settings for the Password Reset Windows Application](../reference/win-security-properties-password-reset.md)**  
Configuring security settings for the Password Reset Windows Application.
-   **[Configure the Password Reset Windows Application to use a proxy server](../task/win-config-proxy-server-password-reset.md)**  
...
-   **[Enable the Password Reset Windows Application to set the display language for the session](../task/win-display-language-password-reset.md)**  
...
-   **[Integrate McAfee disk encryption with the Password Reset Windows Application](../task/win-mcafee-disk-encrypt-password-reset.md)**  
...
-   **[Customize the Password Reset Windows Application](../task/win-customize-password-reset.md)**  
You can customize the appearance and other aspects of the application.
-   **[Limitations of the Password Reset Windows Application](../reference/win-restrictions-password-reset.md)**  
The Password Reset Windows Application has a few limitations.
-   **[Uninstall the Password Reset Windows Application](../task/win-uninstall-password-reset.md)**  
