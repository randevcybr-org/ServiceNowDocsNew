---
title: Computer \[cmdb\_ci\_computer\] class
description: Attributes, identification rule, and other important schema structures for the CMDB Computer \[cmdb\_ci\_computer\] class.
locale: en-US
release: australia
...
# Computer \[cmdb\_ci\_computer\] class
...
|---------|-----------|
|CD\_ROM​|Denotes whether a CD ROM exists.|
|CD Speed​|Speed of CD\_ROM​.|
...
|-------------------|------------|
|CPU manufacturer​|Company \[core\_company\] table​|
