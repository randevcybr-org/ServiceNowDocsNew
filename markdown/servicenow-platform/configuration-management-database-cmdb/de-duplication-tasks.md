...
-   A single task: [Review de-duplication tasks \(manual\)](../task/t_ResolveDeDuplicationTask.md) and use the Duplicate CI Remediator wizard to process a single de-duplication task.
...
Several properties affect how sets of duplicate CIs are processed. For information about these properties, see [Properties related to remediation of duplicate CIs](../reference/properties-duplicate-ci.md).
...
-   **[Review de-duplication tasks \(manual\)](../task/t_ResolveDeDuplicationTask.md)**  
Review details of de-duplication tasks which remediate duplicate CIs, and then potentially process a de-duplication task.
-   **[Remediate a de-duplication task \(manual\)](../task/reconcile-dup-task.md)**  
...
-   **[Turn off workflows of related tables during remediation](../task/dedup-ci-disable-workflow.md)**  
...
-   **[Manage default related items list](../task/manage-related-items-list.md)**  
...
-   **[Properties related to remediation of duplicate CIs](../reference/properties-duplicate-ci.md)**  
...
-   **[Components installed for duplicate CI remediation](../reference/components-installed-with-dup-ci.md)**  
