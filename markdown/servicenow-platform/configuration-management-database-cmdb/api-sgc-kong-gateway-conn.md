---
title: Accessing the connection details of API Service Graph Connector for Kong Gateway
description: You can access the connection details of the API Service Graph Connector for Kong Gateway in a single view using the common connection framework \(CCF\) included within the Integration Commons for CMDB \(sn\_cmdb\_int\_util\) store app.Access the details of a Kong Gateway connection configured for the API Service Graph Connector for Kong Gateway.
locale: en-US
release: australia
...
# Accessing the connection details of API Service Graph Connector for Kong Gateway

You can access the connection details of the API Service Graph Connector for Kong Gateway in a single view using the common connection framework \(CCF\) included within the Integration Commons for CMDB \(sn\_cmdb\_int\_util\) store app.
...
Access the details of a Kong Gateway connection configured for the API Service Graph Connector for Kong Gateway.
...
1.  Navigate to **All** &gt; **Service Graph Connectors** &gt; **Kong Gateway** &gt; **Connections**.
