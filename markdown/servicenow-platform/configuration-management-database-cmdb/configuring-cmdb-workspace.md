---
title: Configuring CMDB Workspace
description: Plan and configure your implementation of CMDB Workspace.
locale: en-US
release: australia
...
1.  [Set up CMDB Workspace](setup-cmdb-workspace.md)
...
2.  Configure any of the following options to show the most relevant data in your organization:
    -   [Modify important actions on the Home view of CMDB Workspace](../task/cmdb-workspace-edit-imp-action.md)
    -   [Add a quick link to the Home view of CMDB Workspace](../task/cmdb-workspace-add-quick-link.md)
    -   [Configure datacenters for Cloud vs Non-cloud resources in CMDB Workspace](../task/cmdb-workspace-config-datacenter.md)
    -   [Configure classes for Cloud vs Non-cloud resources in CMDB Workspace](../task/cmdb-workspace-config-classes-cloud.md)

-   **[Set up CMDB Workspace](setup-cmdb-workspace.md)**  
