...
|---------------|---------------------------------------------|
|Rating an article|The average rating for an article is carried over to the checked out version. The average rating calculation updates and displays on the current version of the article.|
|Marking an article as helpful|The helpfulness percentage of a previous version of an article is also considered for a new version when displayed in the helpfulness column on the homepage.|
|Comments|The Comments section at the bottom of an article displays comments from previous versions unless Live Feed is enabled. Live Feed only shows comments for the current version.|
|Flagging an article|Checking out an article or setting a previous version to the current version resets the flagged value to false.|
