---
title: Knowledge article creation from an incident
description: Enable users to quickly and easily reuse information from an incident in a knowledge article.
locale: en-US
release: australia
