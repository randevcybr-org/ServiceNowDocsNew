---
title: Use article versioning
description: Use article versioning to create and maintain multiple versions of a knowledge article.
locale: en-US
release: australia
...
-   **[Manually update customized files](../reference/manually-update-customized-files.md)**  
...
-   **[Check out a published article and create a new version](../task/create-new-article-version.md)**  
Create a new version of a knowledge article by checking out the latest published version.
-   **[Revert an outdated article to the current state](../task/revert-previous-article-to-current.md)**  
Use an outdated version of an article to create a new version.
-   **[View all versions of an article](../task/view-all-article-versions.md)**  
View a list of all available versions for a selected knowledge article and then view the selected version in a new tab.
-   **[Compare two versions of an article](../task/compare-two-article-versions.md)**  
Select and compare two versions of a knowledge article.
...
-   **[Disable the article versioning feature](../task/article-versioning-disable-property.md)**  
