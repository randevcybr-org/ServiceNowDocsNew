...
This activity requires that the user executing the command be able to run the **chpasswd** command and, if expiring the password immediately, to run **chage** with [MID Server privileged commands](../../../product/mid-server/concept/c_PrivilegedCommandsForMIDServer.md#).
