...
1.  In the navigation pane, select the resource category, apply a filter \(pre-added or new\), and select **Run** to display and export a set of resources.
...
8.  Create and add one or more sets of conditions by navigating to **New Criteria** &gt; **Create another set of conditions**.
