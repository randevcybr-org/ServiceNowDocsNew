...
-   **[Perform a single-line Agent Client Collector installation on macOS when using a MID Server](../task/acc-install-macOS-single-line.md)**  
...
-   **[Uninstall the Agent Client Collector from macOS using a single-line command](../task/acc-uninstall-mac-single-line.md)**  
...
-   **[Uninstall the Agent Client Collector from a macOS machine manually](../task/acc-uninstall-mac-manual.md)**  
