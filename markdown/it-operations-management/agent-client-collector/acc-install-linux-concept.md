---
title: Agent Client Collector installation on a Linux OS system
description: Install Agent Client Collector on a system that uses a Linux OS, either using a single-line command script, or following the installation procedure to embed in your own package distribution mechanism. The installation procedure provides consistency when using package distribution solutions.
locale: en-US
release: australia
...
-   **[Install Agent Client Collector on a Linux system](../task/install-acc-linux.md)**  
...
-   **[Validate Linux installation](../task/acc-validate-linux-install.md)**  
...
-   **[Upgrade Agent Client Collector on a Linux system](../task/acc-linux-upgrade.md)**  
...
-   **[Uninstall Agent Client Collector from a Linux system manually](../task/acc-linux-uninstall.md)**  
...
-   **[Perform a single-line Agent Client Collector installation on Linux](../task/acc-oneliner-install.md)**  
...
-   **[Upgrade the Agent Client Collector manually on a Linux system](../task/acc-install-upgrade-linux.md)**  
...
-   **[Uninstall Agent Client Collector from a Linux system using a single-line command](../task/acc-uninstall-linux.md)**  
