---
title: Amazon Redshift Serverless Namespace pattern-based discovery
...
|Field|Description|
|-----|-----------|
|Object Id \[object\_id\]|The Amazon Resource Name \(ARN\) uniquely identifying the namespace.|
...
|DB Name \[db\_name\]|The name of the database associated with the namespace.|
|Namespace ID \[namespace\_id\]|The unique identifier assigned to the Redshift Serverless namespace.|
...
|Field|Description|
|-----|-----------|
|Object ID \[object\_id\]|The ARN uniquely identifying the namespace.|
|Name \[name\]|The name assigned to the Redshift Serverless namespace.|
...
|AWS Redshift Serverless - Namespace \[cmdb\_aws\_redshift\_serverless\_namespace\]|References|Cloud DataBase \[cmdb\_ci\_cloud\_database\]|
