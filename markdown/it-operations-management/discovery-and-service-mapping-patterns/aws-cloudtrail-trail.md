---
title: AWS CloudTrail Trail pattern-based discovery
...
|Field|Description|
|-----|-----------|
|Object ID \[object\_id\]|The Amazon Resource Name \(ARN\) uniquely identifying the CloudTrail trail.|
|Name \[name\]|The name of the CloudTrail trail.|
|Resource type \[resource\_type\]|Type of resource. The value is set to **AWS::CloudTrail::Trail**.|
