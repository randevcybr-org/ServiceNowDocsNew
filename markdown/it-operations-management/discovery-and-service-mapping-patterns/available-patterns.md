---
title: Available on-premise discovery patterns
...
-   **[Apache Cassandra database discovery](../reference/cassandra-discovery.md)**  
...
-   **[Apache Kafka and Apache Zookeeper discovery](../reference/kafka-zookeeper-discovery.md)**  
...
-   **[Apigee Edge Enterprise edition discovery](apigee-edge-discovery.md)**  
...
-   **[Avi Vantage load balancer discovery](../reference/avi-load-balancer-discovery.md)**  
...
-   **[Next-Generation Cisco Firewall discovery](../reference/cisco-fw-discovery.md)**  
...
-   **[Cisco Switch Wireless Access Point \(WAP\) discovery](../reference/cisco-waps-discovery.md)**  
...
-   **[Citrix NetScaler SDX discovery](../reference/citrix-netscaler-sdx-discovery.md)**  
...
-   **[Citrix Xen Hyper-V Discovery](../reference/citrix-xen-hyper-v-discovery.md)**  
...
-   **[Cloudian Storage Discovery](../reference/cloudian-storage-discovery.md)**  
...
-   **[ColdFusion discovery](cold-fusion-discovery.md)**  
...
-   **[Couchbase Database discovery](../reference/couchbase-db-discovery.md)**  
...
-   **[Dell EMC XtremIO storage array discovery](../reference/xtreamio-storage-array-discovery.md)**  
...
-   **[Dell EMC Isilon discovery](emc-isilon-discovery.md)**  
...
-   **[Dell Data Domain storage discovery using Patterns](../reference/emc-data-domain-pattern.md)**  
...
-   **[F5 certificate discovery](../reference/f5-certificate-discovery.md)**  
...
-   **[Next-Generation Fortinet Network Firewall SNMP-based discovery](../reference/fortinet-fw-discovery.md)**  
...
-   **[Gunicorn pattern-based discovery](../reference/gunicorn-pattern.md)**  
...
-   **[HAProxy load balancer discovery with patterns](../reference/haproxy-lb-discovery-pattern.md)**  
...
-   **[HPE BladeSystem Enclosure Discovery](../reference/hpe-bladesystem-enclosure-discovery.md)**  
...
-   **[IBM Db2 on Linux database discovery](../reference/ibm-db2-linux-discovery.md)**  
ServiceNow Discovery uses the Db2 on Linux discovery pattern to find IBM Db2 instances on Linux servers.
-   **[IBM Db2 on Windows database discovery](../reference/ibm-db2-windows-discovery.md)**  
ServiceNow Discovery uses the Db2 on Windows discovery pattern to find IBM Db2 instances on Windows servers.
-   **[IBM Informix Dynamic Server discovery](ibm-informix-discovery.md)**  
...
-   **[IBM PowerHA SystemMirror for AIX discovery](../reference/ibm-powerha-hamcp-discovery.md)**  
...
-   **[IBM Virtualization and Hardware Management Console discovery](../reference/ibm-hmc-discovery.md)**  
...
-   **[IBM WebSEAL discovery](../reference/ibm_webseal_discovery_patterns.md)**  
...
-   **[IBM WebSphere Application Server discovery using patterns](../reference/ibm-websphere-server-pattern.md)**  
...
-   **[InfiniBox Discovery](../reference/infinibox-discovery.md)**  
...
-   **[Next-Generation Juniper Network Firewall discovery](../reference/juniper-fw-discovery.md)**  
...
-   **[Linux Pacemaker Cluster discovery](../reference/linux-pacemaker-cluster-discovery.md)**  
...
-   **[NetApp SolidFire storage system discovery](../reference/solidfire-storage-pattern.md)**  
...
-   **[Network router discovery using patterns](../reference/network-router-patterns.md)**  
...
-   **[Network switch discovery using patterns](../reference/network-switch-patterns.md)**  
...
-   **[NVIDIA GPU discovery using patterns](../reference/nvidia-gpu-discovery-pattern.md)**  
...
-   **[Oracle Analytics Server pattern-based discovery](../reference/oracle-analytics-server-pattern.md)**  
...
-   **[Oracle Linux Virtualization Manager and Red Hat Virtualization discovery](../reference/red-hat-virtualization-discovery.md)**  
...
-   **[Oracle Listener HD discovery](../reference/oracle-listener-hd-discovery.md)**  
...
-   **[Oracle Solaris LDOM discovery](../reference/solaris-ldom-discovery.md)**  
...
-   **[Palo Alto Networks firewall discovery](../reference/palo-alto-fw-discovery.md)**  
...
-   **[Pivotal Cloud Foundry discovery](pivotal-cloud-foundry.md)**  
...
-   **[Pure Storage FlashBlade discovery](pure-storage-discovery.md)**  
...
-   **[Red Hat JBoss Fuse discovery](jboss-fuse-discovery.md)**  
...
-   **[Rubrik Cluster discovery](../reference/rubrik-discovery.md)**  
...
-   **[Veritas Cluster Server discovery](veritas-cluster-server-discovery.md)**  
...
-   **[VMware NSX Advanced load balancer discovery](../reference/vmware-nsx-lb-discovery.md)**  
...
**Previous topic:**[Discovery patterns used by ITOM Visibility](c_MappingPatternsCustomization.md)

**Next topic:**[Apache Cassandra database discovery](../reference/cassandra-discovery.md)
