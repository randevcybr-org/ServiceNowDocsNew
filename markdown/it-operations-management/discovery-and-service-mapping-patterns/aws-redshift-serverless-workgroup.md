---
title: Amazon Redshift Serverless Workgroup pattern-based discovery
...
|Field|Description|
|-----|-----------|
|Object Id \[object\_id\]|The Amazon Resource Name \(ARN\) that uniquely identifies the resource.|
...
|Workgroup ID \[workgroup\_id\]|The unique identifier for the Redshift Serverless workgroup.|
...
|Field|Description|
|-----|-----------|
|Object ID \[object\_id\]|The ARN that uniquely identifies the resource.|
|Name \[name\]|The name assigned to the resource or workgroup.|
...
|AWS Redshift Serverless - Workgroup \[cmdb\_aws\_redshift\_serverless\_workgroup\]|References|Cloud DataBase \[cmdb\_ci\_cloud\_database\]|
