---
title: Azure Private Link Private Endpoint pattern-based discovery
...
|Provisioning State \[provisioning\_state\]|The current provisioning or deployment state of the resource.|
|Resource Group \[resource\_group\]|Name of the resource group.|
|Subscription ID \[subscription\_id\]|The subscription ID.|
|Tenant ID \[tenant\_id\]|The identifier for the tenant associated with the resource.|
...
|Resource type \[resource\_type\]|Type of resource. The value is set to **microsoft.network/privateendpoints**.|
...
|Azure Private Link - Private Endpoint \[cmdb\_azure\_private\_link\_private\_endpoint\]|References|Cloud Resource \[cmdb\_ci\_cmp\_resource\]|
