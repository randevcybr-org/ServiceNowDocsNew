---
title: Azure Key Vault pattern-based discovery
...
|Public Network Access \[public\_network\_access\]|Indicates whether the resource is accessible over a public network.|
|Resource Group \[resource\_group\]|Name of the resource group.|
|Subscription ID \[subscription\_id\]|The subscription ID.|
|Tenant ID \[tenant\_id\]|The unique identifier of the Azure Active Directory tenant to which the resource belongs.|
...
|Resource type \[resource\_type\]|Type of resource. The value is set to **microsoft.keyvault/vaults**.|
...
|Azure Key Vault \[cmdb\_azure\_key\_vault\_key\_vault\]|References|Cloud Resource \[cmdb\_ci\_cmp\_resource\]|
