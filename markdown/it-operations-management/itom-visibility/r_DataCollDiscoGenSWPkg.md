...
|-----|----------|----------|------|
|Name|cmdb\_ci\_spkg|name|Various|
|Version|cmdb\_ci\_spkg|version|Various|
|Install count|cmdb\_ci\_spkg|install\_count|Various|
|License count|cmdb\_ci\_spkg|license\_count|Various|
|Microsoft SMS ID|cmdb\_ci\_spkg|msft\_sms\_id|Various|
