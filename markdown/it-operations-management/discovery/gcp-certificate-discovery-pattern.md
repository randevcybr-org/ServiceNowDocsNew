---
title: GCP Certificate Manager discovery
...
The **Google Cloud Platform \(GCP\) - Certificate Manager Certificates** pattern and **Google Cloud Platform \(GCP\) - Classic Certificates** pattern support the discovery of the following table and fields.
...
|CI|Relationship|CI|
|---|------------|---|
|Unique Certificate​ \[cmdb\_ci\_certificate\]|Hosts::Hosted on|Google Datacenter​ \[cmdb\_ci\_google\_datacenter\]​|
