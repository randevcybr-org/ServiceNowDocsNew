...
To enable the solution plugin for Discovery, an admin can navigate to **System Definitions** &gt; **Plugins** and activate the Performance Analytics - Content Pack - Discovery plugin.
