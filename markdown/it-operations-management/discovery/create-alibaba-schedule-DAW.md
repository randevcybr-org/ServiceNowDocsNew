...
-   You have created suitable Alibaba Cloud API credentials in the ServiceNow AI Platform. For more information, see [Create Alibaba Cloud API Credentials](create-alibaba-cloud-api-credentials.md).
