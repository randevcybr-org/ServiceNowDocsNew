...
To learn more about SLOs, including SLO types and compliance periods, see [Working with reliability metrics](../../slo-management/concept/sr-work-SLI-SLO.md). To edit or deactivate an SLO in SRM, see [Edit a reliability metric](../../slo-management/task/sr-edit-sli-slo.md).

**Parent Topic:**[Generating service level objectives](../concept/now-assist-itom-slo-generation.md)
