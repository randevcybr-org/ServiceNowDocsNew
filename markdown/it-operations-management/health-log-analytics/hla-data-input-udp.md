---
title: Configure a UDP data input in Health Log Analytics manually
description: Set up a data input for sending raw log messages to your ServiceNow instance directly over a UDP socket.
locale: en-US
release: australia
