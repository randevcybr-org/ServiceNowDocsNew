---
title: Deactivate a log data integration in Health Log Analytics
...
4.  In the **Installed integrations** tab, search for and select the integration tile for the integration you want to deactivate.
