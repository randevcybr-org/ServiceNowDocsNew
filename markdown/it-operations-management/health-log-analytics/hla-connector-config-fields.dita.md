---
title: Integration configuration fields
description: This section provides descriptions of the fields on the integration configuration forms for Health Log Analytics.
locale: en-US
release: australia
...
keywords: [data input, integration, configuration, fields, description, ServiceNow, Health Log Analytics, HLA]
...
-   **[Amazon CloudWatch integration configuration fields](../reference/il-connector-hla-cloudwatch-fields.md)**  
Description of the fields on the Amazon CloudWatch integration configuration forms for Health Log Analytics.
-   **[Amazon S3 integration configuration fields](../reference/il-connector-hla-aws-s3-fields.md)**  
...
-   **[Amazon Data Firehose integration configuration fields](../reference/il-connector-hla-firehose-fields.md)**  
Description of the fields on the Amazon Data Firehose integration configuration forms for Health Log Analytics.
-   **[Cribl integration configuration fields](../reference/il-connector-hla-cribl-fields.md)**  
Description of the fields on the Cribl integration configuration forms for Health Log Analytics.
-   **[Edge Delta REST integration configuration fields](../reference/il-connector-hla-edgedelta-rest-fields.md)**  
Description of the fields on the Edge Delta REST integration configuration form for Health Log Analytics.
-   **[Edge Delta TCP integration configuration fields](../reference/il-connector-hla-edgedelta-tcp-fields.md)**  
...
-   **[REST API integration configuration fields](../reference/il-connector-hla-restapi-fields.md)**  
...
-   **[Splunk Poller integration configuration fields](../reference/il-connector-hla-splunkpoll-fields.md)**  
...
-   **[Vector Agent integration configuration fields](../reference/il-connector-hla-vector-fields.md)**  
