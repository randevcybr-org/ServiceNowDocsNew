---
title: Configure advanced settings for Apache Kafka data inputs in Health Log Analytics manually
description: Configure advanced settings for data inputs used for streaming log data from Apache Kafka to your instance.
locale: en-US
release: australia
...
[Configure an Apache Kafka data input in Health Log Analytics manually](hla-data-input-kafka.md)
