---
title: Configure advanced settings for Microsoft Azure Log Analytics data inputs in Health Log Analytics manually
description: Configure advanced settings for data inputs used for streaming log data from Microsoft Azure Log Analytics to your instance.
locale: en-US
release: australia
...
# Configure advanced settings for Microsoft Azure Log Analytics data inputs in Health Log Analytics manually
...
You can set system parameters for reading log data that determine the actions that the system performs on log data arriving on the MID Server. If no advanced settings are configured, the system uses the default values.
...
[Configure a Microsoft Azure Log Analytics data input in Health Log Analytics manually](hla-data-input-azure.md)
