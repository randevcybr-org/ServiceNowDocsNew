---
title: Application services in Event Management
description: An application service is a set of interconnected applications and hosts which are configured to offer a service to the organization.
locale: en-US
release: australia
...
For general information on application services, see [Application services](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/servicenow-platform/configuration-management-database-cmdb/application-services.md).

-   **[Manually create an application service in Event Management](../task/create-an-application-service.md)**  
...
-   **[Convert manual services to application services](../task/migrate-manual-2-application-service.md)**  
...
-   **[Convert manual services to application services using API](../reference/convert-manual-to-application-service.md)**  
...
-   **[Create an alert query](../task/t_EMCreateAlertGroup.md)**  
An alert query is a set of alerts that meet specific criteria for a particular service.
-   **[Create an application service group](../task/create-service-group.md)**  
...
-   **[Assign a role to a service group](../task/t_EMAssignRoleSvcGroup.md)**  
...
-   **[Activate and configure Service Mapping for top-down discovery](../task/t_EMGetBaselineServiceMapping.md)**  
...
-   **[Configure email notification on application service severity change](../task/t_EMCreateEmailNotificationBusinessService.md)**  
