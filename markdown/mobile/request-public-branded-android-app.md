...
7.  If you selected **iOS and Android** in the **Operating System** field on the **Add basic info** form in Step 3 above, see Step 7 in [Request a new branded iOS app for public distribution](request-public-branded-ios-app.md) for information about filling out the **Set up for iOS** form.
