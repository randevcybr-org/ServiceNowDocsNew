...
Select the link in the "Initial build/update existing app" column of the following table to get information about requesting, testing, and publishing a branded mobile app for your organization.

<table id="table_tmt_qnp_b2c"><thead><tr><th>
...
Mobile Application Management \(MAM\) vendor

</th><th>

Initial build \| Update existing app
...
[Initial build &amp; update existing app](mob-pub-about-custom-apps.md)
