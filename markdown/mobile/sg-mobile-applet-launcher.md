...
Launcher screens serve as landing pages. A launcher screen serves as a container to give your users access to functions and information.

## Launcher screen components

<table id="table_prl_jhq_llb"><tbody><tr><td>

![Mobile launcher screen component hierarchy.](../image/launcher-screen.png)
