---
title: Configure notifications for mobile activity stream mentions
description: Configure your instance to send an email notification or a push notification when a user mentions a contact’s name within a mobile activity stream record.
locale: en-US
release: australia
topic_type: concept
...
-   **[Configure push notifications for mobile activity stream mentions](../task/mentions-config.md)**  
...
-   **[Customize email notifications for mobile activity stream mentions](../task/mentions-mobile-in-email.md)**  
