...
1.  [Set up Field Service user groups](setting-up-field-service-user-groups.md#)
...
2.  [Assign additional managers to user groups when Workforce Optimization for Field Service is installed](assign-additional-managers-to-user-groups.md)
...
4.  [Configure an agent's profile](configure-an-agent-s-profile.md)
