---
title: Setting up your workforce
description: Setting up your workforce involves configuring users, locations, territories, and other foundational data.
locale: en-US
release: australia
...
1.  [Configure the Google Maps API keys](google-maps-api-keys.md)
...
3.  \(Optional\) [Configuring Field Service with Service Locations](Configuring-service-location.md)
...
5.  \(Optional\) [Configuring Field Service Territory Planning](configuring-territory-planning-fsm.md)
...
7.  \(Optional\) [Configuring Field Service Crew Operations](configuring-crew-operations.md)

    Create, modify, and enable crews and their requirements to complete work order tasks that require a crew of agents.

8.  \(Optional\) [Configuring contractor capabilities](configuring-contractor-capabilities.md)
...
9.  \(Optional\) [Configuring Field Service Capacity and Reservations Management](configuring-capacity-management.md)
...
10. \(Optional\) [Configuring Workforce Optimization for Field Service](configuring-wfo-fsm.md)
...
11. \(Optional\) [Configuring denormalized tables in Field Service Management](denormailized-tables-fsm.md)
