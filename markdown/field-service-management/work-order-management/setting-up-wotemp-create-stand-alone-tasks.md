...
Template management enables you to create standalone work order task templates and link them to different work order templates. This enables the work order templates to identify an appropriate task and create it for different work orders based on the defined filtering conditions.

You first create standalone work order task templates and then map them to the work order templates.
