...
Telecom Cisco Switch pattern is part of the Telecommunications Discovery Patterns application \(sn\_tsom\_patterns\), which is part of TSOM Visibility.
...
<table id="table_uvx_qyn_zdc"><thead><tr><th>
