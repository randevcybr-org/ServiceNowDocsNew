...
3.  Select the pie \(![Pie visualization icon](../image/inline-data-vis-pie.png)\), donut \(![donut icon](../image/inline-data-vis-donut.png)\), or semi-donut \(![Data visualization semi-donut icon](../image/inline-data-vis-semi-donut.png)\) visualization type.
...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for pie and donut visualizations](../reference/config-dv-donut-table-data.md).
    -   If your visualization represents indicator data, go to [Indicator data options for pie and donut visualizations](../reference/config-dv-donut-ind-data.md).
    -   If your visualization represents Usage Insights data, go to [Usage Insights data options for pie and donut visualizations](../reference/config-dv-donut-uxa-data.md)
...
-   **[Table data options for pie and donut visualizations](../reference/config-dv-donut-table-data.md)**  
...
-   **[Indicator data options for pie and donut visualizations](../reference/config-dv-donut-ind-data.md)**  
...
-   **[Usage Insights data options for pie and donut visualizations](../reference/config-dv-donut-uxa-data.md)**  
...
-   **[Pie visualization example](../../par-for-workspace/task/dv-example-pie.md)**  
...
-   **[Donut visualization example](../../par-for-workspace/task/dv-example-donut.md)**  
