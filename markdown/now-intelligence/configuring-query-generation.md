...
Select the tables that are subject to Query Generation.
...
-   **[Query Generation skills](../task/enable-query-generation.md)**  
...
-   **[Add a table to the semantic data layer](../task/add-table-semantic-layer.md#)**  
...
-   **[Enable semantic generation for tables in the semantic layer](../task/enable-semantics-generation.md)**  
...
-   **[Tuning the semantic layer](../../ai-data-explorer/concept/semantic-layer-tuning-overview.md)**  
...
**Parent Topic:**[Query Generation](query-generation.md)
