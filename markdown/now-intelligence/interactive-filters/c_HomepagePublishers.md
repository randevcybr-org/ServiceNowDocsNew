...
**Note:** From the Australia release, only users with the report\_admin role can create and edit Core UI interactive filters. To create filters in Platform Analytics experience, see [Filters in Platform Analytics](../../par-for-workspace/concept/interactive-filters-workspace.md).
