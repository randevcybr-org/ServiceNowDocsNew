---
title: Chief Digital Officer Dashboard roles
...
# Chief Digital Officer Dashboard roles

Two roles are associated with this dashboard

## Platform Analytics administrator

The dashboard administrator \(sn\_cdodashboard.cdo\_dashboard\_admin\) is responsible for installing, configuring, and maintaining the CDO Dashboard and its underlying content.
...
The user \(sn\_cdodashboard.cdo\_dashboard\_user\) role is required to access the dashboard.
