---
title: Indicator data options for dial data visualizations
description: When you select an indicator data source for a dial visualization, the following Data configuration options are available.
locale: en-US
release: australia
...
# Indicator data options for dial data visualizations
...
You have selected an indicator data source in [Create a dial data visualization](../task/create-dv-dial-ac.md).
