...
To access the AI summarization tool, the exploration summarization skill must be activated. For more information, see [Activate AI Data Explorer skills](activate-now-ass-explorer.md).
...
![The Summarize button in AI Data Explorer.](../image/nowass-summarize-button.png)

AI generates a summary and places it beneath the goal.The **Summarize** button disappears.

![Summary of exploration of mental health-related HR cases, exposing Product Management as an area of special concern.](../image/nowass-expl-summary.png)

You can place your cursor in the generated summary and edit it, as described in [Write or edit text in an exploration](write-text-exploration.md).

If you change the exploration, you get a message in the summary header that changes have been made.

![Message in the summary header to refresh the summary.](../image/nowass-expl-refresh-summary-msg.png)
...
![Regenerate button summary in the Summary header.](../image/nowass-expl-regenerate-summary.png)
