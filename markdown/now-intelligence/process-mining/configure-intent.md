---
title: Configure intent and activity analysis
...
For the detailed procedure of configuring intent and activity analysis for a process table, see [Configure investigative features](../task/investigative-features.md).

There are system properties that determine how process inefficiency work. For information about the system properties, see [Intent and agent activity analysis properties](../concept/data-cleanup.md#).
