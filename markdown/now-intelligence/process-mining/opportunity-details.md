...
If the Process Inefficiency Highlights skill isn’t activated on the instance, the highlights option isn’t available. However, if the skill is activated, but you don’t have the Process mining for Creator role, then you can only view any highlights that are generated by someone who has the role. For more information about how to generate highlights, see [Generate highlights for improvement opportunities](../task/generate-highlights.md).
