---
title: Chief Risk Officer Dashboard roles
...
# Chief Risk Officer Dashboard roles

Two roles are associated with this dashboard.

## Platform Analytics administrator

The dashboard administrator \(sn\_cro\_dashboard.admin\) is responsible for installing, configuring, and maintaining the CRO Dashboard and its underlying content.
...
The user \(sn\_cro\_dashboard.user\) role is required to access the dashboard.
