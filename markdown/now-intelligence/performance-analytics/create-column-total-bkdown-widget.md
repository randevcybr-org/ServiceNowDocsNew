---
title: Create a columns and total visualization for a breakdown widget
description: To follow changes over time in both the scores of an indicator and the relative proportion of breakdown elements for that indicator, use a Columns and Total visualization in a breakdown widget.
locale: en-US
release: australia
...
![Columns and total visualization for the number of open incidents broken down by priority](../image/columns-total-bkdown.png "Columns and total visualization")
