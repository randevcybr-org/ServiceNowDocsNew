---
title: Create a column visualization for a breakdown widget
description: To compare the elements of one breakdown applied to one indicator, use a column visualization.
locale: en-US
release: australia
...
# Create a column visualization for a breakdown widget

To compare the elements of one breakdown applied to one indicator, use a column visualization.
...
If you want to compare the relative proportion of indicator scores by breakdown elements, and a pie visualization is not appropriate, use a column visualization. Column visualizations are clearer when there are many elements, when several elements are much smaller than others, or when several elements are close to each other in value.

![Open incidents broken down by priority](../image/column-bkdown.png "Column visualization - breakdown")
