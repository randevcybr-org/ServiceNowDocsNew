...
# Try out Complimentary Performance Analytics for Incident Management
...
**Note:** As an alternative to using Complimentary Performance Analytics for Incident Management, you can activate a plugin with the full features of Performance Analytics without a subscription on a non-production instance.
