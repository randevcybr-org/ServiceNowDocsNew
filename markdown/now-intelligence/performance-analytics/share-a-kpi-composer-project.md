...
When you share a project with the right to edit, that user has the same rights technically as a responsible user. The difference has to do with project management: A user who has had a project shared with them simply can edit the project, whereas a responsible user is responsible for the successful implementation of the project.
