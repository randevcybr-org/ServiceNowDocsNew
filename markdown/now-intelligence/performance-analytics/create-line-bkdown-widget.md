---
title: Create a line visualization for a breakdown widget
description: To follow changes over time in the relative proportion of breakdown elements for an indicator, use a line visualization in a breakdown widget.
locale: en-US
release: australia
...
# Create a line visualization for a breakdown widget

To follow changes over time in the relative proportion of breakdown elements for an indicator, use a line visualization in a breakdown widget.
...
A line visualization in a breakdown widget shows how the proportion of indicator scores belonging to different breakdown elements changes over time. To select the time period over which changes are tracked, go to the **Date Settings** tab.

![Line visualization of open incidents broken down by priority](../image/line-bkdown.png "Line visualization - breakdown")
