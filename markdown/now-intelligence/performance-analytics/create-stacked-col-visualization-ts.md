---
title: Create a stacked column visualization for a time series widget
description: To compare and sum the scores of several indicators, create a widget as a time series with a stacked column visualization.
locale: en-US
release: australia
...
![Four indicators for regional sales centers stacked in each column to show both the relative contribution and the sum of all regions](../image/stacked-column-time-series.png "Stacked column visualization - time series")
