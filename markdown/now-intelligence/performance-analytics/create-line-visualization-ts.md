---
title: Create a line visualization for a time series widget
description: To show the trend over time in indicator scores, create a time series widget with a line visualization.
locale: en-US
release: australia
...
To show the trend over time in indicator scores, create a time series widget with a line visualization.
...
Line visualization is the simplest way to show the trend over time in the scores of a single indicator. Consider it the default visualization for a time series. If you are unsure which visualization to use for a time series, use a line.

The following example is a line visualization of the number of open incidents over the month of July. The **Show trend** optional display setting has been enabled.

![A line visualization in a time series](../image/line-open-incidents.png "Line visualization - time series")
...
4.  In the **Visualization** field, select **Line**.
