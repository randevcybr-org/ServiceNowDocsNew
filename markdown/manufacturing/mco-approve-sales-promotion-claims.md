...
| | |
|---|---|
|[Approve all claims](../task/mco-approve-sp-claim.md)|Approve each claim case line.|
|[Reject a claims](../task/mco-reject-all-sp-claims.md)|Reject each claim case line.|
|[Partially approve a claims](../task/mco-partially-approve-spclaims.md)|Partially approve the claim case line.|
...
-   **[Approve all claims](../task/mco-approve-sp-claim.md)**  
As an OEM claims agent, approve all the claim request raised by the dealer.
-   **[Reject a claims](../task/mco-reject-all-sp-claims.md)**  
Reject a claims that was raised by the dealer.
-   **[Partially approve a claims](../task/mco-partially-approve-spclaims.md)**  
