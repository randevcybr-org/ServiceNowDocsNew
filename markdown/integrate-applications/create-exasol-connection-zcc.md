...
description: Establish a zero copy connection to an Exasol database in Zero Copy Connector Hub.
locale: en-US
release: australia
topic_type: task
last_updated: "2026-03-12"
reading_time_minutes: 1
breadcrumb: [Exasol, Community connectors, Zero Copy Connectors, Workflow Data Fabric]
---

# Create an Exasol connection

Establish a zero copy connection to an Exasol database in Zero Copy Connector Hub.
