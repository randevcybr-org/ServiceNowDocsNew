---
title: Import sets
description: Import sets enable administrators to import data from various data sources, and then map that data into ServiceNow tables.
locale: en-US
release: australia
...
keywords: [import data, rte, transform map]
...
**Troubleshoot and get help**
 ...
 -   [Blog: Troubleshooting missing data in date fields](https://community.servicenow.com/community/blogs/blog/2014/05/20/import-sets-troubleshooting-missing-data-in-date-fields)
