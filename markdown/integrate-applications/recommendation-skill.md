...
description: Now Assist for Workflow Data Fabric \(WDF\) includes the oneExtend LLM skill that guides you through integration setup.
locale: en-US
release: australia
topic_type: concept
last_updated: "2026-03-12"
reading_time_minutes: 1
breadcrumb: [Explore, Now Assist for Workflow Data Fabric \(WDF\), Workflow Data Fabric Home, Workflow Data Fabric]
---
...
The oneExtend LLM skill is included with the Now Assist for WDF experience. Follow the instructions in [Configure Now Assist for Workflow Data Fabric \(WDF\)](../task/configure-now-assist-for-workflow-data-fabric.md) to install the plugin.
