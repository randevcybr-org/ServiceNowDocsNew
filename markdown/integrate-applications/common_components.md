...
-   **[Use the GetProcessJobSysID component](../task/use-getprocessjobsysid.md)**  
...
-   **[Use the GracefulStop component](../task/graceful-stop-component.md)**  
...
-   **[Properties of the Common components](../reference/properties-common-components.md)**  
