...
1.  Create a JKS certificate.
    ...
    You can create a JKS certificate for the Oracle Object Storage Management spoke or use the certificate created for the Oracle Cloud IAM spoke. For information about creating the JKS Certificate, see [Create a Java KeyStore \(JKS\) certificate](setup-oracle-iam.md#).

2.  Create X.509 certificate.

    You can create a X.509 certificate for the Oracle Object Storage Management spoke or use the certificate created for the Oracle Cloud IAM spoke. For information about creating a X.509 certificate, see [Create X.509 certificate for the Oracle Cloud IAM spoke](setup-oracle-iam.md#).
