...
-   sn\_ms\_intune\_spoke.microsoft\_intune\_admin, catalog\_admin, and sn\_csd.CSD Admin
-   admin
...
2.  Open a record for the Microsoft Intune application.
...
Name of the configuration record for this application. This record defines the install group and uninstall group for this application. This configuration is required for all deployments, revocations, and leases performed by the Microsoft Intune server.
