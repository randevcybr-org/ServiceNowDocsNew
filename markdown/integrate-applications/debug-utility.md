...
-   **[Use the ConsoleLog component](../task/use-debug-consolelog.md)**  
Write a message to view the console log of RPA Desktop Design Studio by using the ConsoleLog component.
-   **[Use the IsRunningFromStudio component](../task/use-debug-isrunnngfromstudio.md)**  
...
-   **[Use the IsRunningInBotsession component](../task/use-debug-isrunnnginbotsession.md)**  
...
-   **[Properties of the Debug components](../reference/util-debug-prop.md)**  
