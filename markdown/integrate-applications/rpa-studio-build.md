...
-   **[Create an automation project manually](../task/create-automation-project.md)**  
...
-   **[Create an automation project from a template](../task/create-automation-with-template.md)**  
...
-   **[Create a skill project in RPA Desktop Design Studio](../task/create-skill-project.md)**  
Create a skill automation project in RPA Desktop Design Studio that can be reused in other automations.
-   **[Open a local automation project in RPA Desktop Design Studio](../task/open-project-rpa-studio.md)**  
...
-   **[Open a cloud automation project in RPA Desktop Design Studio](../task/open-project-remote-rpa-studio.md)**  
...
-   **[Create user plugins for RPA Desktop Design Studio](../task/install-user-plugins-rpa-studio.md)**  
...
-   **[RPA Desktop Design Studio ports](overview-ports-rpa-studio.md)**  
Components in the RPA Desktop Design Studio have ports that are used while creating an automation workflow.
-   **[Create and use an activity in RPA Desktop Design Studio](../task/configure-activity-rpa-studio.md)**  
Create and use an activity to provide modularity to an automation project in RPA Desktop Design Studio.
-   **[Create and use a variable in RPA Desktop Design Studio](../task/configure-variables-rpa-studio.md)**  
...
-   **[Open Service and Runtime logs](../task/open-logs-rpa-studio.md)**  
...
-   **[Post requisites after installing a hot fix](../task/post-req-hot-fix-rpa.md)**  
