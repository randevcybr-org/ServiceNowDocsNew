...
1.  Navigate to **All** &gt; **Automation Center** &gt; **Administration** &gt; **Automation Tracker**.

2.  On the Automation Tracker page, select **New**.

3.  On the form, specify the flow or action that you want to track as automation.
