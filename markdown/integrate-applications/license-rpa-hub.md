...
For more information about executing RPA scripts, see [Re-evaluate license distribution by executing RPA scripts](../task/execute-rpa-script.md).
...
To retire a robot if the robot machine is not working appropriately, retire the associated unattended robot. For more information, see [Retire a robot in RPA Hub](../task/retire-robot.md).
