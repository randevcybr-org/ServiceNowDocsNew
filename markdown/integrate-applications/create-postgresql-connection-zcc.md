...
description: Establish a zero copy connection to an external PostgreSQL instance in Zero Copy Connector Hub.
locale: en-US
release: australia
topic_type: task
last_updated: "2026-03-12"
reading_time_minutes: 1
breadcrumb: [PostgreSQL, Community connectors, Zero Copy Connectors, Workflow Data Fabric]
---

# Create a PostgreSQL connection

Establish a zero copy connection to an external PostgreSQL instance in Zero Copy Connector Hub.
