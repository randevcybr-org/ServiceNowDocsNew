...
description: Use Now Assist for Workflow Data Fabric \(WDF\) to describe what you want to achieve and get AI-driven recommendations on the right Workflow Data Fabric tools, data assets, and next steps.
locale: en-US
release: australia
...
Use Now Assist for Workflow Data Fabric \(WDF\) to describe what you want to achieve and get AI-driven recommendations on the right Workflow Data Fabric tools, data assets, and next steps.
...
-   [ServiceNow Community on AI and Intelligence](https://www.servicenow.com/community/now-assist/ct-p/now-assist)
