...
-   **[Queue connector methods](../reference/connectors-queues-methods.md)**  
The Queue connector methods enable you to create and manage work items for queues in the RPA Hub.
-   **[Parameters for the Queue connector methods](../reference/queue-connector-method-parameters.md)**  
