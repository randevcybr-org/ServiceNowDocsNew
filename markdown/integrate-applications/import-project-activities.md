...
1.  Open the project that you want to reuse resources from a different automation for.

2.  In the Project Explorer pane, right-click the project and select **Import**.

3.  To select a project that contains the resources that need to be imported, go to the Import Project dialog box, and click the three-dot menu next to **Project File \(.iBot\)**.

4.  Click **Open**.

5.  Click **Load**.

6.  In the Project Items section, select the check boxes next to the options that you want to import so that you can merge or override conflicts.

    If a conflict occurs with any resource that you’re importing, select an option to either merge or override it with the conflict in your project.
