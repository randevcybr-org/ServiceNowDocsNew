...
-   **[Use the ExtractFile component](../task/use-zip-extractfile.md)**  
...
-   **[Use the RemoveFile component](../task/use-zip-removefile.md)**  
Delete a specified file in a zip archive by using the RemoveFile component in RPA Desktop Design Studio.
-   **[Properties of the Zip components](../reference/util-zip-prop.md)**  
