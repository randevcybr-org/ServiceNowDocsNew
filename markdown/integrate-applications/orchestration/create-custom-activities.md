...
3.  Add the [general properties](../reference/General-Flds-Templates.md).
...
</table>10. Click **Continue** to open the [Conditions](../reference/conditions.md) form to create exit condition rules for your activity and then click **Save**.
