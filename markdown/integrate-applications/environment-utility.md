---
title: Environment
description: The Environment components in the RPA Desktop Design Studio retrieve information and perform specific operations on the Windows environment.
locale: en-US
release: australia
topic_type: concept
...
-   **[Use the CurrentDirectory component](../task/use-environment-currentdir.md)**  
Find out the current working directory and its path by using the CurrentDirectory component in RPA Desktop Design Studio.
-   **[Use the GetEnvironmentVariable component](../task/use-environment-getenvvari.md)**  
...
-   **[Use the Is64BitOperatingSystem component](../task/use-environment-is16bitos.md)**  
...
-   **[Use the MachineName component](../task/use-environment-machinename.md)**  
...
-   **[Use the ResolvePath component](../task/use-environment-resolvepath.md)**  
...
-   **[Use the SetEnvironmentVariable component](../task/use-environment-setenvvariable.md)**  
...
-   **[Use the SpecialFolderPath component](../task/use-environment-splfldrpath.md)**  
...
-   **[Use the SystemDirectory component](../task/use-environment-sysdir.md)**  
...
-   **[Use the UserDomain component](../task/use-environment-userdomain.md)**  
...
-   **[Use the UserName component](../task/use-environment-username.md)**  
...
-   **[Properties of the Environment components](../reference/util-environment-prop.md)**  
