...
-   To use the Keyvalue pair connector, see [Use a connector in RPA Desktop Design Studio](../task/use-connector.md).
...
-   **[KeyValuePair connector methods](../reference/keyvaluepair-connector-methods.md)**  
