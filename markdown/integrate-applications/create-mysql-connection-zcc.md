...
description: Establish a zero copy connection to an external MySQL database in Zero Copy Connector Hub.
locale: en-US
release: australia
topic_type: task
last_updated: "2026-03-12"
reading_time_minutes: 1
breadcrumb: [MySQL, Community connectors, Zero Copy Connectors, Workflow Data Fabric]
---
