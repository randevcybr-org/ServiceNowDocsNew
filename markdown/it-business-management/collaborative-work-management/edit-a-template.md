...
-   **Updating Board templates**
    ...
    You can only modify the sharing permissions, template name, and the description of a Board template. The tasks, column order, sorting, custom columns, or any other preferences within the template can't be updated.

-   **Updating Doc templates**

    You can modify sharing permissions along with the format, structure, and pages for a Doc template.
