...
<table id="table_new_allocation_board"><thead><tr><th>
...
Level from which you want to filter resources.-   **Demands/Projects**: When selected, resources are filtered from demands and projects.
-   **Group**: When selected, resources are filtered from a group.
