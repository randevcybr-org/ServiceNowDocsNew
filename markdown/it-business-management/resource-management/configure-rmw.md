...
1.  Install [Install Resource Management Workspace](../task/config-rmw.md) from ServiceNow Store.
2.  [Define custom statuses for resource assignments](../task/define-custom-status-ra.md).
