...
Each time a resource manager makes an allocation, the system creates one or more resource events for that resource. The resource events appear on the user's personal calendar.
