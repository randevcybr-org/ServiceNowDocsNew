---
title: Financials in Project Workspace
...
-   Create a detailed breakdown of the planned costs [using the financials](using-financials-prj-wrkspc.md).
-   [Add, edit, or delete cost plans](../task/create-cost-plan-prj-wrkspc.md) from the side panel.
...
-   [Generate labor costs](../task/gen-labor-costs-prj-wrkspc.md) depending on the resource assignments for the entire scope of the planning item broken down by the financial attributes configured for your organization. For more information on the planning attributes for attribute-based mapping, see [Using the Planning attributes](../../project-management/concept/planning-attributes.md).
-   [Add or edit expense lines](../task/create-expense-line-prj-wrkspc.md) against the cost plans from the side panel with the associated cost plan details pre-populated.
...
![Financials screen for Project Workspace.](../../spw-financials/images/financials-screen-pw.png "Financials screen")
...
-   The pane gives you a tabulated view of the cost plan attributes displaying the Name, Cost type, Expense type, Stat fiscal period, End fiscal period, Total planned cost, Employee type, and Role. You can customize these fields. For more information, see [Customize the left pane view for financials](../../spw-financials/task/customize-fin-left-pane.md).
