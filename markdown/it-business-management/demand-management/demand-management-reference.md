---
title: Demand Management reference
description: Reference information to provide additional details about Demand Management such as the fields, user roles, tables, guidelines, and domain separation information.
locale: en-US
release: australia
...
-   **[Demand tasks](../../planning-and-policy/concept/demand-task.md)**  
...
-   **[Actual cost and effort calculation for a demand and demand task](../../planning-and-policy/concept/actual-cost-effort-calculation-demand.md)**  
...
-   **[Demand Management key terms](../../planning-and-policy/reference/r_DemandManagementKeyTerms.md)**  
Important terms in Demand Management are listed in the table.
-   **[Stage fields](../../planning-and-policy/reference/r_StageFields.md)**  
...
-   **[Composite Fields](../../planning-and-policy/reference/composite-fields.md)**  
A composite field combines information from two fields in a table to form a single field.
-   **[Domain separation and Demand Management](../../planning-and-policy/concept/domain-sep-demand-mgt.md)**  
...
-   **[Data migrated from demands to artifacts](../../planning-and-policy/reference/data-copied-from-demands-to-artifacts.md)**  
Data fields that are migrated from a demand to an artifact when the artifact is created from the demand.
-   **[Demand Management forms](../../planning-and-policy/concept/demand-management-forms.md)**  
Field information for forms used in the Demand Management application.

**Parent Topic:**[Demand Management](../../planning-and-policy/concept/c_DemandManagement.md)
