...
Color to indicate the severity of the risk. **Tip:** You can enter variations of a color to differentiate between risks with similar impact and probability values. For example, you could enter light green to indicate a low-severity risk.
