...
4.  On the Share Dashboard window, fill the details.
    ...
    3.  Select **Add as viewer** or **Add as editor** as required.
        ...
        **Note:** You can select **Add as editor** only if you have the sn\_align\_core.apw\_user role assigned to you.
        ...
        You can also manage to share permissions by selecting a user, group, or role and enabling the **Can share** option.
...
The roles, groups, and users you have shared the dashboard with appears again when you reopen the dialog, along with the rights you have given them.
