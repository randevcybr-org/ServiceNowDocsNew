...
2.  Select the project for which you want to convert a risk, issue, decision, action, or request change record to another RIDAC record.

3.  From the Project form related list, select the risks, issues, decisions, actions, or request changes record to open the form view.
