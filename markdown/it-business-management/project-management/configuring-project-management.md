---
title: Configuring Project Management
description: Learn about the process required to set up and configure Project Management to enable your project managers initiate and plan projects.
locale: en-US
release: australia
