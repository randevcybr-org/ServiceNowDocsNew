...
1.  Navigate to **All** &gt; **Project** &gt; **Projects** &gt; **Export**.
...
</table>2.  A dialog box might prompt you to save the export file.

    Save the file as an XML file. If you are exporting the project from the Planning Console and selected the CSV option, you can save the file in CSV format.
