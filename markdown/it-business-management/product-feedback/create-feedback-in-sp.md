...
Create feedback using the Feedback application and make informed decisions on your product.
...
From the feedback page:-   Select **All feedback** card to view all the feedback records in Feedback application.
...
From the feedback page:-   Select the existing filter card you prefer for composing feedback.
-   Select **New feedback** from either overview or list page.
...
5.  Select **Submit**.
    ...
    You can now track your feedback. Go to the instance and search with the feedback number to open the feedback.
