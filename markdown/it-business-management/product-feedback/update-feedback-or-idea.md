...
# Update Feedback or Product idea records from the list page

Edit the details of a feedback or product idea record and make real-time updates using the list page of feedback or product ideas.
...
Modify feedback or product idea records within the list view or side panel using inline editing. Edit the details inline from the list view or use the side panel. Enable quick updates for fields like short description, state, and others on the list page. You can use the full details page to add work notes, attachments, and view related lists of a feedback or product idea record.
...
-   Select **Browse** and upload a file.
