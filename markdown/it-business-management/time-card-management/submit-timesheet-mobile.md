...
3.  Submit the time sheet using one of the following options.
    ...
    The time sheet is validated against the time sheet policy assigned to you or, if no time sheet policy is assigned, against the default time sheet policy.
