...
Role required: timecard\_admin or timecard\_approver

## About this task

The delegate must have the timecard\_approver role.
...
3.  On the form, fill in the fields.
    ...
    |Field|Description|
    |-----|-----------|
    |User|User from whom the approvals and tasks are delegated to another user.|
