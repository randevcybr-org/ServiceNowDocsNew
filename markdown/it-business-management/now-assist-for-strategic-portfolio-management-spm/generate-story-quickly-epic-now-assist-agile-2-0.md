...
3.  Navigate to the Stories related list.

4.  Select **Generate Story**.

5.  In the context field, enter one or two lines describing the focus of the story.
...
7.  Review and edit any of the generated fields inline to refine the story before saving.
