...
description: The ServiceNow Cost Management application tracks configuration item costs. The costs can be allocated to business units and used in reports.
locale: en-US
release: australia
...
-   **[Task and labor rate cards](../concept/c_TaskAndLaborRateCards.md)**  
...
-   **[Allocating expenses](../concept/c_AllocatingExpenses.md)**  
Expenses can also be allocated to a business entity that is responsible for the expense.
-   **[Budget related records](../concept/c_BudgetRelatedRecords.md)**  
Budgets are related to additional records, displayed as related lists on its form.
-   **[Domain separation and Cost Management](../concept/domain-separation-cost-management.md)**  
