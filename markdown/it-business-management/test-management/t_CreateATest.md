...
Status of the test. Choose from one of the following:-   **Draft**: Test is not ready to be performed.
...
Name of the test indicating what the test is for. For example, **Approve Quote and convert to Order**.
