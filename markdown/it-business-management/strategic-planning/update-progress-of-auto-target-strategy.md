...
1.  Select name of the target for which you want to update actuals.

The target record opens with the **Overview** tab.
...
</table>4.  On the Target form, select the **Update Actual value** related link.
