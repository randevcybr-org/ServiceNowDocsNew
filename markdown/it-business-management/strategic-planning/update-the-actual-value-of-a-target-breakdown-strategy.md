...
<table id="choicetable_whk_swd_tw"><thead><tr><th align="left" id="d87289e82">

Option

</th><th align="left" id="d87289e85">

Steps

</th></tr></thead><tbody><tr><td id="d87289e91">
...
4.  Select the **Quantitative Targets** tab.
5.  From the list of targets, select the target you want to update the actuals for.
6.  Select the **Target Breakdowns** tab.
