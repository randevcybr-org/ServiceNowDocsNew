...
4.  On the Share roadmap form, select users to share the roadmap with and set their access appropriately.
    ...
    2.  From the **Access** field, select the access level as **Viewer** or **Editor** for the users selected.

        For a business stakeholder user, even if you grant the Editor access, they can only add comments on the roadmap.
