...
description: Learn about the fields of the initiative form. Use this form to create or edit the details of an Initiative in Strategic Planning.
locale: en-US
release: australia
...
Detailed information of the initiative.You can refine initiative description using the Refine records skill, if the Now Assist for SPM application is installed.
...
Current working state of the initiative.
...
User assigned to this initiative.
...
State of the initiative in the Strategic Planning workspace.
...
Percentage of work completed for this initiative.
...
Priority of this initiative based on its importance. The available options are:-   **1 - Must have**
-   **2 - Should have**
-   **3 - Could have**
-   **4 - Won’t have**
...
Notes to capture the updates and discussions on the initiative as the work progresses.
...
Strategic priority that this initiative is associated to.
