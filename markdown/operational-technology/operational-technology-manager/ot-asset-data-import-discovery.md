---
title: OT device data import and discovery
description: Multiple methods are available for uploading your existing Operational Technology device data into the ServiceNow AI Platform.
locale: en-US
release: australia
