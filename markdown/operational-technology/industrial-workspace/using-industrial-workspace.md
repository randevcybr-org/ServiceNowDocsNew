---
title: Using the Industrial Workspace
description: After you complete all the required set-up tasks for the Industrial Workspace, users can begin managing their Operational Technology data on the different pages and dashboards available in the Industrial Workspace.
locale: en-US
release: australia
...
-   **[Industrial Workspace homepage destination rules](industrial-workspace-homepage-destination-rules.md)**  
...
-   **[Search for a record in the Industrial Workspace](../task/search-in-industrial-workspace.md)**  
...
-   **[NLQ Genius Results used in the Industrial Workspace](nlq-genius-results-industrial-workspace.md)**  
The Industrial Workspace leverages Natural Language Query \(NLQ\) Genius Results for each search.
-   **[Site filter in the Industrial Workspace](../../mftg-manufacturing-process-mgr/concept/ot-devices-dashboard-filters.md)**  
...
-   **[Operational Technology Progress Scorecard filters](../../mftg-manufacturing-process-mgr/concept/ot-progress-scorecard-filters.md)**  
...
-   **[Sort the Operational Technology Progress Scorecard by ascending or descending order](../task/sort-ot-progress-scorecard.md)**  
...
-   **[Configure the order of your important actions on the Operational Technology Action-Oriented Landing Page](../task/configure-order-important-actions-aolp.md)**  
...
-   **[Indicator sources and indicators for the Operational Technology Vulnerability Response \(PA\) dashboard](../../mftg-manufacturing-ot-vulnerability-response/reference/indicator-and-indicator-sources-otvr-pa-dashboard.md)**  
...
-   **[Operational Technology Vulnerability Response \(PA\) dashboard breakdowns](../../mftg-manufacturing-ot-vulnerability-response/reference/breakdowns-otvr-pa-dashboard.md)**  
The Operational Technology Vulnerability Response uses breakdowns to filter and group the collected records.
-   **[Operational Technology Vulnerability Response \(PA\) dashboard collection jobs](../../mftg-manufacturing-ot-vulnerability-response/reference/collection-jobs-otvr-pa-dashboard.md)**  
...
-   **[Data visualizations used in the Operational Technology Vulnerability Response \(PA\) dashboard](../../mftg-manufacturing-ot-vulnerability-response/reference/data-visualizations-otvr-pa-dashboard.md)**  
...
-   **[View an Operational Technology Unified Map](../../ot-industrial-workspace/task/view-ot-unified-map.md)**  
...
-   **[View a daily summary of Operational Technology device activities for an Equipment Model Entity](../../ot-industrial-workspace/task/view-ot-eme-daily-summary.md)**  
...
-   **[Use the Hardware Vulnerability Assessment menu in the Industrial Workspace](../../mftg-manufacturing-ot-vulnerability-response/task/using-hva-tabs-.md)**  
...
-   **[View and edit the OT Network Map](../../ot-industrial-workspace/task/view-edit-ot-network-map.md)**  
