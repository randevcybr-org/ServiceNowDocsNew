---
title: Using Industrial Process Manager with the Operational Technology Manager
description: After you complete all required set up tasks, including importing equipment models, you can use the Operational Technology Manager and Industrial Process Manager functions on the Industrial Workspace Admin menu. These functions include the Equipment Model Manager and the Industrial Workspace.
locale: en-US
release: australia
