---
title: Using decision tables
description: Using decision tables in Workflow Studio, you can create, modify, test, and update decision tables for use in your workflows and applications. You can also create decision tables in Workflow Studio and then modify them in Excel.
locale: en-US
release: australia
...
-   **[Create decision tables in Workflow Studio](../task/create-decision-table-in-decision-designer.md)**  
...
-   **[Duplicate a decision table](../task/duplicate-decision-table.md)**  
Save time creating similar decision tables by duplicating existing tables in Workflow Studio.
-   **[Edit decision tables using draft authoring](../task/edit-decision-tables-using-draft-authoring.md)**  
...
-   **[Modify decision table structure in Workflow Studio](format-decision-table-in-decision-designer.md#)**  
Evolve with your business logic by modifying the inputs or columns of your decision table in Workflow Studio.
-   **[Modify decision table rules in Workflow Studio](modify-decision-table-rules.md#)**  
...
-   **[Use decision tables](use-decision-tables.md)**  
Decision tables built in Workflow Studio are executed in flows with flow logic or in scripts with API calls.
-   **[Manage decision tables in Excel](manage-decision-tables-ms-excel.md)**  
...
-   **[View related objects in a decision table](../task/view-related-objects-decision-table.md)**  
See and open objects that are related to your decision table, such as flows, subflows,and playbooks.
-   **[Test a decision table in Workflow Studio](../task/test-decision-table-in-decision-builder.md)**  
...
-   **[Create decision table code snippets](../task/create-decision-table-code-snippets.md)**  
...
-   **[Modify Decision Tables in the Classic UI](adjust-unsupported.md#)**  
...
-   **[Delete a decision table](../task/delete-a-decision-table.md)**  
Delete decision tables that you no longer need from the list of decision tables in Workflow Studio.
-   **[Filter conditions in a decision table](../task/filtering-a-decision-table.md)**  
Filter the conditions in the decision table to focus on the necessary data.
-   **[Use enhanced reference record](../task/using-enhanced-reference-record.md)**  
...
-   **[Set rows active or inactive](set-active-inactive-rows.md)**  
...
**Parent Topic:**[Workflow Studio decision tables](../../workflow-studio/reference/workflow-studio-decision-tables-landing.md)
