---
title: Advanced Instruction activity
description: Display detailed instructions to guide end users through your playbook.
locale: en-US
release: australia
...
Details to display in the message to end users.
