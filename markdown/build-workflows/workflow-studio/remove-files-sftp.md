---
title: Remove Files
description: Remove files on an SFTP server, including subfolders, when configured.
locale: en-US
release: australia
...
Option to specify conditions to remove files.
...
Option to specify if files from the subfolders should be removed.
