---
title: Creating and adding a client extension point
description: Create client extension points and add them to the client-side UI scripts in the base application code.
locale: en-US
release: australia
...
breadcrumb: [Using client extension points in client-side UI scripting, Using extension points to extend application functionality, Additional integration resources, Web services, API implementation, API implementation and reference]
---
