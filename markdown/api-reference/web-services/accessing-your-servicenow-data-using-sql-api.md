...
<table id="table_ttk_y4d_m3c" class="nav-card presentation"><tbody><tr><td>

[Explore ![](../../../reuse/icons/brand-icons/bus-explore.svg) Learn about SQL API feature](getting-started-with-servicenow-sql-api.md)

</td><td>

[Configure ![](../../../reuse/icons/brand-icons/bus-sdlc.svg) Install and setup SQL API](configuring-sql-api.md)

</td></tr><tr><td>

[Integrate ![](../../../reuse/icons/brand-icons/bus-integration-and-apis.svg) Integrate SQL API drivers with external business intelligence and database tools](../reference/configure-drivers-bi-tools.md)

</td><td>

[Reference ![](../../../reuse/icons/brand-icons/bus-learn.svg) Get reference information about SQL API](../reference/troubleshooting.md)

</td></tr></tbody>
</table>-   **[Getting started with ServiceNow SQL API](getting-started-with-servicenow-sql-api.md)**  
...
-   **[Integrate SQL API Drivers with external BI tools](../reference/configure-drivers-bi-tools.md)**  
