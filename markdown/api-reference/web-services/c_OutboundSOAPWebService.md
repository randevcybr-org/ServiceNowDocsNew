---
title: Outbound SOAP web service
description: The SOAP Message module can be used to develop, prototype, and save outbound SOAP messages that can be reused in business rules and scripts.
locale: en-US
release: australia
