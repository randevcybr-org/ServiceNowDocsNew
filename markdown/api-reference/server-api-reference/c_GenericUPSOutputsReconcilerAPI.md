---
title: GenericUPSOutputsReconciler - Global
description: The GenericUPSOutputsReconciler script include provides methods to obtain reconciler information for generic uninterruptible power supply \(UPS\) outputs.Returns the reconciliation field.Returns the reconciliation key.Determines if the generic UPS bypass information has changed.Reads the database fields.Reads the discovered information.Sets the database fields.
locale: en-US
release: australia
