...
description: Use the Industrial Root Cause Analysis to identify the cause of disruptions and help prevent re-occurrences.
locale: en-US
release: australia
...
Use the Industrial Root Cause Analysis to identify the cause of disruptions and help prevent re-occurrences.
...
-   **[Create a root cause analysis](../task/create-industrial-root-cause-analysis.md)**  
Create and perform a root cause analysis \(RCA\) for an issue in the Digital Factory Workspace.
-   **[Priority matrix for root cause analysis](../reference/priority-matrix-root-cause-analyses.md)**  
