---
title: Configuring ICW Core
description: Configure Industrial Connected Workforce \(ICW\).
locale: en-US
release: australia
topic_type: concept
...
To make sure that all required components are installed, start by installing the ICW Mobile app.

When you install ICW Mobile, it automatically installs the following dependencies for you:
