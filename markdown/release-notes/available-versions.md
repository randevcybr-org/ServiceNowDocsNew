...
To view security patch and security hotfix release notes, log into [support.servicenow.com](http://support.servicenow.com/) \(formerly HI\).

<table id="AvailableVersions"><thead><tr><th>
...
</table>-   Available: Any user can upgrade to the version. "Available" versions will appear on the [Instance Upgrade Management Dashboard](https://www.servicenow.com/community/upgrades-and-patching-blogs/manage-your-upgrades-with-the-instance-upgrade-management/ba-p/2283562).

    ServiceNow Patching Program targets and patchesare immediately available. Users do not need to request an entitlement to schedule an upgrade to these versions.

-   Available by request: [Contact Customer Service and Support](http://www.servicenow.com/support/contact-support.html) for approval to upgrade to the version.
-   Unavailable: The release version is not available.

## MetricBase releases

For the latest MetricBase on-premise release notes, refer to [KB0748185](https://support.servicenow.com/kb_view.do?sysparm_article=KB0748185).
