...
description: The ServiceNow Now Assist for App Engine application enables creators to enhance custom applications with AI assets that app users can leverage at runtime. Now Assist for App Engine was enhanced and updated in the Australia release.
locale: en-US
release: australia
