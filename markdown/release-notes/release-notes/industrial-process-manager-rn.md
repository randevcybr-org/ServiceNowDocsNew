...
-   **[Additional fields in the OT Subnet Mapping table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/create-a-new-ot-subnet-mapping-record.md)**
    ...
    -   Managed Network
    -   VLAN ID
-   **[OT Discovered Subnets table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/automate-mappings-between-ot-assets-and-equipment-model-entity.md)**
...
-   **[Discovered Subnet value added to the OT Subnet Mapping table](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/create-a-new-ot-subnet-mapping-record.md)**
...
-   **[Updated OT device mapping to equipment model entities in the Industrial Workspace](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/map-ot-devices-in-iw.md)**
...
-   **[Location Validation Map tab](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/operational-technology/industrial-process-manager/create-location-hierarchy-isa.md)**
