...
-   **[AI Desktop Actions release notes](../now-platform-app-engine/agentic-desktop-rn.md)**  
...
-   **[AI Agent Advisor release notes](../analytics-intelligence-reporting/ai-agent-advisor-rn.md)**  
...
-   **[Now Assist AI Agents release notes](../now-platform-user-interface/now-assist-ai-agents-rn.md)**  
...
-   **[Now Assist Center release notes](../analytics-intelligence-reporting/now-assist-center-rn.md)**  
...
-   **[Now Assist for App Engine release notes](../now-platform-app-engine/now-assist-for-app-engine-rn.md)**  
The ServiceNow® Now Assist for App Engine application enables creators to enhance custom applications with AI assets that app users can leverage at runtime. Now Assist for App Engine was enhanced and updated in the Australia release.
-   **[Now Assist for Creator release notes](../now-platform-app-engine/now-assist-for-creator-rn.md)**  
...
-   **[Now Assist for Collaborative Work Management \(CWM\) release notes](../it-business-management/now-assist-for-collaborative-work-management-rn.md)**  
The ServiceNow® Now Assist for Collaborative Work Management \(CWM\) application uses generative AI skills to improve the time to value for tasks you perform in CWM. Now Assist for CWM is a new application in the Australia release.
-   **[Now Assist for Configuration Management Database \(CMDB\) release notes](../now-platform-capabilities/now-assist-cmdb-rn.md)**  
...
-   **[Now Assist for FSM release notes](../field-service-management/now-assist-for-fsm-rn.md)**  
...
-   **[Now Assist for IT Service Management \(ITSM\) release notes](../it-service-management/now-assist-for-itsm-rn.md)**  
...
-   **[Now Assist for Legal Service Delivery \(LSD\) release notes](../legal-service-delivery/now-assist-for-lsd-rn.md)**  
...
-   **[Now Assist release notes](../analytics-intelligence-reporting/now-assist-rn.md)**  
...
-   **[Now Assist for Sales CRM for Telecommunications release notes](../tmt/now-assist-sales-order-management-telecommunications-rn.md)**  
...
-   **[Now Assist for Strategic Portfolio Management \(SPM\) release notes](../it-business-management/now-assist-for-spm-rn.md)**  
...
-   **[Now Assist for Telecommunications, Media and Technology \(TMT\) release notes](../tmt/now-assist-tmt-rn.md)**  
...
-   **[Now Assist for Zero Copy Connector release notes](../now-platform-app-engine/now-assist-for-zero-copy-connector-rn.md)**  
The ServiceNow® Now Assist for Zero Copy Connector application includes generative AI skills and AI agents that can help you use Zero Copy Connectors efficiently. Now Assist for Zero Copy Connector was enhanced and updated in the Australia release.
-   **[Now Assist in Contract Management release notes](../contract-management-pro/cmpro-na-rn.md)**  
...
-   **[Now Assist in Document Intelligence release notes](../analytics-intelligence-reporting/now-assist-document-intelligence-rn.md)**  
...
-   **[Now Assist in Platform Analytics release notes](../analytics-intelligence-reporting/now-assist-platform-analytics-rn.md)**  
