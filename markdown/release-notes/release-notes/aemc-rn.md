...
description: The ServiceNow App Engine Management Center \(AEMC\) application enables admins to manage app development from intake through deployment. AEMC was enhanced and updated in the Australia release.
locale: en-US
release: australia
...
The ServiceNow® App Engine Management Center \(AEMC\) application enables admins to manage app development from intake through deployment. AEMC was enhanced and updated in the Australia release.

## AEMC highlights for the Australia release
...
-   **[Filter and search for requests in AEMC](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/application-development/app-engine-management-center/filter-search-aemc.md#section_kvc_43q_dtb)**
