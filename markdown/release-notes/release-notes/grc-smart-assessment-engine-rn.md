...
description: The ServiceNow Smart Assessment Engine \(SAE\) application streamlines creating, distributing, and managing assessments. It enables you to create customizable assessment templates with detailed instructions and questions to gather information from assessors. SAE was enhanced and updated in the Australia release.
locale: en-US
release: australia
...
The ServiceNow® Smart Assessment Engine \(SAE\) application streamlines creating, distributing, and managing assessments. It enables you to create customizable assessment templates with detailed instructions and questions to gather information from assessors. SAE was enhanced and updated in the Australia release.
