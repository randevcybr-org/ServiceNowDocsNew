---
title: Affected users in cases
description: You can create a new case from one or more affected users in the User \[sys\_user\] table. You can also add users to existing cases.
locale: en-US
release: australia
topic_type: concept
...
-   **[Create a case from affected users](../task/create-cases-from-affected-users.md)**  
...
-   **[Add affected users to existing cases](../task/add-users-to-cases-sir.md)**  
