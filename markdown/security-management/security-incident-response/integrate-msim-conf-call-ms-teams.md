...
-   Start and end Microsoft Teams conference calls directly from major security incidents or a task from the major security workbench.
-   Manage a Microsoft Teams conference call by adding or removing participants.
