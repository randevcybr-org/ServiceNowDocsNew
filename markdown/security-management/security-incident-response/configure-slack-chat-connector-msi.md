---
title: Configure Slack chat connector for major security incidents
...
-   [Get started with Slack chat connector configuration](../reference/get-started-slack-chat-configuration.md)
-   [Activate Slack as a channel provider](../task/activate-slack-channel-provider.md)
-   [Create a chat channel template for Slack](../task/create-chat-channel-template-slack.md)
-   [View chat message activities in Slack](../task/view-chat-message-activities-slack.md)
...
**Parent Topic:**[Configuring Major Security Incident Management](../reference/configuring-major-security-incident-management.md)
