---
title: Configuring Major Security Incident Management
...
-   To get quickly started with Major Security Incident Management configuration, you can refer to the [Major Security Incident Management \(MSIM\) Quick Start Guide](https://store.servicenow.com/sn_appstore_store.do#!/store/application/d591deb12806201057b7a6460e6132c3/3.3.5) on the ServiceNow Store.
-   After installing the Major Security Incident Management app, ensure that you import the update set in [KB1289784](https://support.servicenow.com/kb?id=kb_article_view&sysparm_article=KB1289784) to load the partially pre-configured files.
