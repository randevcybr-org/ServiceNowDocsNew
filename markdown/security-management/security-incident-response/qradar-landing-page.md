---
title: IBM QRadar - Incident Enrichment Integration
description: The IBM QRadar - Incident Enrichment integration searches your logs and adds relevant sighting information to your security incidents.
locale: en-US
release: australia
...
**Set up**
 ...
 -   [Get started with the IBM QRadar - Incident Enrichment integration](../task/activate-configure-qradar-inc-enrich.md)
...
-   [Security Operations - QRadar Sightings Search Flow](../../../security-operations-integrations/concept/secops-integration-sightings-search-qradar-workflow.md)
