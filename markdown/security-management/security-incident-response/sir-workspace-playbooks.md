---
title: Sample Playbooks for SIR Workspace
description: You can create or configure playbooks for SIR Workspace quickly and easily without writing complicated code. You can use these playbooks to resolve security threats in a step-by-step manner. You can invoke the security incident playbook flow automatically or manually.
locale: en-US
release: australia
