...
5.  **To create from an existing list view:**
    ...
    2.  Select the **List** from the drop-down list.
        ...
        **Note:** Whatever list you select from the drop-down list, the list name will be the copy of your main List. For example, if you select **Assigned to Me** within the security incidents section, then the List name will be **Assigned to Me Copy** of the security incidents section.

    3.  Select the columns to be personalized and add filters.
    ...
    5.  After a personalized list view is created, then click on the gear icon and customize the list columns by choosing **Edit columns** option to edit the columns and put them in order that you prefer.
        ...
        -   **Rename** the personalized list view.
        -   **Delete** the personalized list view.
        -   Save the personalized list view as desired using **Save as** option.
        -   **Reset width** of the list view.
        **Note:** You can also directly perform these operations using the other List Actions buttons such as assigning, deleting, exporting the list view which are provided.
...
6.  **To create your own list:**
    ...
    3.  Select the **Source** and **Columns**.
