---
title: Close Session Flow Action
description: Closes a Carbon Black session within the flow.
locale: en-US
release: australia
...
|Failure|Session not closed. More error information is available in the flow action output error.|
