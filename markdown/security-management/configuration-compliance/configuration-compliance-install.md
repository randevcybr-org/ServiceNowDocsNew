...
2.  Browse for Performance Analytics for Configuration Compliance and verify that you have the valid entitlements.

3.  Search for `Performance Analytics for Configuration Compliance`.
