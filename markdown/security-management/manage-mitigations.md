...
2.  Click a mitigation to view all the associated information.
    ...
    In the following illustration, you can view the details for Access Token Manipulation mitigation, its ID, source, and other related information.![View the details for the mitigation and other related information.](../image/mitre-mitigation-overview.gif)
...
Use the [techniques module](view-techniques.md) to add or modify the mitigations data.
