---
title: View related details for an affected user artifact
description: If your case includes affected user artifacts, you can view any related details contained in each affected user referenced by the case.
locale: en-US
release: australia
topic_type: task
...
1.  Open a case that contains affected user artifacts.

2.  Click the **Users** tab.

3.  Click Related Details for the affected user artifact you want to view related details for.

    ![View related deatils for a user](../image/related-details-user.png)
