...
|------|-----------|----------|
|Currencies|Look up currencies from Coupa.|[FX Currency Stage inbound staging table](../reference/spo-fx-currency-inbound-table.md)|
|FX Currency rates|Look up FX rates from Coupa.|[FX Rate Stage inbound staging table](../reference/spo-fx-rate-inbound-table.md)|
|Legal entities|Look up legal entities from Coupa.|[Legal Entity Stage inbound staging table](../reference/spo-legal-entity-inbound-table.md)|
|Purchase Line Shipment Details|Look up purchase line shipment details from Coupa.|[Purchase Requisition staging table](../reference/purchase-requisition-staging-table.md)|
|Shipment Notices|Look up shipment notices from Coupa|-|
|Suppliers|Look up suppliers from Coupa.|[Supplier Location inbound staging table](../reference/slo-supp-location-inbound-table.md)|
|Cost Centers|Look up cost centers from Coupa.|[Cost Center Stage inbound staging table](../reference/spo-cost-center-inbound-table.md)|
|Supplier Payment Information|Look up supplier payment information from Coupa.|[Supplier Payment inbound staging table](../reference/slo-supp-payment-inbound-table.md)|
|Invoices|Look up invoices from Coupa.|[Invoice import inbound staging table](../reference/inbound-invoice-import-staging-table.md)|
|Purchase Orders|Look up purchase orders from Coupa|[Purchase Order inbound staging table](../reference/spo-inbound-pur-order-table.md)|
...
|Receipts|Look up receipts from Coupa.|[Receipt inbound staging table](../reference/spo-inbound-receipt-table.md)|
|Product Models|Look up product models from Coupa.|[Product Model Stage inbound staging table](../reference/spo-prod-mod-inbound-table.md)|
