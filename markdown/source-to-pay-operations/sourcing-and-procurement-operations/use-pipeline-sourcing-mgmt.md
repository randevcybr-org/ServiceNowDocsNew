...
description: Use Pipeline Sourcing Management to create pipeline projects that capture key financial and opportunity data while providing end-to-end visibility into all sourcing activities.
locale: en-US
release: australia
...
-   **[Add a pipeline project to a sourcing request](../task/add-pipeline-sourcing-request.md)**  
...
-   **[Create a pipeline project manually](../task/create-pipeline-manually.md)**  
...
-   **[Report savings when awarding a supplier](../task/report-savings-pipeline.md)**  
When awarding a supplier, enter the spend and savings data for the sourcing event associated with the pipeline project.
-   **[Report savings when awarding multiple suppliers](../task/report-savings-multiple-suppliers.md)**  
...
-   **[Close a pipeline project](../task/close-pipeline-project.md)**  
...
-   **[Create a pipeline project from an expiring contract](../task/create-pipeline-expire-contract.md)**  
