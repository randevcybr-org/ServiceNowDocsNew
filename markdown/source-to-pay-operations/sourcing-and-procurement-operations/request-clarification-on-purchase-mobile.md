...
4.  On the **To-do** tab, select **Pending approval**.
    ...
    **Note:** You can view the clarification provided by the shopper by selecting **Requests for clarification**.

5.  Tap on the Actions icon, and select **Request clarification**.

6.  Enter the clarification you require in the **Question** field.
