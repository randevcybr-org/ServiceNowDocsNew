...
3.  On the form, fill in the fields.
    ...
    |Category|Category of the article such as procurement policy. Use the category picker to select an existing category or subcategory. You can create a category or subcategory to suit your requirements.|
