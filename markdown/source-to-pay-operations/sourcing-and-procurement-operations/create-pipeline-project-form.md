...
Actual start date of the pipeline project.
...
Actual end date of the pipeline project.
...
The date from which savings are expected to begin.
...
The date until which savings are expected to be captured.
...
Direct, measurable cost reductions resulting from the pipeline project.
...
The savings goal set for the pipeline project.
...
Potential costs prevented through negotiation, process changes, or alternative sourcing.
