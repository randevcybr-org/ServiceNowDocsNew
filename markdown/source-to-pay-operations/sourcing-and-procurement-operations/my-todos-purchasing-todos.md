---
title: My to-dos and purchasing to-dos
description: As a shopper, you can review to-dos from the To-dos tab.
locale: en-US
release: australia
...
# My to-dos and purchasing to-dos
...
In the **Purchase detail view**, you can also view all approval requests, including those that have not been requested. For example, if there is a sequential rule that has three approvers, all three purchase request approvals are displayed. Approvals are not triggered for the subsequent approvers though, and email notifications are sent only when approval is required for purchase request. If the approval is no longer required or complete, it is no longer displayed.
