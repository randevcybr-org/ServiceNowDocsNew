...
<table id="table_xms_qbk_wfc"><thead><tr><th>
...
Add the sourcing request to an existing pipeline project.
...
Add the sourcing request to a new pipeline project.
...
-   From the **Project type** list, select one of the following options:
    ...
    -   Spend Optimization
    -   Risk Reduction
-   In the **Estimated Start Date** field, enter the target start date for the pipeline project.
-   In the **Spend Category** field, select the spend category that matches that of the sourcing request.
