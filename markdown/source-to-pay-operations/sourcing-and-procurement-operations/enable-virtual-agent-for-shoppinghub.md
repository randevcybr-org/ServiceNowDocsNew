...
4.  Select any topic to open it and view the conversation flow.

    -   To use the topic in a conversation with no changes, select **Publish**.
    -   To test the active, published conversation topic, select **Test**.
    -   To duplicate the topic so you can customize it, select **Duplicate**. Enter a name for the duplicate topic and select **Save**.
