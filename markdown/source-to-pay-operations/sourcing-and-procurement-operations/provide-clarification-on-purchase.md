...
2.  Select the user icon and select **My purchases**.

3.  On the **View by purchase** tab, select **View question** on the purchase you want to provide clarification for.

4.  In the **Answer question** dialog box, enter your clarification for the approver.
