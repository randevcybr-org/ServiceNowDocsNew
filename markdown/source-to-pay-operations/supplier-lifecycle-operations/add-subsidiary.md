...
Procedure for adding a subsidiary to a supplier from the Source-to-Pay Workspace. 
...
3.  Under My suppliers, select the legal name of the supplier for which you want to add a subsidiary.
