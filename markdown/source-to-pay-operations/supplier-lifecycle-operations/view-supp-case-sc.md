...
2.  Do one of the following:
    ...
    ![My Requests page.](../image/supp-cases-sc.png)
...
4.  To view details about that request, select the link to a request under the Request column.
    ...
    ![Request details page.](../image/supp-case-details-sc2.png)
...
5.  To work on the request, select any of the following tabs:
    ...
    -   **Attachments**: Select the add attachments icon \(![Add attachments icon.](../image/attachments-icon.png)\) to attach documents or images to the case.
